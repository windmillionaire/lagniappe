...
import { c as connectivity, i as isSkippedViewTransitionError, a as captureError, b as initializeLogoutForms, d as analytics, e as captureNetworkError, f as clearRecentSearchResults, u as updateUserData, g as connectivityMessage } from './chunks/shared.js?v=b30f3f24';
...
const VIEWS = {
	project: () => import('./chunks/project.js?v=b30f3f24'),
	page: () => import('./chunks/page.js?v=b30f3f24'),
	home: () => import('./chunks/home.js?v=b30f3f24'),
	manual: () => import('./chunks/manual.js?v=b30f3f24'),
	user: () => import('./chunks/user2.js?v=b30f3f24'),
	form: () => import('./chunks/index.js?v=b30f3f24'),
	category: () => import('./chunks/index.js?v=b30f3f24'),
	task: () => import('./chunks/index.js?v=b30f3f24'),
	builder: () => import('./chunks/builder.js?v=b30f3f24').then(function (n) { return n.b; }),
	results: () => import('./chunks/results.js?v=b30f3f24'),
	file: () => import('./chunks/file.js?v=b30f3f24'),
	report: () => import('./chunks/report.js?v=b30f3f24'),
	analytics: () => import('./chunks/analytics.js?v=b30f3f24'),
	admin: () => import('./chunks/admin.js?v=b30f3f24'),
};
