...
import { c as createIcon } from './icons.js?v=b43106f0';
import { g as generateElementId, w as withTransition, c as captureError, s as showBriefly } from './foundation.js?v=b43106f0';
import { g as getFormElement } from './loader.js?v=b43106f0';

const CONTROLS = {
	"permission-sections": () => import('./permissionSections.js?v=b43106f0'),
	"access-restrictions": () => import('./accessRestrictions.js?v=b43106f0'),
};
