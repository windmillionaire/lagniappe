...
import { c as createIcon } from './icons.js?v=b1aeef6f';
import { g as generateElementId, w as withTransition, c as captureError, s as showBriefly } from './foundation.js?v=b1aeef6f';
import { g as getFormElement } from './loader.js?v=b1aeef6f';

const CONTROLS = {
	"permission-sections": () => import('./permissionSections.js?v=b1aeef6f'),
	"access-restrictions": () => import('./accessRestrictions.js?v=b1aeef6f'),
};
