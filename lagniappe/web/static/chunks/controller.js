...
import { g as generateElementId, w as withTransition, c as captureError, s as showBriefly } from './foundation.js?v=b6b75cd2';
import { g as getFormElement } from './loader.js?v=b6b75cd2';

const CONTROLS = {
	"permission-sections": () => import('./permissionSections.js?v=b6b75cd2'),
	"access-restrictions": () => import('./accessRestrictions.js?v=b6b75cd2'),
};
