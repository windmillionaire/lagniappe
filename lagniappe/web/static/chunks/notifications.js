...
import { r as request, E as ENDPOINTS, w as withTransition, f as renderNotificationBadge } from './foundation.js?v=ba53d151';
import './connectivity.js?v=ba53d151';
import { c as createIcon } from './icons.js?v=ba53d151';
import { Dropdown } from './dropdown.js?v=ba53d151';
...
class Notifications {
	...
	async _selectNotification(option, event) {
		...
		if (action === "message-user") {
			...
			const { ensureMessageComposer } = await import('./messageComposer.js?v=ba53d151');
