...
import { r as request, E as ENDPOINTS, w as withTransition, h as renderNotificationBadge } from './foundation.js?v=b41d0cfc';
import './connectivity.js?v=b41d0cfc';
import { c as createIcon } from './icons.js?v=b41d0cfc';
import { Dropdown } from './dropdown.js?v=b41d0cfc';
...
class Notifications {
	...
	async _selectNotification(option, event) {
		...
		if (action === "message-user") {
			...
			const { ensureMessageComposer } = await import('./messageComposer.js?v=b41d0cfc');
