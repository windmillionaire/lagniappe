...
import { r as request, E as ENDPOINTS, w as withTransition, f as renderNotificationBadge } from './foundation.js?v=ba9311bf';
import './connectivity.js?v=ba9311bf';
import { c as createIcon } from './icons.js?v=ba9311bf';
import { Dropdown } from './dropdown.js?v=ba9311bf';
...
class Notifications {
	...
	async _selectNotification(option, event) {
		...
		if (action === "message-user") {
			...
			const { ensureMessageComposer } = await import('./messageComposer.js?v=ba9311bf');
