...
import { r as request, E as ENDPOINTS, w as withTransition, h as renderNotificationBadge } from './foundation.js?v=b564d2b9';
import './connectivity.js?v=b564d2b9';
import { c as createIcon } from './icons.js?v=b564d2b9';
import { Dropdown } from './dropdown.js?v=b564d2b9';
...
class Notifications {
	...
	async _selectNotification(option, event) {
		...
		if (action === "message-user") {
			...
			const { ensureMessageComposer } = await import('./messageComposer.js?v=b564d2b9');
