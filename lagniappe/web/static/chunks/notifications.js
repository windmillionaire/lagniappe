...
import { r as request, E as ENDPOINTS, w as withTransition, f as renderNotificationBadge } from './foundation.js?v=bc116afe';
import './connectivity.js?v=bc116afe';
import { c as createIcon } from './icons.js?v=bc116afe';
import { Dropdown } from './dropdown.js?v=bc116afe';
...
class Notifications {
	...
	async _selectNotification(option, event) {
		...
		if (action === "message-user") {
			...
			const { ensureMessageComposer } = await import('./messageComposer.js?v=bc116afe');
