...
import { C as CONFIG, f as fieldKind } from './builder.js?v=b9517a42';
import { g as generateElementId } from './foundation.js?v=b9517a42';
import './connectivity.js?v=b9517a42';
import { p as primitives } from './primitives.js?v=b9517a42';
import { S as SelectBox } from './select2.js?v=b9517a42';
import { C as Condition } from './base2.js?v=b9517a42';
