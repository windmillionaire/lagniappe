...
import { g as generateElementId } from './foundation.js?v=b6b75cd2';
import { p as primitives } from './primitives.js?v=b6b75cd2';
import { S as SelectBox } from './select2.js?v=b6b75cd2';
import { C as CONFIG, f as fieldKind } from './builder.js?v=b6b75cd2';
import { C as Condition } from './base2.js?v=b6b75cd2';
