...
import { c as connectivity } from './connectivity.js?v=b6b75cd2';
import { c as captureError, E as ENDPOINTS, w as withTransition, r as request, a as whenIdle, m as markPerformance, S as ShellView } from './foundation.js?v=b6b75cd2';
import { clearRecentSearchResults } from './storage.js?v=b6b75cd2';
...
const WIDGETS = {
	BaseList: () => import('./baseList.js?v=b6b75cd2'),
	CategoryInfo: () => import('./category.js?v=b6b75cd2'),
	CollaborativeDocument: () => import('./collaborative.js?v=b6b75cd2'),
	CreateCategory: () => import('./category.js?v=b6b75cd2'),
	CreateForm: () => import('./form.js?v=b6b75cd2'),
	CreateModelTask: () => import('./modelTasks.js?v=b6b75cd2'),
	CreateNote: () => import('./note.js?v=b6b75cd2'),
	CreatePage: () => import('./pageInfo.js?v=b6b75cd2'),
	CreateProject: () => import('./projectInfo.js?v=b6b75cd2'),
	CreateToolReport: () => import('./tools.js?v=b6b75cd2'),
	CreateUserTask: () => import('./taskSettings.js?v=b6b75cd2'),
	CreateTask: () => import('./taskSettings.js?v=b6b75cd2'),
	CreateUser: () => import('./user.js?v=b6b75cd2'),
	CreateUserGroup: () => import('./user.js?v=b6b75cd2'),
	DirectoryList: () => import('./lists.js?v=b6b75cd2'),
	DocumentSettings: () => import('./documentSettings.js?v=b6b75cd2'),
	FileInfo: () => import('./fileInfo.js?v=b6b75cd2'),
	PDFPreview: () => import('./filePdfPreview.js?v=b6b75cd2'),
	FileUpload: () => import('./uploadFile.js?v=b6b75cd2'),
	Filters: () => import('./filters.js?v=b6b75cd2'),
	FilterResults: () => import('./filterResults.js?v=b6b75cd2'),
	GroupPermissions: () => import('./userPermissions.js?v=b6b75cd2'),
	HomeActivityList: () => import('./activity.js?v=b6b75cd2'),
	HomePageList: () => import('./lists.js?v=b6b75cd2'),
	HomeTaskList: () => import('./tasks.js?v=b6b75cd2'),
	HomeProjectList: () => import('./lists.js?v=b6b75cd2'),
	HomeCategoryList: () => import('./lists.js?v=b6b75cd2'),
	ImportData: () => import('./ingress.js?v=b6b75cd2'),
	IndexTable: () => import('./indexTable.js?v=b6b75cd2'),
	IngressFileUpload: () => import('./ingressUpload.js?v=b6b75cd2'),
	IngressList: () => import('./lists.js?v=b6b75cd2'),
	MobileTableControls: () => import('./mobileControls.js?v=b6b75cd2'),
	ModelTaskInfo: () => import('./modelTasks.js?v=b6b75cd2'),
	ModelTaskList: () => import('./modelTasks.js?v=b6b75cd2'),
	PageInfo: () => import('./pageInfo.js?v=b6b75cd2'),
	PagePermissions: () => import('./pagePermissions.js?v=b6b75cd2'),
	PagePhoto: () => import('./pagePhoto.js?v=b6b75cd2'),
	PageTaskList: () => import('./pageTaskList.js?v=b6b75cd2'),
	ProjectInfo: () => import('./projectInfo.js?v=b6b75cd2'),
	PublicPermissions: () => import('./userPermissions.js?v=b6b75cd2'),
	SavedFilters: () => import('./filters.js?v=b6b75cd2'),
	SiteAiModels: () => import('./aiModels.js?v=b6b75cd2'),
	SiteAdministrators: () => import('./administrators.js?v=b6b75cd2'),
	SiteDeployment: () => import('./deployment.js?v=b6b75cd2'),
	SiteInstallationAccess: () => import('./installationAccess.js?v=b6b75cd2'),
	SiteImage: () => import('./image.js?v=b6b75cd2'),
	SiteMaintenance: () => import('./maintenance.js?v=b6b75cd2'),
	SiteServiceProviders: () => import('./providers.js?v=b6b75cd2'),
	SiteSettings: () => import('./siteSettings.js?v=b6b75cd2'),
	StarredList: () => import('./lists.js?v=b6b75cd2'),
	TableEditor: () => import('./editor.js?v=b6b75cd2'),
	TableSorting: () => import('./sorting.js?v=b6b75cd2'),
	TableVisibility: () => import('./visibility.js?v=b6b75cd2'),
	TaskForm: () => import('./taskForm.js?v=b6b75cd2'),
	TaskHistory: () => import('./taskHistory.js?v=b6b75cd2'),
	TaskCombine: () => import('./taskSettings.js?v=b6b75cd2'),
	TaskMove: () => import('./taskSettings.js?v=b6b75cd2'),
	ToolReportList: () => import('./lists.js?v=b6b75cd2'),
	TaskSettings: () => import('./taskSettings.js?v=b6b75cd2'),
	UserSettings: () => import('./userSettings.js?v=b6b75cd2'),
};
...
const ensureOfflineQueue = (view) =>
	loadOnce(view, "_offlineQueuePromise", "offlineQueue", async () => {
		const { OfflineQueue } = await import('./offlineQueue.js?v=b6b75cd2');
...
const ensurePollingCoordinator = (view) =>
	loadOnce(view, "_pollingPromise", "PollingCoordinator", async () => {
		const { PollingCoordinator } = await import('./polling.js?v=b6b75cd2');
		if (view._destroyed) return null;
...
const ensureSyncManager = (view) =>
	loadOnce(view, "_syncPromise", "SyncManager", async () => {
		...
		const { SyncManager } = await import('./sync.js?v=b6b75cd2');
		if (view._destroyed) return null;
...
const ensureEditWatcher = (view) =>
	loadOnce(view, "_editWatcherPromise", "EditWatcher", async () => {
		await ensurePollingCoordinator(view);
		const { EditWatcher } = await import('./watcher.js?v=b6b75cd2');
		if (view._destroyed) return null;
	...
	loadOnce(
		...
		async () => {
			...
			const { DeferredOperationManager } = await import(
				'./deferredOperations.js?v=b6b75cd2'
			);
			if (view._destroyed) return null;
...
const ensureNotifications = (view) =>
	loadOnce(view, "_notificationsPromise", "Notifications", async () => {
		...
		const { Notifications } = await import('./notifications.js?v=b6b75cd2');
		if (view._destroyed) return null;
...
const ensureSearchBox = (view) =>
	loadOnce(view, "_searchPromise", "SearchBox", async () => {
		...
		const { SearchBox } = await import('./search.js?v=b6b75cd2');
		if (view._destroyed) return null;
...
const ensureEntityMenu = (view) =>
	loadOnce(view, "_entityMenuPromise", "EntityMenu", async () => {
		const { EntityMenu } = await import('./entityMenu.js?v=b6b75cd2');
		if (view._destroyed) return null;
...
const ensureSubmissionManager = (view) =>
	loadOnce(view, "_submissionPromise", "SubmissionManager", async () => {
		const { SubmissionManager } = await import('./submission.js?v=b6b75cd2');
		if (view._destroyed) return null;
...
const ensureOfflineModal = (view) =>
	loadOnce(view, "_offlineModalPromise", "offlineModal", async () => {
		...
		const { OfflineModal } = await import('./modal.js?v=b6b75cd2');
		if (view._destroyed) return null;
...
const initializeCoreServices = (view) => {
	...
	const offlineWork = idle.then(async () => {
		const { inspectOfflineWork } = await import('./offlineWork.js?v=b6b75cd2');
	...
	view.initialReplayReady = view.offlineQueueReady.then(async (queue) => {
		if (!queue) return 0;
		const { replayOfflineQueue } = await import('./offlineReplay.js?v=b6b75cd2');
...
class Core extends ShellView {
	...
	scheduleOfflineReplay() {
		...
		const replay = import('./offlineReplay.js?v=b6b75cd2').then(
