...
import { c as connectivity } from './connectivity.js?v=b41d0cfc';
import { c as captureError, E as ENDPOINTS, w as withTransition, s as showBriefly, a as clearRecentSearchResults, r as request, b as whenIdle, m as markPerformance, S as ShellView } from './foundation.js?v=b41d0cfc';
...
const WIDGETS = {
	BaseList: () => import('./baseList.js?v=b41d0cfc'),
	CategoryInfo: () => import('./category.js?v=b41d0cfc'),
	CollaborativeDocument: () => import('./collaborative.js?v=b41d0cfc'),
	CreateCategory: () => import('./category.js?v=b41d0cfc'),
	CreateForm: () => import('./form.js?v=b41d0cfc'),
	CreateModelTask: () => import('./modelTasks.js?v=b41d0cfc'),
	CreateNote: () => import('./note.js?v=b41d0cfc'),
	CreatePage: () => import('./pageInfo.js?v=b41d0cfc'),
	CreateProject: () => import('./projectInfo.js?v=b41d0cfc'),
	CreateToolReport: () => import('./tools.js?v=b41d0cfc'),
	CreateUserTask: () => import('./taskSettings.js?v=b41d0cfc'),
	CreateTask: () => import('./taskSettings.js?v=b41d0cfc'),
	CreateUser: () => import('./user.js?v=b41d0cfc'),
	CreateUserGroup: () => import('./user.js?v=b41d0cfc'),
	DirectoryList: () => import('./lists.js?v=b41d0cfc'),
	DocumentSettings: () => import('./documentSettings.js?v=b41d0cfc'),
	FileInfo: () => import('./fileInfo.js?v=b41d0cfc'),
	PDFPreview: () => import('./filePdfPreview.js?v=b41d0cfc'),
	FileUpload: () => import('./uploadFile.js?v=b41d0cfc'),
	Filters: () => import('./filters.js?v=b41d0cfc'),
	FilterResults: () => import('./tables.js?v=b41d0cfc'),
	GroupPermissions: () => import('./user.js?v=b41d0cfc'),
	HomeActivityList: () => import('./activity.js?v=b41d0cfc'),
	HomePageList: () => import('./lists.js?v=b41d0cfc'),
	HomeTaskList: () => import('./tasks.js?v=b41d0cfc'),
	HomeProjectList: () => import('./lists.js?v=b41d0cfc'),
	HomeCategoryList: () => import('./lists.js?v=b41d0cfc'),
	ImportData: () => import('./ingress.js?v=b41d0cfc'),
	IndexTable: () => import('./tables.js?v=b41d0cfc'),
	IngressFileUpload: () => import('./ingressUpload.js?v=b41d0cfc'),
	IngressList: () => import('./lists.js?v=b41d0cfc'),
	MobileTableControls: () => import('./mobileTableControls.js?v=b41d0cfc'),
	ModelTaskInfo: () => import('./modelTasks.js?v=b41d0cfc'),
	ModelTaskList: () => import('./modelTasks.js?v=b41d0cfc'),
	PageInfo: () => import('./pageInfo.js?v=b41d0cfc'),
	PagePermissions: () => import('./pagePermissions.js?v=b41d0cfc'),
	PagePhoto: () => import('./pagePhoto.js?v=b41d0cfc'),
	PageTaskList: () => import('./pageTaskList.js?v=b41d0cfc'),
	ProjectInfo: () => import('./projectInfo.js?v=b41d0cfc'),
	PublicPermissions: () => import('./user.js?v=b41d0cfc'),
	SavedFilters: () => import('./filters.js?v=b41d0cfc'),
	SiteAiModels: () => import('./aiModels.js?v=b41d0cfc'),
	SiteAdministrators: () => import('./administrators.js?v=b41d0cfc'),
	SiteDeployment: () => import('./deployment.js?v=b41d0cfc'),
	SiteInstallationAccess: () => import('./installationAccess.js?v=b41d0cfc'),
	SiteImage: () => import('./image.js?v=b41d0cfc'),
	SiteMaintenance: () => import('./maintenance.js?v=b41d0cfc'),
	SiteServiceProviders: () => import('./providers.js?v=b41d0cfc'),
	SiteSettings: () => import('./siteSettings.js?v=b41d0cfc'),
	StarredList: () => import('./lists.js?v=b41d0cfc'),
	TableEditor: () => import('./tableEditor.js?v=b41d0cfc'),
	TableSorting: () => import('./tableSorting.js?v=b41d0cfc'),
	TableVisibility: () => import('./tableVisibility.js?v=b41d0cfc'),
	TaskForm: () => import('./taskForm.js?v=b41d0cfc'),
	TaskHistory: () => import('./tables.js?v=b41d0cfc'),
	TaskCombine: () => import('./taskSettings.js?v=b41d0cfc'),
	TaskMove: () => import('./taskSettings.js?v=b41d0cfc'),
	ToolReportList: () => import('./lists.js?v=b41d0cfc'),
	TaskSettings: () => import('./taskSettings.js?v=b41d0cfc'),
	UserSettings: () => import('./pageInfo.js?v=b41d0cfc'),
};

/** Sync-capable widgets that can run without a mounted view (offline replay). */
const HEADLESS_WIDGETS = {
	document: {
		load: () => import('./collaborative.js?v=b41d0cfc'),
...
const ensureOfflineQueue = (view) =>
	loadOnce(view, "_offlineQueuePromise", "offlineQueue", async () => {
		const { OfflineQueue } = await import('./offlineQueue.js?v=b41d0cfc');
...
const ensurePollingCoordinator = (view) =>
	loadOnce(view, "_pollingPromise", "PollingCoordinator", async () => {
		const { PollingCoordinator } = await import('./polling.js?v=b41d0cfc');
		if (view._destroyed) return null;
...
const ensureSyncManager = (view) =>
	loadOnce(view, "_syncPromise", "SyncManager", async () => {
		...
		const { SyncManager } = await import('./sync.js?v=b41d0cfc');
		if (view._destroyed) return null;
...
const ensureEditWatcher = (view) =>
	loadOnce(view, "_editWatcherPromise", "EditWatcher", async () => {
		await ensurePollingCoordinator(view);
		const { EditWatcher } = await import('./editWatcher.js?v=b41d0cfc');
		if (view._destroyed) return null;
	...
	loadOnce(
		...
		async () => {
			...
			const { DeferredOperationManager } = await import(
				'./deferredOperations.js?v=b41d0cfc'
			);
			if (view._destroyed) return null;
...
const ensureNotifications = (view) =>
	loadOnce(view, "_notificationsPromise", "Notifications", async () => {
		...
		const { Notifications } = await import('./notifications.js?v=b41d0cfc');
		if (view._destroyed) return null;
...
const ensureSearchBox = (view) =>
	loadOnce(view, "_searchPromise", "SearchBox", async () => {
		...
		const { SearchBox } = await import('./search.js?v=b41d0cfc');
		if (view._destroyed) return null;
...
const ensureEntityMenu = (view) =>
	loadOnce(view, "_entityMenuPromise", "EntityMenu", async () => {
		const { EntityMenu } = await import('./entityMenu.js?v=b41d0cfc');
		if (view._destroyed) return null;
...
const ensureSubmissionManager = (view) =>
	loadOnce(view, "_submissionPromise", "SubmissionManager", async () => {
		const { SubmissionManager } = await import('./submission.js?v=b41d0cfc');
		if (view._destroyed) return null;
...
const ensureOfflineModal = (view) =>
	loadOnce(view, "_offlineModalPromise", "offlineModal", async () => {
		...
		const { OfflineModal } = await import('./modal.js?v=b41d0cfc');
		if (view._destroyed) return null;
...
const initializeCoreServices = (view) => {
	...
	const offlineWork = idle.then(async () => {
		const { inspectOfflineWork } = await import('./offlineWork.js?v=b41d0cfc');
	...
	view.initialReplayReady = view.offlineQueueReady.then(async (queue) => {
		if (!queue) return 0;
		const { replayOfflineQueue } = await import('./offlineReplay.js?v=b41d0cfc');
...
class Core extends ShellView {
	...
	scheduleOfflineReplay() {
		...
		const replay = import('./offlineReplay.js?v=b41d0cfc').then(({ replayOfflineQueue }) =>
