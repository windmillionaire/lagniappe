...
import { c as connectivity } from './connectivity.js?v=ba53d151';
import { c as captureError, E as ENDPOINTS, w as withTransition, s as showBriefly, a as clearRecentSearchResults, r as request, b as whenIdle, m as markPerformance, S as ShellView } from './foundation.js?v=ba53d151';
...
const WIDGETS = {
	BaseList: () => import('./baseList.js?v=ba53d151'),
	CategoryInfo: () => import('./category.js?v=ba53d151'),
	CollaborativeDocument: () => import('./collaborative.js?v=ba53d151'),
	CreateCategory: () => import('./category.js?v=ba53d151'),
	CreateForm: () => import('./form.js?v=ba53d151'),
	CreateModelTask: () => import('./modelTasks.js?v=ba53d151'),
	CreateNote: () => import('./note.js?v=ba53d151'),
	CreatePage: () => import('./pageInfo.js?v=ba53d151'),
	CreateProject: () => import('./projectInfo.js?v=ba53d151'),
	CreateToolReport: () => import('./tools.js?v=ba53d151'),
	CreateUserTask: () => import('./taskSettings.js?v=ba53d151'),
	CreateTask: () => import('./taskSettings.js?v=ba53d151'),
	CreateUser: () => import('./user.js?v=ba53d151'),
	CreateUserGroup: () => import('./user.js?v=ba53d151'),
	DirectoryList: () => import('./lists.js?v=ba53d151'),
	DocumentSettings: () => import('./documentSettings.js?v=ba53d151'),
	FileInfo: () => import('./fileInfo.js?v=ba53d151'),
	PDFPreview: () => import('./filePdfPreview.js?v=ba53d151'),
	FileUpload: () => import('./uploadFile.js?v=ba53d151'),
	Filters: () => import('./filters.js?v=ba53d151'),
	FilterResults: () => import('./tables.js?v=ba53d151'),
	GeneratePages: () => import('./category.js?v=ba53d151'),
	GroupPermissions: () => import('./user.js?v=ba53d151'),
	HomeActivityList: () => import('./activity.js?v=ba53d151'),
	HomePageList: () => import('./lists.js?v=ba53d151'),
	HomeTaskList: () => import('./tasks.js?v=ba53d151'),
	HomeProjectList: () => import('./lists.js?v=ba53d151'),
	HomeCategoryList: () => import('./lists.js?v=ba53d151'),
	ImportData: () => import('./ingress.js?v=ba53d151'),
	IndexTable: () => import('./tables.js?v=ba53d151'),
	IngressFileUpload: () => import('./ingressUpload.js?v=ba53d151'),
	IngressList: () => import('./lists.js?v=ba53d151'),
	MobileTableControls: () => import('./mobileTableControls.js?v=ba53d151'),
	ModelTaskInfo: () => import('./modelTasks.js?v=ba53d151'),
	ModelTaskList: () => import('./modelTasks.js?v=ba53d151'),
	PageInfo: () => import('./pageInfo.js?v=ba53d151'),
	PagePermissions: () => import('./pagePermissions.js?v=ba53d151'),
	PagePhoto: () => import('./pagePhoto.js?v=ba53d151'),
	PageTaskList: () => import('./pageTaskList.js?v=ba53d151'),
	ProjectInfo: () => import('./projectInfo.js?v=ba53d151'),
	PublicPermissions: () => import('./user.js?v=ba53d151'),
	SavedFilters: () => import('./filters.js?v=ba53d151'),
	SiteExport: () => import('./siteExport.js?v=ba53d151'),
	SiteAiModels: () => import('./aiModels.js?v=ba53d151'),
	SiteDeployment: () => import('./deployment.js?v=ba53d151'),
	SiteImage: () => import('./image.js?v=ba53d151'),
	SiteMaintenance: () => import('./maintenance.js?v=ba53d151'),
	SiteServiceProviders: () => import('./providers.js?v=ba53d151'),
	SiteSettings: () => import('./siteSettings.js?v=ba53d151'),
	StarredList: () => import('./lists.js?v=ba53d151'),
	TableEditor: () => import('./tableEditor.js?v=ba53d151'),
	TableSorting: () => import('./tableSorting.js?v=ba53d151'),
	TableVisibility: () => import('./tableVisibility.js?v=ba53d151'),
	TaskForm: () => import('./taskForm.js?v=ba53d151'),
	TaskHistory: () => import('./tables.js?v=ba53d151'),
	TaskCombine: () => import('./taskSettings.js?v=ba53d151'),
	TaskMove: () => import('./taskSettings.js?v=ba53d151'),
	ToolReportList: () => import('./lists.js?v=ba53d151'),
	TaskSettings: () => import('./taskSettings.js?v=ba53d151'),
	UserSettings: () => import('./pageInfo.js?v=ba53d151'),
};

/** Sync-capable widgets that can run without a mounted view (offline replay). */
const HEADLESS_WIDGETS = {
	document: {
		load: () => import('./collaborative.js?v=ba53d151'),
...
const ensureOfflineQueue = (view) =>
	loadOnce(view, "_offlineQueuePromise", "offlineQueue", async () => {
		const { OfflineQueue } = await import('./offlineQueue.js?v=ba53d151');
...
const ensurePollingCoordinator = (view) =>
	loadOnce(view, "_pollingPromise", "PollingCoordinator", async () => {
		const { PollingCoordinator } = await import('./polling.js?v=ba53d151');
		if (view._destroyed) return null;
...
const ensureSyncManager = (view) =>
	loadOnce(view, "_syncPromise", "SyncManager", async () => {
		...
		const { SyncManager } = await import('./sync.js?v=ba53d151');
		if (view._destroyed) return null;
...
const ensureEditWatcher = (view) =>
	loadOnce(view, "_editWatcherPromise", "EditWatcher", async () => {
		await ensurePollingCoordinator(view);
		const { EditWatcher } = await import('./editWatcher.js?v=ba53d151');
		if (view._destroyed) return null;
	...
	loadOnce(
		...
		async () => {
			...
			const { DeferredOperationManager } = await import(
				'./deferredOperations.js?v=ba53d151'
			);
			if (view._destroyed) return null;
...
const ensureNotifications = (view) =>
	loadOnce(view, "_notificationsPromise", "Notifications", async () => {
		...
		const { Notifications } = await import('./notifications.js?v=ba53d151');
		if (view._destroyed) return null;
...
const ensureSearchBox = (view) =>
	loadOnce(view, "_searchPromise", "SearchBox", async () => {
		...
		const { SearchBox } = await import('./search.js?v=ba53d151');
		if (view._destroyed) return null;
...
const ensureEntityMenu = (view) =>
	loadOnce(view, "_entityMenuPromise", "EntityMenu", async () => {
		const { EntityMenu } = await import('./entityMenu.js?v=ba53d151');
		if (view._destroyed) return null;
...
const ensureSubmissionManager = (view) =>
	loadOnce(view, "_submissionPromise", "SubmissionManager", async () => {
		const { SubmissionManager } = await import('./submission.js?v=ba53d151');
		if (view._destroyed) return null;
...
const ensureOfflineModal = (view) =>
	loadOnce(view, "_offlineModalPromise", "offlineModal", async () => {
		...
		const { OfflineModal } = await import('./modal.js?v=ba53d151');
		if (view._destroyed) return null;
...
const initializeCoreServices = (view) => {
	...
	const offlineWork = idle.then(async () => {
		const { inspectOfflineWork } = await import('./offlineWork.js?v=ba53d151');
	...
	view.initialReplayReady = view.offlineQueueReady.then(async (queue) => {
		if (!queue) return 0;
		const { replayOfflineQueue } = await import('./offlineReplay.js?v=ba53d151');
...
class Core extends ShellView {
	...
	scheduleOfflineReplay() {
		...
		const replay = import('./offlineReplay.js?v=ba53d151').then(({ replayOfflineQueue }) =>
