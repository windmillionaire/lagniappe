...
import { c as connectivity } from './connectivity.js?v=b687b680';
import { c as captureError, E as ENDPOINTS, w as withTransition, s as showBriefly, a as clearRecentSearchResults, r as request, b as whenIdle, m as markPerformance, S as ShellView } from './foundation.js?v=b687b680';
...
const WIDGETS = {
	BaseList: () => import('./baseList.js?v=b687b680'),
	CategoryInfo: () => import('./category.js?v=b687b680'),
	CollaborativeDocument: () => import('./collaborative.js?v=b687b680'),
	CreateCategory: () => import('./category.js?v=b687b680'),
	CreateForm: () => import('./form.js?v=b687b680'),
	CreateModelTask: () => import('./modelTasks.js?v=b687b680'),
	CreateNote: () => import('./note.js?v=b687b680'),
	CreatePage: () => import('./pageInfo.js?v=b687b680'),
	CreateProject: () => import('./projectInfo.js?v=b687b680'),
	CreateToolReport: () => import('./tools.js?v=b687b680'),
	CreateUserTask: () => import('./taskSettings.js?v=b687b680'),
	CreateTask: () => import('./taskSettings.js?v=b687b680'),
	CreateUser: () => import('./user.js?v=b687b680'),
	CreateUserGroup: () => import('./user.js?v=b687b680'),
	DirectoryList: () => import('./lists.js?v=b687b680'),
	DocumentSettings: () => import('./documentSettings.js?v=b687b680'),
	FileInfo: () => import('./fileInfo.js?v=b687b680'),
	PDFPreview: () => import('./filePdfPreview.js?v=b687b680'),
	FileUpload: () => import('./uploadFile.js?v=b687b680'),
	Filters: () => import('./filters.js?v=b687b680'),
	FilterResults: () => import('./tables.js?v=b687b680'),
	GeneratePages: () => import('./category.js?v=b687b680'),
	GroupPermissions: () => import('./user.js?v=b687b680'),
	HomeActivityList: () => import('./activity.js?v=b687b680'),
	HomePageList: () => import('./lists.js?v=b687b680'),
	HomeTaskList: () => import('./tasks.js?v=b687b680'),
	HomeProjectList: () => import('./lists.js?v=b687b680'),
	HomeCategoryList: () => import('./lists.js?v=b687b680'),
	ImportData: () => import('./ingress.js?v=b687b680'),
	IndexTable: () => import('./tables.js?v=b687b680'),
	IngressFileUpload: () => import('./ingressUpload.js?v=b687b680'),
	IngressList: () => import('./lists.js?v=b687b680'),
	MobileTableControls: () => import('./mobileTableControls.js?v=b687b680'),
	ModelTaskInfo: () => import('./modelTasks.js?v=b687b680'),
	ModelTaskList: () => import('./modelTasks.js?v=b687b680'),
	PageInfo: () => import('./pageInfo.js?v=b687b680'),
	PagePermissions: () => import('./pagePermissions.js?v=b687b680'),
	PagePhoto: () => import('./pagePhoto.js?v=b687b680'),
	PageTaskList: () => import('./pageTaskList.js?v=b687b680'),
	ProjectInfo: () => import('./projectInfo.js?v=b687b680'),
	PublicPermissions: () => import('./user.js?v=b687b680'),
	SavedFilters: () => import('./filters.js?v=b687b680'),
	SiteAiModels: () => import('./aiModels.js?v=b687b680'),
	SiteAdministrators: () => import('./administrators.js?v=b687b680'),
	SiteDeployment: () => import('./deployment.js?v=b687b680'),
	SiteInstallationAccess: () => import('./installationAccess.js?v=b687b680'),
	SiteImage: () => import('./image.js?v=b687b680'),
	SiteMaintenance: () => import('./maintenance.js?v=b687b680'),
	SiteServiceProviders: () => import('./providers.js?v=b687b680'),
	SiteSettings: () => import('./siteSettings.js?v=b687b680'),
	StarredList: () => import('./lists.js?v=b687b680'),
	TableEditor: () => import('./tableEditor.js?v=b687b680'),
	TableSorting: () => import('./tableSorting.js?v=b687b680'),
	TableVisibility: () => import('./tableVisibility.js?v=b687b680'),
	TaskForm: () => import('./taskForm.js?v=b687b680'),
	TaskHistory: () => import('./tables.js?v=b687b680'),
	TaskCombine: () => import('./taskSettings.js?v=b687b680'),
	TaskMove: () => import('./taskSettings.js?v=b687b680'),
	ToolReportList: () => import('./lists.js?v=b687b680'),
	TaskSettings: () => import('./taskSettings.js?v=b687b680'),
	UserSettings: () => import('./pageInfo.js?v=b687b680'),
};

/** Sync-capable widgets that can run without a mounted view (offline replay). */
const HEADLESS_WIDGETS = {
	document: {
		load: () => import('./collaborative.js?v=b687b680'),
...
const ensureOfflineQueue = (view) =>
	loadOnce(view, "_offlineQueuePromise", "offlineQueue", async () => {
		const { OfflineQueue } = await import('./offlineQueue.js?v=b687b680');
...
const ensurePollingCoordinator = (view) =>
	loadOnce(view, "_pollingPromise", "PollingCoordinator", async () => {
		const { PollingCoordinator } = await import('./polling.js?v=b687b680');
		if (view._destroyed) return null;
...
const ensureSyncManager = (view) =>
	loadOnce(view, "_syncPromise", "SyncManager", async () => {
		...
		const { SyncManager } = await import('./sync.js?v=b687b680');
		if (view._destroyed) return null;
...
const ensureEditWatcher = (view) =>
	loadOnce(view, "_editWatcherPromise", "EditWatcher", async () => {
		await ensurePollingCoordinator(view);
		const { EditWatcher } = await import('./editWatcher.js?v=b687b680');
		if (view._destroyed) return null;
	...
	loadOnce(
		...
		async () => {
			...
			const { DeferredOperationManager } = await import(
				'./deferredOperations.js?v=b687b680'
			);
			if (view._destroyed) return null;
...
const ensureNotifications = (view) =>
	loadOnce(view, "_notificationsPromise", "Notifications", async () => {
		...
		const { Notifications } = await import('./notifications.js?v=b687b680');
		if (view._destroyed) return null;
...
const ensureSearchBox = (view) =>
	loadOnce(view, "_searchPromise", "SearchBox", async () => {
		...
		const { SearchBox } = await import('./search.js?v=b687b680');
		if (view._destroyed) return null;
...
const ensureEntityMenu = (view) =>
	loadOnce(view, "_entityMenuPromise", "EntityMenu", async () => {
		const { EntityMenu } = await import('./entityMenu.js?v=b687b680');
		if (view._destroyed) return null;
...
const ensureSubmissionManager = (view) =>
	loadOnce(view, "_submissionPromise", "SubmissionManager", async () => {
		const { SubmissionManager } = await import('./submission.js?v=b687b680');
		if (view._destroyed) return null;
...
const ensureOfflineModal = (view) =>
	loadOnce(view, "_offlineModalPromise", "offlineModal", async () => {
		...
		const { OfflineModal } = await import('./modal.js?v=b687b680');
		if (view._destroyed) return null;
...
const initializeCoreServices = (view) => {
	...
	const offlineWork = idle.then(async () => {
		const { inspectOfflineWork } = await import('./offlineWork.js?v=b687b680');
	...
	view.initialReplayReady = view.offlineQueueReady.then(async (queue) => {
		if (!queue) return 0;
		const { replayOfflineQueue } = await import('./offlineReplay.js?v=b687b680');
...
class Core extends ShellView {
	...
	scheduleOfflineReplay() {
		...
		const replay = import('./offlineReplay.js?v=b687b680').then(({ replayOfflineQueue }) =>
