...
import { c as connectivity } from './connectivity.js?v=bc116afe';
import { c as captureError, E as ENDPOINTS, w as withTransition, s as showBriefly, a as clearRecentSearchResults, r as request, b as whenIdle, m as markPerformance, S as ShellView } from './foundation.js?v=bc116afe';
...
const WIDGETS = {
	BaseList: () => import('./baseList.js?v=bc116afe'),
	CategoryInfo: () => import('./category.js?v=bc116afe'),
	CollaborativeDocument: () => import('./collaborative.js?v=bc116afe'),
	CreateCategory: () => import('./category.js?v=bc116afe'),
	CreateForm: () => import('./form.js?v=bc116afe'),
	CreateModelTask: () => import('./modelTasks.js?v=bc116afe'),
	CreateNote: () => import('./note.js?v=bc116afe'),
	CreatePage: () => import('./pageInfo.js?v=bc116afe'),
	CreateProject: () => import('./projectInfo.js?v=bc116afe'),
	CreateToolReport: () => import('./tools.js?v=bc116afe'),
	CreateUserTask: () => import('./taskSettings.js?v=bc116afe'),
	CreateTask: () => import('./taskSettings.js?v=bc116afe'),
	CreateUser: () => import('./user.js?v=bc116afe'),
	CreateUserGroup: () => import('./user.js?v=bc116afe'),
	DirectoryList: () => import('./lists.js?v=bc116afe'),
	DocumentSettings: () => import('./documentSettings.js?v=bc116afe'),
	FileInfo: () => import('./fileInfo.js?v=bc116afe'),
	PDFPreview: () => import('./filePdfPreview.js?v=bc116afe'),
	FileUpload: () => import('./uploadFile.js?v=bc116afe'),
	Filters: () => import('./filters.js?v=bc116afe'),
	FilterResults: () => import('./tables.js?v=bc116afe'),
	GeneratePages: () => import('./category.js?v=bc116afe'),
	GroupPermissions: () => import('./user.js?v=bc116afe'),
	HomeActivityList: () => import('./activity.js?v=bc116afe'),
	HomePageList: () => import('./lists.js?v=bc116afe'),
	HomeTaskList: () => import('./tasks.js?v=bc116afe'),
	HomeProjectList: () => import('./lists.js?v=bc116afe'),
	HomeCategoryList: () => import('./lists.js?v=bc116afe'),
	ImportData: () => import('./ingress.js?v=bc116afe'),
	IndexTable: () => import('./tables.js?v=bc116afe'),
	IngressFileUpload: () => import('./ingressUpload.js?v=bc116afe'),
	IngressList: () => import('./lists.js?v=bc116afe'),
	MobileTableControls: () => import('./mobileTableControls.js?v=bc116afe'),
	ModelTaskInfo: () => import('./modelTasks.js?v=bc116afe'),
	ModelTaskList: () => import('./modelTasks.js?v=bc116afe'),
	PageInfo: () => import('./pageInfo.js?v=bc116afe'),
	PagePermissions: () => import('./pagePermissions.js?v=bc116afe'),
	PagePhoto: () => import('./pagePhoto.js?v=bc116afe'),
	PageTaskList: () => import('./pageTaskList.js?v=bc116afe'),
	ProjectInfo: () => import('./projectInfo.js?v=bc116afe'),
	PublicPermissions: () => import('./user.js?v=bc116afe'),
	SavedFilters: () => import('./filters.js?v=bc116afe'),
	SiteExport: () => import('./siteExport.js?v=bc116afe'),
	SiteAiModels: () => import('./aiModels.js?v=bc116afe'),
	SiteDeployment: () => import('./deployment.js?v=bc116afe'),
	SiteImage: () => import('./image.js?v=bc116afe'),
	SiteMaintenance: () => import('./maintenance.js?v=bc116afe'),
	SiteServiceProviders: () => import('./providers.js?v=bc116afe'),
	SiteSettings: () => import('./siteSettings.js?v=bc116afe'),
	StarredList: () => import('./lists.js?v=bc116afe'),
	TableEditor: () => import('./tableEditor.js?v=bc116afe'),
	TableSorting: () => import('./tableSorting.js?v=bc116afe'),
	TableVisibility: () => import('./tableVisibility.js?v=bc116afe'),
	TaskForm: () => import('./taskForm.js?v=bc116afe'),
	TaskHistory: () => import('./tables.js?v=bc116afe'),
	TaskCombine: () => import('./taskSettings.js?v=bc116afe'),
	TaskMove: () => import('./taskSettings.js?v=bc116afe'),
	ToolReportList: () => import('./lists.js?v=bc116afe'),
	TaskSettings: () => import('./taskSettings.js?v=bc116afe'),
	UserSettings: () => import('./pageInfo.js?v=bc116afe'),
};

/** Sync-capable widgets that can run without a mounted view (offline replay). */
const HEADLESS_WIDGETS = {
	document: {
		load: () => import('./collaborative.js?v=bc116afe'),
...
const ensureOfflineQueue = (view) =>
	loadOnce(view, "_offlineQueuePromise", "offlineQueue", async () => {
		const { OfflineQueue } = await import('./offlineQueue.js?v=bc116afe');
...
const ensurePollingCoordinator = (view) =>
	loadOnce(view, "_pollingPromise", "PollingCoordinator", async () => {
		const { PollingCoordinator } = await import('./polling.js?v=bc116afe');
		if (view._destroyed) return null;
...
const ensureSyncManager = (view) =>
	loadOnce(view, "_syncPromise", "SyncManager", async () => {
		...
		const { SyncManager } = await import('./sync.js?v=bc116afe');
		if (view._destroyed) return null;
...
const ensureEditWatcher = (view) =>
	loadOnce(view, "_editWatcherPromise", "EditWatcher", async () => {
		await ensurePollingCoordinator(view);
		const { EditWatcher } = await import('./editWatcher.js?v=bc116afe');
		if (view._destroyed) return null;
	...
	loadOnce(
		...
		async () => {
			...
			const { DeferredOperationManager } = await import(
				'./deferredOperations.js?v=bc116afe'
			);
			if (view._destroyed) return null;
...
const ensureNotifications = (view) =>
	loadOnce(view, "_notificationsPromise", "Notifications", async () => {
		...
		const { Notifications } = await import('./notifications.js?v=bc116afe');
		if (view._destroyed) return null;
...
const ensureSearchBox = (view) =>
	loadOnce(view, "_searchPromise", "SearchBox", async () => {
		...
		const { SearchBox } = await import('./search.js?v=bc116afe');
		if (view._destroyed) return null;
...
const ensureEntityMenu = (view) =>
	loadOnce(view, "_entityMenuPromise", "EntityMenu", async () => {
		const { EntityMenu } = await import('./entityMenu.js?v=bc116afe');
		if (view._destroyed) return null;
...
const ensureSubmissionManager = (view) =>
	loadOnce(view, "_submissionPromise", "SubmissionManager", async () => {
		const { SubmissionManager } = await import('./submission.js?v=bc116afe');
		if (view._destroyed) return null;
...
const ensureOfflineModal = (view) =>
	loadOnce(view, "_offlineModalPromise", "offlineModal", async () => {
		...
		const { OfflineModal } = await import('./modal.js?v=bc116afe');
		if (view._destroyed) return null;
...
const initializeCoreServices = (view) => {
	...
	const offlineWork = idle.then(async () => {
		const { inspectOfflineWork } = await import('./offlineWork.js?v=bc116afe');
	...
	view.initialReplayReady = view.offlineQueueReady.then(async (queue) => {
		if (!queue) return 0;
		const { replayOfflineQueue } = await import('./offlineReplay.js?v=bc116afe');
...
class Core extends ShellView {
	...
	scheduleOfflineReplay() {
		...
		const replay = import('./offlineReplay.js?v=bc116afe').then(({ replayOfflineQueue }) =>
