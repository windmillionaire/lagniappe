...
import { c as connectivity } from './connectivity.js?v=b564d2b9';
import { c as captureError, E as ENDPOINTS, w as withTransition, a as clearRecentSearchResults, r as request, b as whenIdle, m as markPerformance, S as ShellView } from './foundation.js?v=b564d2b9';
...
const WIDGETS = {
	BaseList: () => import('./baseList.js?v=b564d2b9'),
	CategoryInfo: () => import('./category.js?v=b564d2b9'),
	CollaborativeDocument: () => import('./collaborative.js?v=b564d2b9'),
	CreateCategory: () => import('./category.js?v=b564d2b9'),
	CreateForm: () => import('./form.js?v=b564d2b9'),
	CreateModelTask: () => import('./modelTasks.js?v=b564d2b9'),
	CreateNote: () => import('./note.js?v=b564d2b9'),
	CreatePage: () => import('./pageInfo.js?v=b564d2b9'),
	CreateProject: () => import('./projectInfo.js?v=b564d2b9'),
	CreateToolReport: () => import('./tools.js?v=b564d2b9'),
	CreateUserTask: () => import('./taskSettings.js?v=b564d2b9'),
	CreateTask: () => import('./taskSettings.js?v=b564d2b9'),
	CreateUser: () => import('./user.js?v=b564d2b9'),
	CreateUserGroup: () => import('./user.js?v=b564d2b9'),
	DirectoryList: () => import('./lists.js?v=b564d2b9'),
	DocumentSettings: () => import('./documentSettings.js?v=b564d2b9'),
	FileInfo: () => import('./fileInfo.js?v=b564d2b9'),
	PDFPreview: () => import('./filePdfPreview.js?v=b564d2b9'),
	FileUpload: () => import('./uploadFile.js?v=b564d2b9'),
	Filters: () => import('./filters.js?v=b564d2b9'),
	FilterResults: () => import('./tables.js?v=b564d2b9'),
	GroupPermissions: () => import('./user.js?v=b564d2b9'),
	HomeActivityList: () => import('./activity.js?v=b564d2b9'),
	HomePageList: () => import('./lists.js?v=b564d2b9'),
	HomeTaskList: () => import('./tasks.js?v=b564d2b9'),
	HomeProjectList: () => import('./lists.js?v=b564d2b9'),
	HomeCategoryList: () => import('./lists.js?v=b564d2b9'),
	ImportData: () => import('./ingress.js?v=b564d2b9'),
	IndexTable: () => import('./tables.js?v=b564d2b9'),
	IngressFileUpload: () => import('./ingressUpload.js?v=b564d2b9'),
	IngressList: () => import('./lists.js?v=b564d2b9'),
	MobileTableControls: () => import('./mobileTableControls.js?v=b564d2b9'),
	ModelTaskInfo: () => import('./modelTasks.js?v=b564d2b9'),
	ModelTaskList: () => import('./modelTasks.js?v=b564d2b9'),
	PageInfo: () => import('./pageInfo.js?v=b564d2b9'),
	PagePermissions: () => import('./pagePermissions.js?v=b564d2b9'),
	PagePhoto: () => import('./pagePhoto.js?v=b564d2b9'),
	PageTaskList: () => import('./pageTaskList.js?v=b564d2b9'),
	ProjectInfo: () => import('./projectInfo.js?v=b564d2b9'),
	PublicPermissions: () => import('./user.js?v=b564d2b9'),
	SavedFilters: () => import('./filters.js?v=b564d2b9'),
	SiteAiModels: () => import('./aiModels.js?v=b564d2b9'),
	SiteAdministrators: () => import('./administrators.js?v=b564d2b9'),
	SiteDeployment: () => import('./deployment.js?v=b564d2b9'),
	SiteInstallationAccess: () => import('./installationAccess.js?v=b564d2b9'),
	SiteImage: () => import('./image.js?v=b564d2b9'),
	SiteMaintenance: () => import('./maintenance.js?v=b564d2b9'),
	SiteServiceProviders: () => import('./providers.js?v=b564d2b9'),
	SiteSettings: () => import('./siteSettings.js?v=b564d2b9'),
	StarredList: () => import('./lists.js?v=b564d2b9'),
	TableEditor: () => import('./tableEditor.js?v=b564d2b9'),
	TableSorting: () => import('./tableSorting.js?v=b564d2b9'),
	TableVisibility: () => import('./tableVisibility.js?v=b564d2b9'),
	TaskForm: () => import('./taskForm.js?v=b564d2b9'),
	TaskHistory: () => import('./tables.js?v=b564d2b9'),
	TaskCombine: () => import('./taskSettings.js?v=b564d2b9'),
	TaskMove: () => import('./taskSettings.js?v=b564d2b9'),
	ToolReportList: () => import('./lists.js?v=b564d2b9'),
	TaskSettings: () => import('./taskSettings.js?v=b564d2b9'),
	UserSettings: () => import('./pageInfo.js?v=b564d2b9'),
};

/** Sync-capable widgets that can run without a mounted view (offline replay). */
const HEADLESS_WIDGETS = {
	document: {
		load: () => import('./collaborative.js?v=b564d2b9'),
...
const ensureOfflineQueue = (view) =>
	loadOnce(view, "_offlineQueuePromise", "offlineQueue", async () => {
		const { OfflineQueue } = await import('./offlineQueue.js?v=b564d2b9');
...
const ensurePollingCoordinator = (view) =>
	loadOnce(view, "_pollingPromise", "PollingCoordinator", async () => {
		const { PollingCoordinator } = await import('./polling.js?v=b564d2b9');
		if (view._destroyed) return null;
...
const ensureSyncManager = (view) =>
	loadOnce(view, "_syncPromise", "SyncManager", async () => {
		...
		const { SyncManager } = await import('./sync.js?v=b564d2b9');
		if (view._destroyed) return null;
...
const ensureEditWatcher = (view) =>
	loadOnce(view, "_editWatcherPromise", "EditWatcher", async () => {
		await ensurePollingCoordinator(view);
		const { EditWatcher } = await import('./editWatcher.js?v=b564d2b9');
		if (view._destroyed) return null;
	...
	loadOnce(
		...
		async () => {
			...
			const { DeferredOperationManager } = await import(
				'./deferredOperations.js?v=b564d2b9'
			);
			if (view._destroyed) return null;
...
const ensureNotifications = (view) =>
	loadOnce(view, "_notificationsPromise", "Notifications", async () => {
		...
		const { Notifications } = await import('./notifications.js?v=b564d2b9');
		if (view._destroyed) return null;
...
const ensureSearchBox = (view) =>
	loadOnce(view, "_searchPromise", "SearchBox", async () => {
		...
		const { SearchBox } = await import('./search.js?v=b564d2b9');
		if (view._destroyed) return null;
...
const ensureEntityMenu = (view) =>
	loadOnce(view, "_entityMenuPromise", "EntityMenu", async () => {
		const { EntityMenu } = await import('./entityMenu.js?v=b564d2b9');
		if (view._destroyed) return null;
...
const ensureSubmissionManager = (view) =>
	loadOnce(view, "_submissionPromise", "SubmissionManager", async () => {
		const { SubmissionManager } = await import('./submission.js?v=b564d2b9');
		if (view._destroyed) return null;
...
const ensureOfflineModal = (view) =>
	loadOnce(view, "_offlineModalPromise", "offlineModal", async () => {
		...
		const { OfflineModal } = await import('./modal.js?v=b564d2b9');
		if (view._destroyed) return null;
...
const initializeCoreServices = (view) => {
	...
	const offlineWork = idle.then(async () => {
		const { inspectOfflineWork } = await import('./offlineWork.js?v=b564d2b9');
	...
	view.initialReplayReady = view.offlineQueueReady.then(async (queue) => {
		if (!queue) return 0;
		const { replayOfflineQueue } = await import('./offlineReplay.js?v=b564d2b9');
...
class Core extends ShellView {
	...
	scheduleOfflineReplay() {
		...
		const replay = import('./offlineReplay.js?v=b564d2b9').then(({ replayOfflineQueue }) =>
