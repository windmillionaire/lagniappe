...
import { c as connectivity } from './connectivity.js?v=ba9311bf';
import { c as captureError, E as ENDPOINTS, w as withTransition, s as showBriefly, a as clearRecentSearchResults, r as request, b as whenIdle, m as markPerformance, S as ShellView } from './foundation.js?v=ba9311bf';
...
const WIDGETS = {
	BaseList: () => import('./baseList.js?v=ba9311bf'),
	CategoryInfo: () => import('./category.js?v=ba9311bf'),
	CollaborativeDocument: () => import('./collaborative.js?v=ba9311bf'),
	CreateCategory: () => import('./category.js?v=ba9311bf'),
	CreateForm: () => import('./form.js?v=ba9311bf'),
	CreateModelTask: () => import('./modelTasks.js?v=ba9311bf'),
	CreateNote: () => import('./note.js?v=ba9311bf'),
	CreatePage: () => import('./pageInfo.js?v=ba9311bf'),
	CreateProject: () => import('./projectInfo.js?v=ba9311bf'),
	CreateToolReport: () => import('./tools.js?v=ba9311bf'),
	CreateUserTask: () => import('./taskSettings.js?v=ba9311bf'),
	CreateTask: () => import('./taskSettings.js?v=ba9311bf'),
	CreateUser: () => import('./user.js?v=ba9311bf'),
	CreateUserGroup: () => import('./user.js?v=ba9311bf'),
	DirectoryList: () => import('./lists.js?v=ba9311bf'),
	DocumentSettings: () => import('./documentSettings.js?v=ba9311bf'),
	FileInfo: () => import('./fileInfo.js?v=ba9311bf'),
	PDFPreview: () => import('./filePdfPreview.js?v=ba9311bf'),
	FileUpload: () => import('./uploadFile.js?v=ba9311bf'),
	Filters: () => import('./filters.js?v=ba9311bf'),
	FilterResults: () => import('./tables.js?v=ba9311bf'),
	GeneratePages: () => import('./category.js?v=ba9311bf'),
	GroupPermissions: () => import('./user.js?v=ba9311bf'),
	HomeActivityList: () => import('./activity.js?v=ba9311bf'),
	HomePageList: () => import('./lists.js?v=ba9311bf'),
	HomeTaskList: () => import('./tasks.js?v=ba9311bf'),
	HomeProjectList: () => import('./lists.js?v=ba9311bf'),
	HomeCategoryList: () => import('./lists.js?v=ba9311bf'),
	ImportData: () => import('./ingress.js?v=ba9311bf'),
	IndexTable: () => import('./tables.js?v=ba9311bf'),
	IngressFileUpload: () => import('./ingressUpload.js?v=ba9311bf'),
	IngressList: () => import('./lists.js?v=ba9311bf'),
	MobileTableControls: () => import('./mobileTableControls.js?v=ba9311bf'),
	ModelTaskInfo: () => import('./modelTasks.js?v=ba9311bf'),
	ModelTaskList: () => import('./modelTasks.js?v=ba9311bf'),
	PageInfo: () => import('./pageInfo.js?v=ba9311bf'),
	PagePermissions: () => import('./pagePermissions.js?v=ba9311bf'),
	PagePhoto: () => import('./pagePhoto.js?v=ba9311bf'),
	PageTaskList: () => import('./pageTaskList.js?v=ba9311bf'),
	ProjectInfo: () => import('./projectInfo.js?v=ba9311bf'),
	PublicPermissions: () => import('./user.js?v=ba9311bf'),
	SavedFilters: () => import('./filters.js?v=ba9311bf'),
	SiteExport: () => import('./siteExport.js?v=ba9311bf'),
	SiteAiModels: () => import('./aiModels.js?v=ba9311bf'),
	SiteDeployment: () => import('./deployment.js?v=ba9311bf'),
	SiteImage: () => import('./image.js?v=ba9311bf'),
	SiteMaintenance: () => import('./maintenance.js?v=ba9311bf'),
	SiteServiceProviders: () => import('./providers.js?v=ba9311bf'),
	SiteSettings: () => import('./siteSettings.js?v=ba9311bf'),
	StarredList: () => import('./lists.js?v=ba9311bf'),
	TableEditor: () => import('./tableEditor.js?v=ba9311bf'),
	TableSorting: () => import('./tableSorting.js?v=ba9311bf'),
	TableVisibility: () => import('./tableVisibility.js?v=ba9311bf'),
	TaskForm: () => import('./taskForm.js?v=ba9311bf'),
	TaskHistory: () => import('./tables.js?v=ba9311bf'),
	TaskCombine: () => import('./taskSettings.js?v=ba9311bf'),
	TaskMove: () => import('./taskSettings.js?v=ba9311bf'),
	ToolReportList: () => import('./lists.js?v=ba9311bf'),
	TaskSettings: () => import('./taskSettings.js?v=ba9311bf'),
	UserSettings: () => import('./pageInfo.js?v=ba9311bf'),
};

/** Sync-capable widgets that can run without a mounted view (offline replay). */
const HEADLESS_WIDGETS = {
	document: {
		load: () => import('./collaborative.js?v=ba9311bf'),
...
const ensureOfflineQueue = (view) =>
	loadOnce(view, "_offlineQueuePromise", "offlineQueue", async () => {
		const { OfflineQueue } = await import('./offlineQueue.js?v=ba9311bf');
...
const ensurePollingCoordinator = (view) =>
	loadOnce(view, "_pollingPromise", "PollingCoordinator", async () => {
		const { PollingCoordinator } = await import('./polling.js?v=ba9311bf');
		if (view._destroyed) return null;
...
const ensureSyncManager = (view) =>
	loadOnce(view, "_syncPromise", "SyncManager", async () => {
		...
		const { SyncManager } = await import('./sync.js?v=ba9311bf');
		if (view._destroyed) return null;
...
const ensureEditWatcher = (view) =>
	loadOnce(view, "_editWatcherPromise", "EditWatcher", async () => {
		await ensurePollingCoordinator(view);
		const { EditWatcher } = await import('./editWatcher.js?v=ba9311bf');
		if (view._destroyed) return null;
	...
	loadOnce(
		...
		async () => {
			...
			const { DeferredOperationManager } = await import(
				'./deferredOperations.js?v=ba9311bf'
			);
			if (view._destroyed) return null;
...
const ensureNotifications = (view) =>
	loadOnce(view, "_notificationsPromise", "Notifications", async () => {
		...
		const { Notifications } = await import('./notifications.js?v=ba9311bf');
		if (view._destroyed) return null;
...
const ensureSearchBox = (view) =>
	loadOnce(view, "_searchPromise", "SearchBox", async () => {
		...
		const { SearchBox } = await import('./search.js?v=ba9311bf');
		if (view._destroyed) return null;
...
const ensureEntityMenu = (view) =>
	loadOnce(view, "_entityMenuPromise", "EntityMenu", async () => {
		const { EntityMenu } = await import('./entityMenu.js?v=ba9311bf');
		if (view._destroyed) return null;
...
const ensureSubmissionManager = (view) =>
	loadOnce(view, "_submissionPromise", "SubmissionManager", async () => {
		const { SubmissionManager } = await import('./submission.js?v=ba9311bf');
		if (view._destroyed) return null;
...
const ensureOfflineModal = (view) =>
	loadOnce(view, "_offlineModalPromise", "offlineModal", async () => {
		...
		const { OfflineModal } = await import('./modal.js?v=ba9311bf');
		if (view._destroyed) return null;
...
const initializeCoreServices = (view) => {
	...
	const offlineWork = idle.then(async () => {
		const { inspectOfflineWork } = await import('./offlineWork.js?v=ba9311bf');
	...
	view.initialReplayReady = view.offlineQueueReady.then(async (queue) => {
		if (!queue) return 0;
		const { replayOfflineQueue } = await import('./offlineReplay.js?v=ba9311bf');
...
class Core extends ShellView {
	...
	scheduleOfflineReplay() {
		...
		const replay = import('./offlineReplay.js?v=ba9311bf').then(({ replayOfflineQueue }) =>
