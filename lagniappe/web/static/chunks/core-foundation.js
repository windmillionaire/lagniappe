...
import { c as connectivity } from './connectivity.js?v=b5fa0583';
import { c as captureError, E as ENDPOINTS, w as withTransition, a as clearRecentSearchResults, r as request, b as whenIdle, m as markPerformance, S as ShellView } from './foundation.js?v=b5fa0583';
...
const WIDGETS = {
	BaseList: () => import('./baseList.js?v=b5fa0583'),
	CategoryInfo: () => import('./category.js?v=b5fa0583'),
	CollaborativeDocument: () => import('./collaborative.js?v=b5fa0583'),
	CreateCategory: () => import('./category.js?v=b5fa0583'),
	CreateForm: () => import('./form.js?v=b5fa0583'),
	CreateModelTask: () => import('./modelTasks.js?v=b5fa0583'),
	CreateNote: () => import('./note.js?v=b5fa0583'),
	CreatePage: () => import('./pageInfo.js?v=b5fa0583'),
	CreateProject: () => import('./projectInfo.js?v=b5fa0583'),
	CreateToolReport: () => import('./tools.js?v=b5fa0583'),
	CreateUserTask: () => import('./taskSettings.js?v=b5fa0583'),
	CreateTask: () => import('./taskSettings.js?v=b5fa0583'),
	CreateUser: () => import('./user.js?v=b5fa0583'),
	CreateUserGroup: () => import('./user.js?v=b5fa0583'),
	DirectoryList: () => import('./lists.js?v=b5fa0583'),
	DocumentSettings: () => import('./documentSettings.js?v=b5fa0583'),
	FileInfo: () => import('./fileInfo.js?v=b5fa0583'),
	PDFPreview: () => import('./filePdfPreview.js?v=b5fa0583'),
	FileUpload: () => import('./uploadFile.js?v=b5fa0583'),
	Filters: () => import('./filters.js?v=b5fa0583'),
	FilterResults: () => import('./tables.js?v=b5fa0583'),
	GroupPermissions: () => import('./user.js?v=b5fa0583'),
	HomeActivityList: () => import('./activity.js?v=b5fa0583'),
	HomePageList: () => import('./lists.js?v=b5fa0583'),
	HomeTaskList: () => import('./tasks.js?v=b5fa0583'),
	HomeProjectList: () => import('./lists.js?v=b5fa0583'),
	HomeCategoryList: () => import('./lists.js?v=b5fa0583'),
	ImportData: () => import('./ingress.js?v=b5fa0583'),
	IndexTable: () => import('./tables.js?v=b5fa0583'),
	IngressFileUpload: () => import('./ingressUpload.js?v=b5fa0583'),
	IngressList: () => import('./lists.js?v=b5fa0583'),
	MobileTableControls: () => import('./mobileTableControls.js?v=b5fa0583'),
	ModelTaskInfo: () => import('./modelTasks.js?v=b5fa0583'),
	ModelTaskList: () => import('./modelTasks.js?v=b5fa0583'),
	PageInfo: () => import('./pageInfo.js?v=b5fa0583'),
	PagePermissions: () => import('./pagePermissions.js?v=b5fa0583'),
	PagePhoto: () => import('./pagePhoto.js?v=b5fa0583'),
	PageTaskList: () => import('./pageTaskList.js?v=b5fa0583'),
	ProjectInfo: () => import('./projectInfo.js?v=b5fa0583'),
	PublicPermissions: () => import('./user.js?v=b5fa0583'),
	SavedFilters: () => import('./filters.js?v=b5fa0583'),
	SiteAiModels: () => import('./aiModels.js?v=b5fa0583'),
	SiteAdministrators: () => import('./administrators.js?v=b5fa0583'),
	SiteDeployment: () => import('./deployment.js?v=b5fa0583'),
	SiteInstallationAccess: () => import('./installationAccess.js?v=b5fa0583'),
	SiteImage: () => import('./image.js?v=b5fa0583'),
	SiteMaintenance: () => import('./maintenance.js?v=b5fa0583'),
	SiteServiceProviders: () => import('./providers.js?v=b5fa0583'),
	SiteSettings: () => import('./siteSettings.js?v=b5fa0583'),
	StarredList: () => import('./lists.js?v=b5fa0583'),
	TableEditor: () => import('./tableEditor.js?v=b5fa0583'),
	TableSorting: () => import('./tableSorting.js?v=b5fa0583'),
	TableVisibility: () => import('./tableVisibility.js?v=b5fa0583'),
	TaskForm: () => import('./taskForm.js?v=b5fa0583'),
	TaskHistory: () => import('./tables.js?v=b5fa0583'),
	TaskCombine: () => import('./taskSettings.js?v=b5fa0583'),
	TaskMove: () => import('./taskSettings.js?v=b5fa0583'),
	ToolReportList: () => import('./lists.js?v=b5fa0583'),
	TaskSettings: () => import('./taskSettings.js?v=b5fa0583'),
	UserSettings: () => import('./pageInfo.js?v=b5fa0583'),
};

/** Sync-capable widgets that can run without a mounted view (offline replay). */
const HEADLESS_WIDGETS = {
	document: {
		load: () => import('./collaborative.js?v=b5fa0583'),
...
const ensureOfflineQueue = (view) =>
	loadOnce(view, "_offlineQueuePromise", "offlineQueue", async () => {
		const { OfflineQueue } = await import('./offlineQueue.js?v=b5fa0583');
...
const ensurePollingCoordinator = (view) =>
	loadOnce(view, "_pollingPromise", "PollingCoordinator", async () => {
		const { PollingCoordinator } = await import('./polling.js?v=b5fa0583');
		if (view._destroyed) return null;
...
const ensureSyncManager = (view) =>
	loadOnce(view, "_syncPromise", "SyncManager", async () => {
		...
		const { SyncManager } = await import('./sync.js?v=b5fa0583');
		if (view._destroyed) return null;
...
const ensureEditWatcher = (view) =>
	loadOnce(view, "_editWatcherPromise", "EditWatcher", async () => {
		await ensurePollingCoordinator(view);
		const { EditWatcher } = await import('./editWatcher.js?v=b5fa0583');
		if (view._destroyed) return null;
	...
	loadOnce(
		...
		async () => {
			...
			const { DeferredOperationManager } = await import(
				'./deferredOperations.js?v=b5fa0583'
			);
			if (view._destroyed) return null;
...
const ensureNotifications = (view) =>
	loadOnce(view, "_notificationsPromise", "Notifications", async () => {
		...
		const { Notifications } = await import('./notifications.js?v=b5fa0583');
		if (view._destroyed) return null;
...
const ensureSearchBox = (view) =>
	loadOnce(view, "_searchPromise", "SearchBox", async () => {
		...
		const { SearchBox } = await import('./search.js?v=b5fa0583');
		if (view._destroyed) return null;
...
const ensureEntityMenu = (view) =>
	loadOnce(view, "_entityMenuPromise", "EntityMenu", async () => {
		const { EntityMenu } = await import('./entityMenu.js?v=b5fa0583');
		if (view._destroyed) return null;
...
const ensureSubmissionManager = (view) =>
	loadOnce(view, "_submissionPromise", "SubmissionManager", async () => {
		const { SubmissionManager } = await import('./submission.js?v=b5fa0583');
		if (view._destroyed) return null;
...
const ensureOfflineModal = (view) =>
	loadOnce(view, "_offlineModalPromise", "offlineModal", async () => {
		...
		const { OfflineModal } = await import('./modal.js?v=b5fa0583');
		if (view._destroyed) return null;
...
const initializeCoreServices = (view) => {
	...
	const offlineWork = idle.then(async () => {
		const { inspectOfflineWork } = await import('./offlineWork.js?v=b5fa0583');
	...
	view.initialReplayReady = view.offlineQueueReady.then(async (queue) => {
		if (!queue) return 0;
		const { replayOfflineQueue } = await import('./offlineReplay.js?v=b5fa0583');
...
class Core extends ShellView {
	...
	scheduleOfflineReplay() {
		...
		const replay = import('./offlineReplay.js?v=b5fa0583').then(({ replayOfflineQueue }) =>
