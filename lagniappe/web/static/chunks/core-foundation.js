...
import { c as connectivity } from './connectivity.js?v=b13679a7';
import { c as captureError, E as ENDPOINTS, w as withTransition, s as showBriefly, a as clearRecentSearchResults, r as request, b as whenIdle, m as markPerformance, S as ShellView } from './foundation.js?v=b13679a7';
...
const WIDGETS = {
	BaseList: () => import('./baseList.js?v=b13679a7'),
	CategoryInfo: () => import('./category.js?v=b13679a7'),
	CollaborativeDocument: () => import('./collaborative.js?v=b13679a7'),
	CreateCategory: () => import('./category.js?v=b13679a7'),
	CreateForm: () => import('./form.js?v=b13679a7'),
	CreateModelTask: () => import('./modelTasks.js?v=b13679a7'),
	CreateNote: () => import('./note.js?v=b13679a7'),
	CreatePage: () => import('./pageInfo.js?v=b13679a7'),
	CreateProject: () => import('./projectInfo.js?v=b13679a7'),
	CreateToolReport: () => import('./tools.js?v=b13679a7'),
	CreateUserTask: () => import('./taskSettings.js?v=b13679a7'),
	CreateTask: () => import('./taskSettings.js?v=b13679a7'),
	CreateUser: () => import('./user.js?v=b13679a7'),
	CreateUserGroup: () => import('./user.js?v=b13679a7'),
	DirectoryList: () => import('./lists.js?v=b13679a7'),
	DocumentSettings: () => import('./documentSettings.js?v=b13679a7'),
	FileInfo: () => import('./fileInfo.js?v=b13679a7'),
	PDFPreview: () => import('./filePdfPreview.js?v=b13679a7'),
	FileUpload: () => import('./uploadFile.js?v=b13679a7'),
	Filters: () => import('./filters.js?v=b13679a7'),
	FilterResults: () => import('./tables.js?v=b13679a7'),
	GeneratePages: () => import('./category.js?v=b13679a7'),
	GroupPermissions: () => import('./user.js?v=b13679a7'),
	HomeActivityList: () => import('./activity.js?v=b13679a7'),
	HomePageList: () => import('./lists.js?v=b13679a7'),
	HomeTaskList: () => import('./tasks.js?v=b13679a7'),
	HomeProjectList: () => import('./lists.js?v=b13679a7'),
	HomeCategoryList: () => import('./lists.js?v=b13679a7'),
	ImportData: () => import('./ingress.js?v=b13679a7'),
	IndexTable: () => import('./tables.js?v=b13679a7'),
	IngressFileUpload: () => import('./ingressUpload.js?v=b13679a7'),
	IngressList: () => import('./lists.js?v=b13679a7'),
	MobileTableControls: () => import('./mobileTableControls.js?v=b13679a7'),
	ModelTaskInfo: () => import('./modelTasks.js?v=b13679a7'),
	ModelTaskList: () => import('./modelTasks.js?v=b13679a7'),
	PageInfo: () => import('./pageInfo.js?v=b13679a7'),
	PagePermissions: () => import('./pagePermissions.js?v=b13679a7'),
	PagePhoto: () => import('./pagePhoto.js?v=b13679a7'),
	PageTaskList: () => import('./pageTaskList.js?v=b13679a7'),
	ProjectInfo: () => import('./projectInfo.js?v=b13679a7'),
	PublicPermissions: () => import('./user.js?v=b13679a7'),
	SavedFilters: () => import('./filters.js?v=b13679a7'),
	SiteExport: () => import('./siteExport.js?v=b13679a7'),
	SiteAiModels: () => import('./aiModels.js?v=b13679a7'),
	SiteDeployment: () => import('./deployment.js?v=b13679a7'),
	SiteImage: () => import('./image.js?v=b13679a7'),
	SiteMaintenance: () => import('./maintenance.js?v=b13679a7'),
	SiteServiceProviders: () => import('./providers.js?v=b13679a7'),
	SiteSettings: () => import('./siteSettings.js?v=b13679a7'),
	StarredList: () => import('./lists.js?v=b13679a7'),
	TableEditor: () => import('./tableEditor.js?v=b13679a7'),
	TableSorting: () => import('./tableSorting.js?v=b13679a7'),
	TableVisibility: () => import('./tableVisibility.js?v=b13679a7'),
	TaskForm: () => import('./taskForm.js?v=b13679a7'),
	TaskHistory: () => import('./tables.js?v=b13679a7'),
	TaskCombine: () => import('./taskSettings.js?v=b13679a7'),
	TaskMove: () => import('./taskSettings.js?v=b13679a7'),
	ToolReportList: () => import('./lists.js?v=b13679a7'),
	TaskSettings: () => import('./taskSettings.js?v=b13679a7'),
	UserSettings: () => import('./pageInfo.js?v=b13679a7'),
};

/** Sync-capable widgets that can run without a mounted view (offline replay). */
const HEADLESS_WIDGETS = {
	document: {
		load: () => import('./collaborative.js?v=b13679a7'),
...
const ensureOfflineQueue = (view) =>
	loadOnce(view, "_offlineQueuePromise", "offlineQueue", async () => {
		const { OfflineQueue } = await import('./offlineQueue.js?v=b13679a7');
...
const ensurePollingCoordinator = (view) =>
	loadOnce(view, "_pollingPromise", "PollingCoordinator", async () => {
		const { PollingCoordinator } = await import('./polling.js?v=b13679a7');
		if (view._destroyed) return null;
...
const ensureSyncManager = (view) =>
	loadOnce(view, "_syncPromise", "SyncManager", async () => {
		...
		const { SyncManager } = await import('./sync.js?v=b13679a7');
		if (view._destroyed) return null;
...
const ensureEditWatcher = (view) =>
	loadOnce(view, "_editWatcherPromise", "EditWatcher", async () => {
		await ensurePollingCoordinator(view);
		const { EditWatcher } = await import('./editWatcher.js?v=b13679a7');
		if (view._destroyed) return null;
	...
	loadOnce(
		...
		async () => {
			...
			const { DeferredOperationManager } = await import(
				'./deferredOperations.js?v=b13679a7'
			);
			if (view._destroyed) return null;
...
const ensureNotifications = (view) =>
	loadOnce(view, "_notificationsPromise", "Notifications", async () => {
		...
		const { Notifications } = await import('./notifications.js?v=b13679a7');
		if (view._destroyed) return null;
...
const ensureSearchBox = (view) =>
	loadOnce(view, "_searchPromise", "SearchBox", async () => {
		...
		const { SearchBox } = await import('./search.js?v=b13679a7');
		if (view._destroyed) return null;
...
const ensureEntityMenu = (view) =>
	loadOnce(view, "_entityMenuPromise", "EntityMenu", async () => {
		const { EntityMenu } = await import('./entityMenu.js?v=b13679a7');
		if (view._destroyed) return null;
...
const ensureSubmissionManager = (view) =>
	loadOnce(view, "_submissionPromise", "SubmissionManager", async () => {
		const { SubmissionManager } = await import('./submission.js?v=b13679a7');
		if (view._destroyed) return null;
...
const ensureOfflineModal = (view) =>
	loadOnce(view, "_offlineModalPromise", "offlineModal", async () => {
		...
		const { OfflineModal } = await import('./modal.js?v=b13679a7');
		if (view._destroyed) return null;
...
const initializeCoreServices = (view) => {
	...
	const offlineWork = idle.then(async () => {
		const { inspectOfflineWork } = await import('./offlineWork.js?v=b13679a7');
	...
	view.initialReplayReady = view.offlineQueueReady.then(async (queue) => {
		if (!queue) return 0;
		const { replayOfflineQueue } = await import('./offlineReplay.js?v=b13679a7');
...
class Core extends ShellView {
	...
	scheduleOfflineReplay() {
		...
		this._offlineReplayTask = import('./offlineReplay.js?v=b13679a7')
