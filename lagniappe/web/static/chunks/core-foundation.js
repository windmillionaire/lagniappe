...
import { c as connectivity } from './connectivity.js?v=b110e8d6';
import { c as captureError, E as ENDPOINTS, w as withTransition, s as showBriefly, a as clearRecentSearchResults, r as request, b as whenIdle, m as markPerformance, S as ShellView } from './foundation.js?v=b110e8d6';
...
const WIDGETS = {
	BaseList: () => import('./baseList.js?v=b110e8d6'),
	CategoryInfo: () => import('./category.js?v=b110e8d6'),
	CollaborativeDocument: () => import('./collaborative.js?v=b110e8d6'),
	CreateCategory: () => import('./category.js?v=b110e8d6'),
	CreateForm: () => import('./form.js?v=b110e8d6'),
	CreateModelTask: () => import('./modelTasks.js?v=b110e8d6'),
	CreateNote: () => import('./note.js?v=b110e8d6'),
	CreatePage: () => import('./pageInfo.js?v=b110e8d6'),
	CreateProject: () => import('./projectInfo.js?v=b110e8d6'),
	CreateToolReport: () => import('./tools.js?v=b110e8d6'),
	CreateUserTask: () => import('./taskSettings.js?v=b110e8d6'),
	CreateTask: () => import('./taskSettings.js?v=b110e8d6'),
	CreateUser: () => import('./user.js?v=b110e8d6'),
	CreateUserGroup: () => import('./user.js?v=b110e8d6'),
	DirectoryList: () => import('./lists.js?v=b110e8d6'),
	DocumentSettings: () => import('./documentSettings.js?v=b110e8d6'),
	FileInfo: () => import('./fileInfo.js?v=b110e8d6'),
	PDFPreview: () => import('./filePdfPreview.js?v=b110e8d6'),
	FileUpload: () => import('./uploadFile.js?v=b110e8d6'),
	Filters: () => import('./filters.js?v=b110e8d6'),
	FilterResults: () => import('./tables.js?v=b110e8d6'),
	GroupPermissions: () => import('./user.js?v=b110e8d6'),
	HomeActivityList: () => import('./activity.js?v=b110e8d6'),
	HomePageList: () => import('./lists.js?v=b110e8d6'),
	HomeTaskList: () => import('./tasks.js?v=b110e8d6'),
	HomeProjectList: () => import('./lists.js?v=b110e8d6'),
	HomeCategoryList: () => import('./lists.js?v=b110e8d6'),
	ImportData: () => import('./ingress.js?v=b110e8d6'),
	IndexTable: () => import('./tables.js?v=b110e8d6'),
	IngressFileUpload: () => import('./ingressUpload.js?v=b110e8d6'),
	IngressList: () => import('./lists.js?v=b110e8d6'),
	MobileTableControls: () => import('./mobileTableControls.js?v=b110e8d6'),
	ModelTaskInfo: () => import('./modelTasks.js?v=b110e8d6'),
	ModelTaskList: () => import('./modelTasks.js?v=b110e8d6'),
	PageInfo: () => import('./pageInfo.js?v=b110e8d6'),
	PagePermissions: () => import('./pagePermissions.js?v=b110e8d6'),
	PagePhoto: () => import('./pagePhoto.js?v=b110e8d6'),
	PageTaskList: () => import('./pageTaskList.js?v=b110e8d6'),
	ProjectInfo: () => import('./projectInfo.js?v=b110e8d6'),
	PublicPermissions: () => import('./user.js?v=b110e8d6'),
	SavedFilters: () => import('./filters.js?v=b110e8d6'),
	SiteAiModels: () => import('./aiModels.js?v=b110e8d6'),
	SiteAdministrators: () => import('./administrators.js?v=b110e8d6'),
	SiteDeployment: () => import('./deployment.js?v=b110e8d6'),
	SiteInstallationAccess: () => import('./installationAccess.js?v=b110e8d6'),
	SiteImage: () => import('./image.js?v=b110e8d6'),
	SiteMaintenance: () => import('./maintenance.js?v=b110e8d6'),
	SiteServiceProviders: () => import('./providers.js?v=b110e8d6'),
	SiteSettings: () => import('./siteSettings.js?v=b110e8d6'),
	StarredList: () => import('./lists.js?v=b110e8d6'),
	TableEditor: () => import('./tableEditor.js?v=b110e8d6'),
	TableSorting: () => import('./tableSorting.js?v=b110e8d6'),
	TableVisibility: () => import('./tableVisibility.js?v=b110e8d6'),
	TaskForm: () => import('./taskForm.js?v=b110e8d6'),
	TaskHistory: () => import('./tables.js?v=b110e8d6'),
	TaskCombine: () => import('./taskSettings.js?v=b110e8d6'),
	TaskMove: () => import('./taskSettings.js?v=b110e8d6'),
	ToolReportList: () => import('./lists.js?v=b110e8d6'),
	TaskSettings: () => import('./taskSettings.js?v=b110e8d6'),
	UserSettings: () => import('./pageInfo.js?v=b110e8d6'),
};

/** Sync-capable widgets that can run without a mounted view (offline replay). */
const HEADLESS_WIDGETS = {
	document: {
		load: () => import('./collaborative.js?v=b110e8d6'),
...
const ensureOfflineQueue = (view) =>
	loadOnce(view, "_offlineQueuePromise", "offlineQueue", async () => {
		const { OfflineQueue } = await import('./offlineQueue.js?v=b110e8d6');
...
const ensurePollingCoordinator = (view) =>
	loadOnce(view, "_pollingPromise", "PollingCoordinator", async () => {
		const { PollingCoordinator } = await import('./polling.js?v=b110e8d6');
		if (view._destroyed) return null;
...
const ensureSyncManager = (view) =>
	loadOnce(view, "_syncPromise", "SyncManager", async () => {
		...
		const { SyncManager } = await import('./sync.js?v=b110e8d6');
		if (view._destroyed) return null;
...
const ensureEditWatcher = (view) =>
	loadOnce(view, "_editWatcherPromise", "EditWatcher", async () => {
		await ensurePollingCoordinator(view);
		const { EditWatcher } = await import('./editWatcher.js?v=b110e8d6');
		if (view._destroyed) return null;
	...
	loadOnce(
		...
		async () => {
			...
			const { DeferredOperationManager } = await import(
				'./deferredOperations.js?v=b110e8d6'
			);
			if (view._destroyed) return null;
...
const ensureNotifications = (view) =>
	loadOnce(view, "_notificationsPromise", "Notifications", async () => {
		...
		const { Notifications } = await import('./notifications.js?v=b110e8d6');
		if (view._destroyed) return null;
...
const ensureSearchBox = (view) =>
	loadOnce(view, "_searchPromise", "SearchBox", async () => {
		...
		const { SearchBox } = await import('./search.js?v=b110e8d6');
		if (view._destroyed) return null;
...
const ensureEntityMenu = (view) =>
	loadOnce(view, "_entityMenuPromise", "EntityMenu", async () => {
		const { EntityMenu } = await import('./entityMenu.js?v=b110e8d6');
		if (view._destroyed) return null;
...
const ensureSubmissionManager = (view) =>
	loadOnce(view, "_submissionPromise", "SubmissionManager", async () => {
		const { SubmissionManager } = await import('./submission.js?v=b110e8d6');
		if (view._destroyed) return null;
...
const ensureOfflineModal = (view) =>
	loadOnce(view, "_offlineModalPromise", "offlineModal", async () => {
		...
		const { OfflineModal } = await import('./modal.js?v=b110e8d6');
		if (view._destroyed) return null;
...
const initializeCoreServices = (view) => {
	...
	const offlineWork = idle.then(async () => {
		const { inspectOfflineWork } = await import('./offlineWork.js?v=b110e8d6');
	...
	view.initialReplayReady = view.offlineQueueReady.then(async (queue) => {
		if (!queue) return 0;
		const { replayOfflineQueue } = await import('./offlineReplay.js?v=b110e8d6');
...
class Core extends ShellView {
	...
	scheduleOfflineReplay() {
		...
		const replay = import('./offlineReplay.js?v=b110e8d6').then(({ replayOfflineQueue }) =>
