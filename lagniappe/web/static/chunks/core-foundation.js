...
import { c as connectivity } from './connectivity.js?v=bb55a6e4';
import { c as captureError, E as ENDPOINTS, w as withTransition, s as showBriefly, a as clearRecentSearchResults, r as request, b as whenIdle, m as markPerformance, S as ShellView } from './foundation.js?v=bb55a6e4';
...
const WIDGETS = {
	BaseList: () => import('./baseList.js?v=bb55a6e4'),
	CategoryInfo: () => import('./category.js?v=bb55a6e4'),
	CollaborativeDocument: () => import('./collaborative.js?v=bb55a6e4'),
	CreateCategory: () => import('./category.js?v=bb55a6e4'),
	CreateForm: () => import('./form.js?v=bb55a6e4'),
	CreateModelTask: () => import('./modelTasks.js?v=bb55a6e4'),
	CreateNote: () => import('./note.js?v=bb55a6e4'),
	CreatePage: () => import('./pageInfo.js?v=bb55a6e4'),
	CreateProject: () => import('./projectInfo.js?v=bb55a6e4'),
	CreateToolReport: () => import('./tools.js?v=bb55a6e4'),
	CreateUserTask: () => import('./taskSettings.js?v=bb55a6e4'),
	CreateTask: () => import('./taskSettings.js?v=bb55a6e4'),
	CreateUser: () => import('./user.js?v=bb55a6e4'),
	CreateUserGroup: () => import('./user.js?v=bb55a6e4'),
	DirectoryList: () => import('./lists.js?v=bb55a6e4'),
	DocumentSettings: () => import('./documentSettings.js?v=bb55a6e4'),
	FileInfo: () => import('./fileInfo.js?v=bb55a6e4'),
	PDFPreview: () => import('./filePdfPreview.js?v=bb55a6e4'),
	FileUpload: () => import('./uploadFile.js?v=bb55a6e4'),
	Filters: () => import('./filters.js?v=bb55a6e4'),
	FilterResults: () => import('./tables.js?v=bb55a6e4'),
	GeneratePages: () => import('./category.js?v=bb55a6e4'),
	GroupPermissions: () => import('./user.js?v=bb55a6e4'),
	HomeActivityList: () => import('./activity.js?v=bb55a6e4'),
	HomePageList: () => import('./lists.js?v=bb55a6e4'),
	HomeTaskList: () => import('./tasks.js?v=bb55a6e4'),
	HomeProjectList: () => import('./lists.js?v=bb55a6e4'),
	HomeCategoryList: () => import('./lists.js?v=bb55a6e4'),
	ImportData: () => import('./ingress.js?v=bb55a6e4'),
	IndexTable: () => import('./tables.js?v=bb55a6e4'),
	IngressFileUpload: () => import('./ingressUpload.js?v=bb55a6e4'),
	IngressList: () => import('./lists.js?v=bb55a6e4'),
	MobileTableControls: () => import('./mobileTableControls.js?v=bb55a6e4'),
	ModelTaskInfo: () => import('./modelTasks.js?v=bb55a6e4'),
	ModelTaskList: () => import('./modelTasks.js?v=bb55a6e4'),
	PageInfo: () => import('./pageInfo.js?v=bb55a6e4'),
	PagePermissions: () => import('./pagePermissions.js?v=bb55a6e4'),
	PagePhoto: () => import('./pagePhoto.js?v=bb55a6e4'),
	PageTaskList: () => import('./pageTaskList.js?v=bb55a6e4'),
	ProjectInfo: () => import('./projectInfo.js?v=bb55a6e4'),
	PublicPermissions: () => import('./user.js?v=bb55a6e4'),
	SavedFilters: () => import('./filters.js?v=bb55a6e4'),
	SiteAiModels: () => import('./aiModels.js?v=bb55a6e4'),
	SiteAdministrators: () => import('./administrators.js?v=bb55a6e4'),
	SiteDeployment: () => import('./deployment.js?v=bb55a6e4'),
	SiteInstallationAccess: () => import('./installationAccess.js?v=bb55a6e4'),
	SiteImage: () => import('./image.js?v=bb55a6e4'),
	SiteMaintenance: () => import('./maintenance.js?v=bb55a6e4'),
	SiteServiceProviders: () => import('./providers.js?v=bb55a6e4'),
	SiteSettings: () => import('./siteSettings.js?v=bb55a6e4'),
	StarredList: () => import('./lists.js?v=bb55a6e4'),
	TableEditor: () => import('./tableEditor.js?v=bb55a6e4'),
	TableSorting: () => import('./tableSorting.js?v=bb55a6e4'),
	TableVisibility: () => import('./tableVisibility.js?v=bb55a6e4'),
	TaskForm: () => import('./taskForm.js?v=bb55a6e4'),
	TaskHistory: () => import('./tables.js?v=bb55a6e4'),
	TaskCombine: () => import('./taskSettings.js?v=bb55a6e4'),
	TaskMove: () => import('./taskSettings.js?v=bb55a6e4'),
	ToolReportList: () => import('./lists.js?v=bb55a6e4'),
	TaskSettings: () => import('./taskSettings.js?v=bb55a6e4'),
	UserSettings: () => import('./pageInfo.js?v=bb55a6e4'),
};

/** Sync-capable widgets that can run without a mounted view (offline replay). */
const HEADLESS_WIDGETS = {
	document: {
		load: () => import('./collaborative.js?v=bb55a6e4'),
...
const ensureOfflineQueue = (view) =>
	loadOnce(view, "_offlineQueuePromise", "offlineQueue", async () => {
		const { OfflineQueue } = await import('./offlineQueue.js?v=bb55a6e4');
...
const ensurePollingCoordinator = (view) =>
	loadOnce(view, "_pollingPromise", "PollingCoordinator", async () => {
		const { PollingCoordinator } = await import('./polling.js?v=bb55a6e4');
		if (view._destroyed) return null;
...
const ensureSyncManager = (view) =>
	loadOnce(view, "_syncPromise", "SyncManager", async () => {
		...
		const { SyncManager } = await import('./sync.js?v=bb55a6e4');
		if (view._destroyed) return null;
...
const ensureEditWatcher = (view) =>
	loadOnce(view, "_editWatcherPromise", "EditWatcher", async () => {
		await ensurePollingCoordinator(view);
		const { EditWatcher } = await import('./editWatcher.js?v=bb55a6e4');
		if (view._destroyed) return null;
	...
	loadOnce(
		...
		async () => {
			...
			const { DeferredOperationManager } = await import(
				'./deferredOperations.js?v=bb55a6e4'
			);
			if (view._destroyed) return null;
...
const ensureNotifications = (view) =>
	loadOnce(view, "_notificationsPromise", "Notifications", async () => {
		...
		const { Notifications } = await import('./notifications.js?v=bb55a6e4');
		if (view._destroyed) return null;
...
const ensureSearchBox = (view) =>
	loadOnce(view, "_searchPromise", "SearchBox", async () => {
		...
		const { SearchBox } = await import('./search.js?v=bb55a6e4');
		if (view._destroyed) return null;
...
const ensureEntityMenu = (view) =>
	loadOnce(view, "_entityMenuPromise", "EntityMenu", async () => {
		const { EntityMenu } = await import('./entityMenu.js?v=bb55a6e4');
		if (view._destroyed) return null;
...
const ensureSubmissionManager = (view) =>
	loadOnce(view, "_submissionPromise", "SubmissionManager", async () => {
		const { SubmissionManager } = await import('./submission.js?v=bb55a6e4');
		if (view._destroyed) return null;
...
const ensureOfflineModal = (view) =>
	loadOnce(view, "_offlineModalPromise", "offlineModal", async () => {
		...
		const { OfflineModal } = await import('./modal.js?v=bb55a6e4');
		if (view._destroyed) return null;
...
const initializeCoreServices = (view) => {
	...
	const offlineWork = idle.then(async () => {
		const { inspectOfflineWork } = await import('./offlineWork.js?v=bb55a6e4');
	...
	view.initialReplayReady = view.offlineQueueReady.then(async (queue) => {
		if (!queue) return 0;
		const { replayOfflineQueue } = await import('./offlineReplay.js?v=bb55a6e4');
...
class Core extends ShellView {
	...
	scheduleOfflineReplay() {
		...
		const replay = import('./offlineReplay.js?v=bb55a6e4').then(({ replayOfflineQueue }) =>
