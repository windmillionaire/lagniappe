...
import { c as captureError, E as ENDPOINTS, w as withTransition, s as showBriefly, a as clearRecentSearchResults, r as request, b as whenIdle, m as markPerformance, S as ShellView } from './foundation.js?v=b2884058';
...
const WIDGETS = {
	BaseList: () => import('./baseList.js?v=b2884058'),
	CategoryInfo: () => import('./category.js?v=b2884058'),
	CollaborativeDocument: () => import('./collaborative.js?v=b2884058'),
	CreateCategory: () => import('./category.js?v=b2884058'),
	CreateForm: () => import('./form.js?v=b2884058'),
	CreateModelTask: () => import('./modelTasks.js?v=b2884058'),
	CreateNote: () => import('./note.js?v=b2884058'),
	CreatePage: () => import('./pageInfo.js?v=b2884058'),
	CreateProject: () => import('./projectInfo.js?v=b2884058'),
	CreateToolReport: () => import('./tools.js?v=b2884058'),
	CreateUserTask: () => import('./taskSettings.js?v=b2884058'),
	CreateTask: () => import('./taskSettings.js?v=b2884058'),
	CreateUser: () => import('./user.js?v=b2884058'),
	CreateUserGroup: () => import('./user.js?v=b2884058'),
	DirectoryList: () => import('./lists.js?v=b2884058'),
	DocumentSettings: () => import('./documentSettings.js?v=b2884058'),
	FileInfo: () => import('./fileInfo.js?v=b2884058'),
	PDFPreview: () => import('./filePdfPreview.js?v=b2884058'),
	FileUpload: () => import('./uploadFile.js?v=b2884058'),
	Filters: () => import('./filters.js?v=b2884058'),
	FilterResults: () => import('./tables.js?v=b2884058'),
	GeneratePages: () => import('./category.js?v=b2884058'),
	GroupPermissions: () => import('./user.js?v=b2884058'),
	HomeActivityList: () => import('./activity.js?v=b2884058'),
	HomePageList: () => import('./lists.js?v=b2884058'),
	HomeTaskList: () => import('./tasks.js?v=b2884058'),
	HomeProjectList: () => import('./lists.js?v=b2884058'),
	HomeCategoryList: () => import('./lists.js?v=b2884058'),
	ImportData: () => import('./ingress.js?v=b2884058'),
	IndexTable: () => import('./tables.js?v=b2884058'),
	IngressFileUpload: () => import('./ingressUpload.js?v=b2884058'),
	IngressList: () => import('./lists.js?v=b2884058'),
	MobileTableControls: () => import('./mobileTableControls.js?v=b2884058'),
	ModelTaskInfo: () => import('./modelTasks.js?v=b2884058'),
	ModelTaskList: () => import('./modelTasks.js?v=b2884058'),
	PageInfo: () => import('./pageInfo.js?v=b2884058'),
	PagePermissions: () => import('./pagePermissions.js?v=b2884058'),
	PagePhoto: () => import('./pagePhoto.js?v=b2884058'),
	PageTaskList: () => import('./pageTaskList.js?v=b2884058'),
	ProjectInfo: () => import('./projectInfo.js?v=b2884058'),
	PublicPermissions: () => import('./user.js?v=b2884058'),
	SavedFilters: () => import('./filters.js?v=b2884058'),
	SiteExport: () => import('./siteExport.js?v=b2884058'),
	SiteAiModels: () => import('./aiModels.js?v=b2884058'),
	SiteDeployment: () => import('./deployment.js?v=b2884058'),
	SiteImage: () => import('./image.js?v=b2884058'),
	SiteMaintenance: () => import('./maintenance.js?v=b2884058'),
	SiteServiceProviders: () => import('./providers.js?v=b2884058'),
	SiteSettings: () => import('./siteSettings.js?v=b2884058'),
	StarredList: () => import('./lists.js?v=b2884058'),
	TableEditor: () => import('./tableEditor.js?v=b2884058'),
	TableSorting: () => import('./tableSorting.js?v=b2884058'),
	TableVisibility: () => import('./tableVisibility.js?v=b2884058'),
	TaskForm: () => import('./taskForm.js?v=b2884058'),
	TaskHistory: () => import('./tables.js?v=b2884058'),
	TaskCombine: () => import('./taskSettings.js?v=b2884058'),
	TaskMove: () => import('./taskSettings.js?v=b2884058'),
	ToolReportList: () => import('./lists.js?v=b2884058'),
	TaskSettings: () => import('./taskSettings.js?v=b2884058'),
	UserSettings: () => import('./pageInfo.js?v=b2884058'),
};

/** Sync-capable widgets that can run without a mounted view (offline replay). */
const HEADLESS_WIDGETS = {
	document: {
		load: () => import('./collaborative.js?v=b2884058'),
...
const ensureOfflineQueue = (view) =>
	loadOnce(view, "_offlineQueuePromise", "offlineQueue", async () => {
		const { OfflineQueue } = await import('./offlineQueue.js?v=b2884058');
...
const ensurePollingCoordinator = (view) =>
	loadOnce(view, "_pollingPromise", "PollingCoordinator", async () => {
		const { PollingCoordinator } = await import('./polling.js?v=b2884058');
		if (view._destroyed) return null;
...
const ensureSyncManager = (view) =>
	loadOnce(view, "_syncPromise", "SyncManager", async () => {
		...
		const { SyncManager } = await import('./sync.js?v=b2884058');
		if (view._destroyed) return null;
...
const ensureEditWatcher = (view) =>
	loadOnce(view, "_editWatcherPromise", "EditWatcher", async () => {
		await ensurePollingCoordinator(view);
		const { EditWatcher } = await import('./editWatcher.js?v=b2884058');
		if (view._destroyed) return null;
	...
	loadOnce(
		...
		async () => {
			...
			const { DeferredOperationManager } = await import(
				'./deferredOperations.js?v=b2884058'
			);
			if (view._destroyed) return null;
...
const ensureNotifications = (view) =>
	loadOnce(view, "_notificationsPromise", "Notifications", async () => {
		...
		const { Notifications } = await import('./notifications.js?v=b2884058');
		if (view._destroyed) return null;
...
const ensureSearchBox = (view) =>
	loadOnce(view, "_searchPromise", "SearchBox", async () => {
		...
		const { SearchBox } = await import('./search.js?v=b2884058');
		if (view._destroyed) return null;
...
const ensureEntityMenu = (view) =>
	loadOnce(view, "_entityMenuPromise", "EntityMenu", async () => {
		const { EntityMenu } = await import('./entityMenu.js?v=b2884058');
		if (view._destroyed) return null;
...
const ensureSubmissionManager = (view) =>
	loadOnce(view, "_submissionPromise", "SubmissionManager", async () => {
		const { SubmissionManager } = await import('./submission.js?v=b2884058');
		if (view._destroyed) return null;
...
const ensureOfflineModal = (view) =>
	loadOnce(view, "_offlineModalPromise", "offlineModal", async () => {
		...
		const { OfflineModal } = await import('./modal.js?v=b2884058');
		if (view._destroyed) return null;
...
const initializeCoreServices = (view) => {
	...
	const offlineWork = idle.then(async () => {
		const { inspectOfflineWork } = await import('./offlineWork.js?v=b2884058');
	...
	view.initialReplayReady = view.offlineQueueReady.then(async (queue) => {
		if (!queue) return 0;
		const { replayOfflineQueue } = await import('./offlineReplay.js?v=b2884058');
...
class Core extends ShellView {
	...
	scheduleOfflineReplay() {
		...
		this._offlineReplayTask = import('./offlineReplay.js?v=b2884058')
