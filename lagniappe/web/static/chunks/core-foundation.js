...
import { c as connectivity } from './connectivity.js?v=b7c13b49';
import { c as captureError, E as ENDPOINTS, w as withTransition, a as clearRecentSearchResults, r as request, b as whenIdle, m as markPerformance, S as ShellView } from './foundation.js?v=b7c13b49';
...
const WIDGETS = {
	BaseList: () => import('./baseList.js?v=b7c13b49'),
	CategoryInfo: () => import('./category.js?v=b7c13b49'),
	CollaborativeDocument: () => import('./collaborative.js?v=b7c13b49'),
	CreateCategory: () => import('./category.js?v=b7c13b49'),
	CreateForm: () => import('./form.js?v=b7c13b49'),
	CreateModelTask: () => import('./modelTasks.js?v=b7c13b49'),
	CreateNote: () => import('./note.js?v=b7c13b49'),
	CreatePage: () => import('./pageInfo.js?v=b7c13b49'),
	CreateProject: () => import('./projectInfo.js?v=b7c13b49'),
	CreateToolReport: () => import('./tools.js?v=b7c13b49'),
	CreateUserTask: () => import('./taskSettings.js?v=b7c13b49'),
	CreateTask: () => import('./taskSettings.js?v=b7c13b49'),
	CreateUser: () => import('./user.js?v=b7c13b49'),
	CreateUserGroup: () => import('./user.js?v=b7c13b49'),
	DirectoryList: () => import('./lists.js?v=b7c13b49'),
	DocumentSettings: () => import('./documentSettings.js?v=b7c13b49'),
	FileInfo: () => import('./fileInfo.js?v=b7c13b49'),
	PDFPreview: () => import('./filePdfPreview.js?v=b7c13b49'),
	FileUpload: () => import('./uploadFile.js?v=b7c13b49'),
	Filters: () => import('./filters.js?v=b7c13b49'),
	FilterResults: () => import('./tables.js?v=b7c13b49'),
	GroupPermissions: () => import('./user.js?v=b7c13b49'),
	HomeActivityList: () => import('./activity.js?v=b7c13b49'),
	HomePageList: () => import('./lists.js?v=b7c13b49'),
	HomeTaskList: () => import('./tasks.js?v=b7c13b49'),
	HomeProjectList: () => import('./lists.js?v=b7c13b49'),
	HomeCategoryList: () => import('./lists.js?v=b7c13b49'),
	ImportData: () => import('./ingress.js?v=b7c13b49'),
	IndexTable: () => import('./tables.js?v=b7c13b49'),
	IngressFileUpload: () => import('./ingressUpload.js?v=b7c13b49'),
	IngressList: () => import('./lists.js?v=b7c13b49'),
	MobileTableControls: () => import('./mobileTableControls.js?v=b7c13b49'),
	ModelTaskInfo: () => import('./modelTasks.js?v=b7c13b49'),
	ModelTaskList: () => import('./modelTasks.js?v=b7c13b49'),
	PageInfo: () => import('./pageInfo.js?v=b7c13b49'),
	PagePermissions: () => import('./pagePermissions.js?v=b7c13b49'),
	PagePhoto: () => import('./pagePhoto.js?v=b7c13b49'),
	PageTaskList: () => import('./pageTaskList.js?v=b7c13b49'),
	ProjectInfo: () => import('./projectInfo.js?v=b7c13b49'),
	PublicPermissions: () => import('./user.js?v=b7c13b49'),
	SavedFilters: () => import('./filters.js?v=b7c13b49'),
	SiteAiModels: () => import('./aiModels.js?v=b7c13b49'),
	SiteAdministrators: () => import('./administrators.js?v=b7c13b49'),
	SiteDeployment: () => import('./deployment.js?v=b7c13b49'),
	SiteInstallationAccess: () => import('./installationAccess.js?v=b7c13b49'),
	SiteImage: () => import('./image.js?v=b7c13b49'),
	SiteMaintenance: () => import('./maintenance.js?v=b7c13b49'),
	SiteServiceProviders: () => import('./providers.js?v=b7c13b49'),
	SiteSettings: () => import('./siteSettings.js?v=b7c13b49'),
	StarredList: () => import('./lists.js?v=b7c13b49'),
	TableEditor: () => import('./tableEditor.js?v=b7c13b49'),
	TableSorting: () => import('./tableSorting.js?v=b7c13b49'),
	TableVisibility: () => import('./tableVisibility.js?v=b7c13b49'),
	TaskForm: () => import('./taskForm.js?v=b7c13b49'),
	TaskHistory: () => import('./tables.js?v=b7c13b49'),
	TaskCombine: () => import('./taskSettings.js?v=b7c13b49'),
	TaskMove: () => import('./taskSettings.js?v=b7c13b49'),
	ToolReportList: () => import('./lists.js?v=b7c13b49'),
	TaskSettings: () => import('./taskSettings.js?v=b7c13b49'),
	UserSettings: () => import('./pageInfo.js?v=b7c13b49'),
};

/** Sync-capable widgets that can run without a mounted view (offline replay). */
const HEADLESS_WIDGETS = {
	document: {
		load: () => import('./collaborative.js?v=b7c13b49'),
...
const ensureOfflineQueue = (view) =>
	loadOnce(view, "_offlineQueuePromise", "offlineQueue", async () => {
		const { OfflineQueue } = await import('./offlineQueue.js?v=b7c13b49');
...
const ensurePollingCoordinator = (view) =>
	loadOnce(view, "_pollingPromise", "PollingCoordinator", async () => {
		const { PollingCoordinator } = await import('./polling.js?v=b7c13b49');
		if (view._destroyed) return null;
...
const ensureSyncManager = (view) =>
	loadOnce(view, "_syncPromise", "SyncManager", async () => {
		...
		const { SyncManager } = await import('./sync.js?v=b7c13b49');
		if (view._destroyed) return null;
...
const ensureEditWatcher = (view) =>
	loadOnce(view, "_editWatcherPromise", "EditWatcher", async () => {
		await ensurePollingCoordinator(view);
		const { EditWatcher } = await import('./editWatcher.js?v=b7c13b49');
		if (view._destroyed) return null;
	...
	loadOnce(
		...
		async () => {
			...
			const { DeferredOperationManager } = await import(
				'./deferredOperations.js?v=b7c13b49'
			);
			if (view._destroyed) return null;
...
const ensureNotifications = (view) =>
	loadOnce(view, "_notificationsPromise", "Notifications", async () => {
		...
		const { Notifications } = await import('./notifications.js?v=b7c13b49');
		if (view._destroyed) return null;
...
const ensureSearchBox = (view) =>
	loadOnce(view, "_searchPromise", "SearchBox", async () => {
		...
		const { SearchBox } = await import('./search.js?v=b7c13b49');
		if (view._destroyed) return null;
...
const ensureEntityMenu = (view) =>
	loadOnce(view, "_entityMenuPromise", "EntityMenu", async () => {
		const { EntityMenu } = await import('./entityMenu.js?v=b7c13b49');
		if (view._destroyed) return null;
...
const ensureSubmissionManager = (view) =>
	loadOnce(view, "_submissionPromise", "SubmissionManager", async () => {
		const { SubmissionManager } = await import('./submission.js?v=b7c13b49');
		if (view._destroyed) return null;
...
const ensureOfflineModal = (view) =>
	loadOnce(view, "_offlineModalPromise", "offlineModal", async () => {
		...
		const { OfflineModal } = await import('./modal.js?v=b7c13b49');
		if (view._destroyed) return null;
...
const initializeCoreServices = (view) => {
	...
	const offlineWork = idle.then(async () => {
		const { inspectOfflineWork } = await import('./offlineWork.js?v=b7c13b49');
	...
	view.initialReplayReady = view.offlineQueueReady.then(async (queue) => {
		if (!queue) return 0;
		const { replayOfflineQueue } = await import('./offlineReplay.js?v=b7c13b49');
...
class Core extends ShellView {
	...
	scheduleOfflineReplay() {
		...
		const replay = import('./offlineReplay.js?v=b7c13b49').then(({ replayOfflineQueue }) =>
