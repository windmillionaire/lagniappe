...
import { c as connectivity } from './connectivity.js?v=bdbb928b';
import { c as captureError, E as ENDPOINTS, w as withTransition, s as showBriefly, a as clearRecentSearchResults, r as request, b as whenIdle, m as markPerformance, S as ShellView } from './foundation.js?v=bdbb928b';
...
const WIDGETS = {
	BaseList: () => import('./baseList.js?v=bdbb928b'),
	CategoryInfo: () => import('./category.js?v=bdbb928b'),
	CollaborativeDocument: () => import('./collaborative.js?v=bdbb928b'),
	CreateCategory: () => import('./category.js?v=bdbb928b'),
	CreateForm: () => import('./form.js?v=bdbb928b'),
	CreateModelTask: () => import('./modelTasks.js?v=bdbb928b'),
	CreateNote: () => import('./note.js?v=bdbb928b'),
	CreatePage: () => import('./pageInfo.js?v=bdbb928b'),
	CreateProject: () => import('./projectInfo.js?v=bdbb928b'),
	CreateToolReport: () => import('./tools.js?v=bdbb928b'),
	CreateUserTask: () => import('./taskSettings.js?v=bdbb928b'),
	CreateTask: () => import('./taskSettings.js?v=bdbb928b'),
	CreateUser: () => import('./user.js?v=bdbb928b'),
	CreateUserGroup: () => import('./user.js?v=bdbb928b'),
	DirectoryList: () => import('./lists.js?v=bdbb928b'),
	DocumentSettings: () => import('./documentSettings.js?v=bdbb928b'),
	FileInfo: () => import('./fileInfo.js?v=bdbb928b'),
	PDFPreview: () => import('./filePdfPreview.js?v=bdbb928b'),
	FileUpload: () => import('./uploadFile.js?v=bdbb928b'),
	Filters: () => import('./filters.js?v=bdbb928b'),
	FilterResults: () => import('./tables.js?v=bdbb928b'),
	GeneratePages: () => import('./category.js?v=bdbb928b'),
	GroupPermissions: () => import('./user.js?v=bdbb928b'),
	HomeActivityList: () => import('./activity.js?v=bdbb928b'),
	HomePageList: () => import('./lists.js?v=bdbb928b'),
	HomeTaskList: () => import('./tasks.js?v=bdbb928b'),
	HomeProjectList: () => import('./lists.js?v=bdbb928b'),
	HomeCategoryList: () => import('./lists.js?v=bdbb928b'),
	ImportData: () => import('./ingress.js?v=bdbb928b'),
	IndexTable: () => import('./tables.js?v=bdbb928b'),
	IngressFileUpload: () => import('./ingressUpload.js?v=bdbb928b'),
	IngressList: () => import('./lists.js?v=bdbb928b'),
	MobileTableControls: () => import('./mobileTableControls.js?v=bdbb928b'),
	ModelTaskInfo: () => import('./modelTasks.js?v=bdbb928b'),
	ModelTaskList: () => import('./modelTasks.js?v=bdbb928b'),
	PageInfo: () => import('./pageInfo.js?v=bdbb928b'),
	PagePermissions: () => import('./pagePermissions.js?v=bdbb928b'),
	PagePhoto: () => import('./pagePhoto.js?v=bdbb928b'),
	PageTaskList: () => import('./pageTaskList.js?v=bdbb928b'),
	ProjectInfo: () => import('./projectInfo.js?v=bdbb928b'),
	PublicPermissions: () => import('./user.js?v=bdbb928b'),
	SavedFilters: () => import('./filters.js?v=bdbb928b'),
	SiteAiModels: () => import('./aiModels.js?v=bdbb928b'),
	SiteAdministrators: () => import('./administrators.js?v=bdbb928b'),
	SiteDeployment: () => import('./deployment.js?v=bdbb928b'),
	SiteInstallationAccess: () => import('./installationAccess.js?v=bdbb928b'),
	SiteImage: () => import('./image.js?v=bdbb928b'),
	SiteMaintenance: () => import('./maintenance.js?v=bdbb928b'),
	SiteServiceProviders: () => import('./providers.js?v=bdbb928b'),
	SiteSettings: () => import('./siteSettings.js?v=bdbb928b'),
	StarredList: () => import('./lists.js?v=bdbb928b'),
	TableEditor: () => import('./tableEditor.js?v=bdbb928b'),
	TableSorting: () => import('./tableSorting.js?v=bdbb928b'),
	TableVisibility: () => import('./tableVisibility.js?v=bdbb928b'),
	TaskForm: () => import('./taskForm.js?v=bdbb928b'),
	TaskHistory: () => import('./tables.js?v=bdbb928b'),
	TaskCombine: () => import('./taskSettings.js?v=bdbb928b'),
	TaskMove: () => import('./taskSettings.js?v=bdbb928b'),
	ToolReportList: () => import('./lists.js?v=bdbb928b'),
	TaskSettings: () => import('./taskSettings.js?v=bdbb928b'),
	UserSettings: () => import('./pageInfo.js?v=bdbb928b'),
};

/** Sync-capable widgets that can run without a mounted view (offline replay). */
const HEADLESS_WIDGETS = {
	document: {
		load: () => import('./collaborative.js?v=bdbb928b'),
...
const ensureOfflineQueue = (view) =>
	loadOnce(view, "_offlineQueuePromise", "offlineQueue", async () => {
		const { OfflineQueue } = await import('./offlineQueue.js?v=bdbb928b');
...
const ensurePollingCoordinator = (view) =>
	loadOnce(view, "_pollingPromise", "PollingCoordinator", async () => {
		const { PollingCoordinator } = await import('./polling.js?v=bdbb928b');
		if (view._destroyed) return null;
...
const ensureSyncManager = (view) =>
	loadOnce(view, "_syncPromise", "SyncManager", async () => {
		...
		const { SyncManager } = await import('./sync.js?v=bdbb928b');
		if (view._destroyed) return null;
...
const ensureEditWatcher = (view) =>
	loadOnce(view, "_editWatcherPromise", "EditWatcher", async () => {
		await ensurePollingCoordinator(view);
		const { EditWatcher } = await import('./editWatcher.js?v=bdbb928b');
		if (view._destroyed) return null;
	...
	loadOnce(
		...
		async () => {
			...
			const { DeferredOperationManager } = await import(
				'./deferredOperations.js?v=bdbb928b'
			);
			if (view._destroyed) return null;
...
const ensureNotifications = (view) =>
	loadOnce(view, "_notificationsPromise", "Notifications", async () => {
		...
		const { Notifications } = await import('./notifications.js?v=bdbb928b');
		if (view._destroyed) return null;
...
const ensureSearchBox = (view) =>
	loadOnce(view, "_searchPromise", "SearchBox", async () => {
		...
		const { SearchBox } = await import('./search.js?v=bdbb928b');
		if (view._destroyed) return null;
...
const ensureEntityMenu = (view) =>
	loadOnce(view, "_entityMenuPromise", "EntityMenu", async () => {
		const { EntityMenu } = await import('./entityMenu.js?v=bdbb928b');
		if (view._destroyed) return null;
...
const ensureSubmissionManager = (view) =>
	loadOnce(view, "_submissionPromise", "SubmissionManager", async () => {
		const { SubmissionManager } = await import('./submission.js?v=bdbb928b');
		if (view._destroyed) return null;
...
const ensureOfflineModal = (view) =>
	loadOnce(view, "_offlineModalPromise", "offlineModal", async () => {
		...
		const { OfflineModal } = await import('./modal.js?v=bdbb928b');
		if (view._destroyed) return null;
...
const initializeCoreServices = (view) => {
	...
	const offlineWork = idle.then(async () => {
		const { inspectOfflineWork } = await import('./offlineWork.js?v=bdbb928b');
	...
	view.initialReplayReady = view.offlineQueueReady.then(async (queue) => {
		if (!queue) return 0;
		const { replayOfflineQueue } = await import('./offlineReplay.js?v=bdbb928b');
...
class Core extends ShellView {
	...
	scheduleOfflineReplay() {
		...
		const replay = import('./offlineReplay.js?v=bdbb928b').then(({ replayOfflineQueue }) =>
