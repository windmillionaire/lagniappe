...
import { c as connectivity } from './connectivity.js?v=b05079d4';
import { c as captureError, E as ENDPOINTS, w as withTransition, s as showBriefly, a as clearRecentSearchResults, r as request, b as whenIdle, m as markPerformance, S as ShellView } from './foundation.js?v=b05079d4';
...
const WIDGETS = {
	BaseList: () => import('./baseList.js?v=b05079d4'),
	CategoryInfo: () => import('./category.js?v=b05079d4'),
	CollaborativeDocument: () => import('./collaborative.js?v=b05079d4'),
	CreateCategory: () => import('./category.js?v=b05079d4'),
	CreateForm: () => import('./form.js?v=b05079d4'),
	CreateModelTask: () => import('./modelTasks.js?v=b05079d4'),
	CreateNote: () => import('./note.js?v=b05079d4'),
	CreatePage: () => import('./pageInfo.js?v=b05079d4'),
	CreateProject: () => import('./projectInfo.js?v=b05079d4'),
	CreateToolReport: () => import('./tools.js?v=b05079d4'),
	CreateUserTask: () => import('./taskSettings.js?v=b05079d4'),
	CreateTask: () => import('./taskSettings.js?v=b05079d4'),
	CreateUser: () => import('./user.js?v=b05079d4'),
	CreateUserGroup: () => import('./user.js?v=b05079d4'),
	DirectoryList: () => import('./lists.js?v=b05079d4'),
	DocumentSettings: () => import('./documentSettings.js?v=b05079d4'),
	FileInfo: () => import('./fileInfo.js?v=b05079d4'),
	PDFPreview: () => import('./filePdfPreview.js?v=b05079d4'),
	FileUpload: () => import('./uploadFile.js?v=b05079d4'),
	Filters: () => import('./filters.js?v=b05079d4'),
	FilterResults: () => import('./tables.js?v=b05079d4'),
	GeneratePages: () => import('./category.js?v=b05079d4'),
	GroupPermissions: () => import('./user.js?v=b05079d4'),
	HomeActivityList: () => import('./activity.js?v=b05079d4'),
	HomePageList: () => import('./lists.js?v=b05079d4'),
	HomeTaskList: () => import('./tasks.js?v=b05079d4'),
	HomeProjectList: () => import('./lists.js?v=b05079d4'),
	HomeCategoryList: () => import('./lists.js?v=b05079d4'),
	ImportData: () => import('./ingress.js?v=b05079d4'),
	IndexTable: () => import('./tables.js?v=b05079d4'),
	IngressFileUpload: () => import('./ingressUpload.js?v=b05079d4'),
	IngressList: () => import('./lists.js?v=b05079d4'),
	MobileTableControls: () => import('./mobileTableControls.js?v=b05079d4'),
	ModelTaskInfo: () => import('./modelTasks.js?v=b05079d4'),
	ModelTaskList: () => import('./modelTasks.js?v=b05079d4'),
	PageInfo: () => import('./pageInfo.js?v=b05079d4'),
	PagePermissions: () => import('./pagePermissions.js?v=b05079d4'),
	PagePhoto: () => import('./pagePhoto.js?v=b05079d4'),
	PageTaskList: () => import('./pageTaskList.js?v=b05079d4'),
	ProjectInfo: () => import('./projectInfo.js?v=b05079d4'),
	PublicPermissions: () => import('./user.js?v=b05079d4'),
	SavedFilters: () => import('./filters.js?v=b05079d4'),
	SiteAiModels: () => import('./aiModels.js?v=b05079d4'),
	SiteAdministrators: () => import('./administrators.js?v=b05079d4'),
	SiteDeployment: () => import('./deployment.js?v=b05079d4'),
	SiteImage: () => import('./image.js?v=b05079d4'),
	SiteMaintenance: () => import('./maintenance.js?v=b05079d4'),
	SiteServiceProviders: () => import('./providers.js?v=b05079d4'),
	SiteSettings: () => import('./siteSettings.js?v=b05079d4'),
	StarredList: () => import('./lists.js?v=b05079d4'),
	TableEditor: () => import('./tableEditor.js?v=b05079d4'),
	TableSorting: () => import('./tableSorting.js?v=b05079d4'),
	TableVisibility: () => import('./tableVisibility.js?v=b05079d4'),
	TaskForm: () => import('./taskForm.js?v=b05079d4'),
	TaskHistory: () => import('./tables.js?v=b05079d4'),
	TaskCombine: () => import('./taskSettings.js?v=b05079d4'),
	TaskMove: () => import('./taskSettings.js?v=b05079d4'),
	ToolReportList: () => import('./lists.js?v=b05079d4'),
	TaskSettings: () => import('./taskSettings.js?v=b05079d4'),
	UserSettings: () => import('./pageInfo.js?v=b05079d4'),
};

/** Sync-capable widgets that can run without a mounted view (offline replay). */
const HEADLESS_WIDGETS = {
	document: {
		load: () => import('./collaborative.js?v=b05079d4'),
...
const ensureOfflineQueue = (view) =>
	loadOnce(view, "_offlineQueuePromise", "offlineQueue", async () => {
		const { OfflineQueue } = await import('./offlineQueue.js?v=b05079d4');
...
const ensurePollingCoordinator = (view) =>
	loadOnce(view, "_pollingPromise", "PollingCoordinator", async () => {
		const { PollingCoordinator } = await import('./polling.js?v=b05079d4');
		if (view._destroyed) return null;
...
const ensureSyncManager = (view) =>
	loadOnce(view, "_syncPromise", "SyncManager", async () => {
		...
		const { SyncManager } = await import('./sync.js?v=b05079d4');
		if (view._destroyed) return null;
...
const ensureEditWatcher = (view) =>
	loadOnce(view, "_editWatcherPromise", "EditWatcher", async () => {
		await ensurePollingCoordinator(view);
		const { EditWatcher } = await import('./editWatcher.js?v=b05079d4');
		if (view._destroyed) return null;
	...
	loadOnce(
		...
		async () => {
			...
			const { DeferredOperationManager } = await import(
				'./deferredOperations.js?v=b05079d4'
			);
			if (view._destroyed) return null;
...
const ensureNotifications = (view) =>
	loadOnce(view, "_notificationsPromise", "Notifications", async () => {
		...
		const { Notifications } = await import('./notifications.js?v=b05079d4');
		if (view._destroyed) return null;
...
const ensureSearchBox = (view) =>
	loadOnce(view, "_searchPromise", "SearchBox", async () => {
		...
		const { SearchBox } = await import('./search.js?v=b05079d4');
		if (view._destroyed) return null;
...
const ensureEntityMenu = (view) =>
	loadOnce(view, "_entityMenuPromise", "EntityMenu", async () => {
		const { EntityMenu } = await import('./entityMenu.js?v=b05079d4');
		if (view._destroyed) return null;
...
const ensureSubmissionManager = (view) =>
	loadOnce(view, "_submissionPromise", "SubmissionManager", async () => {
		const { SubmissionManager } = await import('./submission.js?v=b05079d4');
		if (view._destroyed) return null;
...
const ensureOfflineModal = (view) =>
	loadOnce(view, "_offlineModalPromise", "offlineModal", async () => {
		...
		const { OfflineModal } = await import('./modal.js?v=b05079d4');
		if (view._destroyed) return null;
...
const initializeCoreServices = (view) => {
	...
	const offlineWork = idle.then(async () => {
		const { inspectOfflineWork } = await import('./offlineWork.js?v=b05079d4');
	...
	view.initialReplayReady = view.offlineQueueReady.then(async (queue) => {
		if (!queue) return 0;
		const { replayOfflineQueue } = await import('./offlineReplay.js?v=b05079d4');
...
class Core extends ShellView {
	...
	scheduleOfflineReplay() {
		...
		const replay = import('./offlineReplay.js?v=b05079d4').then(({ replayOfflineQueue }) =>
