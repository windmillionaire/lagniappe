...
import { c as connectivity } from './connectivity.js?v=b60dadce';
import { c as captureError, E as ENDPOINTS, w as withTransition, s as showBriefly, a as clearRecentSearchResults, r as request, b as whenIdle, m as markPerformance, S as ShellView } from './foundation.js?v=b60dadce';
...
const WIDGETS = {
	BaseList: () => import('./baseList.js?v=b60dadce'),
	CategoryInfo: () => import('./category.js?v=b60dadce'),
	CollaborativeDocument: () => import('./collaborative.js?v=b60dadce'),
	CreateCategory: () => import('./category.js?v=b60dadce'),
	CreateForm: () => import('./form.js?v=b60dadce'),
	CreateModelTask: () => import('./modelTasks.js?v=b60dadce'),
	CreateNote: () => import('./note.js?v=b60dadce'),
	CreatePage: () => import('./pageInfo.js?v=b60dadce'),
	CreateProject: () => import('./projectInfo.js?v=b60dadce'),
	CreateToolReport: () => import('./tools.js?v=b60dadce'),
	CreateUserTask: () => import('./taskSettings.js?v=b60dadce'),
	CreateTask: () => import('./taskSettings.js?v=b60dadce'),
	CreateUser: () => import('./user.js?v=b60dadce'),
	CreateUserGroup: () => import('./user.js?v=b60dadce'),
	DirectoryList: () => import('./lists.js?v=b60dadce'),
	DocumentSettings: () => import('./documentSettings.js?v=b60dadce'),
	FileInfo: () => import('./fileInfo.js?v=b60dadce'),
	PDFPreview: () => import('./filePdfPreview.js?v=b60dadce'),
	FileUpload: () => import('./uploadFile.js?v=b60dadce'),
	Filters: () => import('./filters.js?v=b60dadce'),
	FilterResults: () => import('./tables.js?v=b60dadce'),
	GroupPermissions: () => import('./user.js?v=b60dadce'),
	HomeActivityList: () => import('./activity.js?v=b60dadce'),
	HomePageList: () => import('./lists.js?v=b60dadce'),
	HomeTaskList: () => import('./tasks.js?v=b60dadce'),
	HomeProjectList: () => import('./lists.js?v=b60dadce'),
	HomeCategoryList: () => import('./lists.js?v=b60dadce'),
	ImportData: () => import('./ingress.js?v=b60dadce'),
	IndexTable: () => import('./tables.js?v=b60dadce'),
	IngressFileUpload: () => import('./ingressUpload.js?v=b60dadce'),
	IngressList: () => import('./lists.js?v=b60dadce'),
	MobileTableControls: () => import('./mobileTableControls.js?v=b60dadce'),
	ModelTaskInfo: () => import('./modelTasks.js?v=b60dadce'),
	ModelTaskList: () => import('./modelTasks.js?v=b60dadce'),
	PageInfo: () => import('./pageInfo.js?v=b60dadce'),
	PagePermissions: () => import('./pagePermissions.js?v=b60dadce'),
	PagePhoto: () => import('./pagePhoto.js?v=b60dadce'),
	PageTaskList: () => import('./pageTaskList.js?v=b60dadce'),
	ProjectInfo: () => import('./projectInfo.js?v=b60dadce'),
	PublicPermissions: () => import('./user.js?v=b60dadce'),
	SavedFilters: () => import('./filters.js?v=b60dadce'),
	SiteAiModels: () => import('./aiModels.js?v=b60dadce'),
	SiteAdministrators: () => import('./administrators.js?v=b60dadce'),
	SiteDeployment: () => import('./deployment.js?v=b60dadce'),
	SiteInstallationAccess: () => import('./installationAccess.js?v=b60dadce'),
	SiteImage: () => import('./image.js?v=b60dadce'),
	SiteMaintenance: () => import('./maintenance.js?v=b60dadce'),
	SiteServiceProviders: () => import('./providers.js?v=b60dadce'),
	SiteSettings: () => import('./siteSettings.js?v=b60dadce'),
	StarredList: () => import('./lists.js?v=b60dadce'),
	TableEditor: () => import('./tableEditor.js?v=b60dadce'),
	TableSorting: () => import('./tableSorting.js?v=b60dadce'),
	TableVisibility: () => import('./tableVisibility.js?v=b60dadce'),
	TaskForm: () => import('./taskForm.js?v=b60dadce'),
	TaskHistory: () => import('./tables.js?v=b60dadce'),
	TaskCombine: () => import('./taskSettings.js?v=b60dadce'),
	TaskMove: () => import('./taskSettings.js?v=b60dadce'),
	ToolReportList: () => import('./lists.js?v=b60dadce'),
	TaskSettings: () => import('./taskSettings.js?v=b60dadce'),
	UserSettings: () => import('./pageInfo.js?v=b60dadce'),
};

/** Sync-capable widgets that can run without a mounted view (offline replay). */
const HEADLESS_WIDGETS = {
	document: {
		load: () => import('./collaborative.js?v=b60dadce'),
...
const ensureOfflineQueue = (view) =>
	loadOnce(view, "_offlineQueuePromise", "offlineQueue", async () => {
		const { OfflineQueue } = await import('./offlineQueue.js?v=b60dadce');
...
const ensurePollingCoordinator = (view) =>
	loadOnce(view, "_pollingPromise", "PollingCoordinator", async () => {
		const { PollingCoordinator } = await import('./polling.js?v=b60dadce');
		if (view._destroyed) return null;
...
const ensureSyncManager = (view) =>
	loadOnce(view, "_syncPromise", "SyncManager", async () => {
		...
		const { SyncManager } = await import('./sync.js?v=b60dadce');
		if (view._destroyed) return null;
...
const ensureEditWatcher = (view) =>
	loadOnce(view, "_editWatcherPromise", "EditWatcher", async () => {
		await ensurePollingCoordinator(view);
		const { EditWatcher } = await import('./editWatcher.js?v=b60dadce');
		if (view._destroyed) return null;
	...
	loadOnce(
		...
		async () => {
			...
			const { DeferredOperationManager } = await import(
				'./deferredOperations.js?v=b60dadce'
			);
			if (view._destroyed) return null;
...
const ensureNotifications = (view) =>
	loadOnce(view, "_notificationsPromise", "Notifications", async () => {
		...
		const { Notifications } = await import('./notifications.js?v=b60dadce');
		if (view._destroyed) return null;
...
const ensureSearchBox = (view) =>
	loadOnce(view, "_searchPromise", "SearchBox", async () => {
		...
		const { SearchBox } = await import('./search.js?v=b60dadce');
		if (view._destroyed) return null;
...
const ensureEntityMenu = (view) =>
	loadOnce(view, "_entityMenuPromise", "EntityMenu", async () => {
		const { EntityMenu } = await import('./entityMenu.js?v=b60dadce');
		if (view._destroyed) return null;
...
const ensureSubmissionManager = (view) =>
	loadOnce(view, "_submissionPromise", "SubmissionManager", async () => {
		const { SubmissionManager } = await import('./submission.js?v=b60dadce');
		if (view._destroyed) return null;
...
const ensureOfflineModal = (view) =>
	loadOnce(view, "_offlineModalPromise", "offlineModal", async () => {
		...
		const { OfflineModal } = await import('./modal.js?v=b60dadce');
		if (view._destroyed) return null;
...
const initializeCoreServices = (view) => {
	...
	const offlineWork = idle.then(async () => {
		const { inspectOfflineWork } = await import('./offlineWork.js?v=b60dadce');
	...
	view.initialReplayReady = view.offlineQueueReady.then(async (queue) => {
		if (!queue) return 0;
		const { replayOfflineQueue } = await import('./offlineReplay.js?v=b60dadce');
...
class Core extends ShellView {
	...
	scheduleOfflineReplay() {
		...
		const replay = import('./offlineReplay.js?v=b60dadce').then(({ replayOfflineQueue }) =>
