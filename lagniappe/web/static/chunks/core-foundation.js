...
import { c as connectivity } from './connectivity.js?v=b43106f0';
import { c as captureError, E as ENDPOINTS, w as withTransition, r as request, a as whenIdle, m as markPerformance, S as ShellView } from './foundation.js?v=b43106f0';
import { clearRecentSearchResults } from './storage.js?v=b43106f0';
...
const WIDGETS = {
	BaseList: () => import('./baseList.js?v=b43106f0'),
	CategoryInfo: () => import('./category.js?v=b43106f0'),
	CollaborativeDocument: () => import('./collaborative.js?v=b43106f0'),
	CreateCategory: () => import('./category.js?v=b43106f0'),
	CreateForm: () => import('./form.js?v=b43106f0'),
	CreateModelTask: () => import('./modelTasks.js?v=b43106f0'),
	CreateNote: () => import('./note.js?v=b43106f0'),
	CreatePage: () => import('./pageInfo.js?v=b43106f0'),
	CreateProject: () => import('./projectInfo.js?v=b43106f0'),
	CreateToolReport: () => import('./tools.js?v=b43106f0'),
	CreateUserTask: () => import('./taskSettings.js?v=b43106f0'),
	CreateTask: () => import('./taskSettings.js?v=b43106f0'),
	CreateUser: () => import('./user.js?v=b43106f0'),
	CreateUserGroup: () => import('./user.js?v=b43106f0'),
	DirectoryList: () => import('./lists.js?v=b43106f0'),
	DocumentSettings: () => import('./documentSettings.js?v=b43106f0'),
	FileInfo: () => import('./fileInfo.js?v=b43106f0'),
	PDFPreview: () => import('./filePdfPreview.js?v=b43106f0'),
	FileUpload: () => import('./uploadFile.js?v=b43106f0'),
	Filters: () => import('./filters.js?v=b43106f0'),
	FilterResults: () => import('./filterResults.js?v=b43106f0'),
	GroupPermissions: () => import('./userPermissions.js?v=b43106f0'),
	HomeActivityList: () => import('./activity.js?v=b43106f0'),
	HomePageList: () => import('./lists.js?v=b43106f0'),
	HomeTaskList: () => import('./tasks.js?v=b43106f0'),
	HomeProjectList: () => import('./lists.js?v=b43106f0'),
	HomeCategoryList: () => import('./lists.js?v=b43106f0'),
	ImportData: () => import('./ingress.js?v=b43106f0'),
	IndexTable: () => import('./indexTable.js?v=b43106f0'),
	IngressFileUpload: () => import('./ingressUpload.js?v=b43106f0'),
	IngressList: () => import('./lists.js?v=b43106f0'),
	MobileTableControls: () => import('./mobileControls.js?v=b43106f0'),
	ModelTaskInfo: () => import('./modelTasks.js?v=b43106f0'),
	ModelTaskList: () => import('./modelTasks.js?v=b43106f0'),
	PageInfo: () => import('./pageInfo.js?v=b43106f0'),
	PagePermissions: () => import('./pagePermissions.js?v=b43106f0'),
	PagePhoto: () => import('./pagePhoto.js?v=b43106f0'),
	PageTaskList: () => import('./pageTaskList.js?v=b43106f0'),
	ProjectInfo: () => import('./projectInfo.js?v=b43106f0'),
	PublicPermissions: () => import('./userPermissions.js?v=b43106f0'),
	SavedFilters: () => import('./filters.js?v=b43106f0'),
	SiteAiModels: () => import('./aiModels.js?v=b43106f0'),
	SiteAdministrators: () => import('./administrators.js?v=b43106f0'),
	SiteDeployment: () => import('./deployment.js?v=b43106f0'),
	SiteInstallationAccess: () => import('./installationAccess.js?v=b43106f0'),
	SiteImage: () => import('./image.js?v=b43106f0'),
	SiteMaintenance: () => import('./maintenance.js?v=b43106f0'),
	SiteServiceProviders: () => import('./providers.js?v=b43106f0'),
	SiteSettings: () => import('./siteSettings.js?v=b43106f0'),
	StarredList: () => import('./lists.js?v=b43106f0'),
	TableEditor: () => import('./editor.js?v=b43106f0'),
	TableSorting: () => import('./sorting.js?v=b43106f0'),
	TableVisibility: () => import('./visibility.js?v=b43106f0'),
	TaskForm: () => import('./taskForm.js?v=b43106f0'),
	TaskHistory: () => import('./taskHistory.js?v=b43106f0'),
	TaskCombine: () => import('./taskSettings.js?v=b43106f0'),
	TaskMove: () => import('./taskSettings.js?v=b43106f0'),
	ToolReportList: () => import('./lists.js?v=b43106f0'),
	TaskSettings: () => import('./taskSettings.js?v=b43106f0'),
	UserSettings: () => import('./userSettings.js?v=b43106f0'),
};
...
const ensureOfflineQueue = (view) =>
	loadOnce(view, "_offlineQueuePromise", "offlineQueue", async () => {
		const { OfflineQueue } = await import('./offlineQueue.js?v=b43106f0');
...
const ensurePollingCoordinator = (view) =>
	loadOnce(view, "_pollingPromise", "PollingCoordinator", async () => {
		const { PollingCoordinator } = await import('./polling.js?v=b43106f0');
		if (view._destroyed) return null;
...
const ensureSyncManager = (view) =>
	loadOnce(view, "_syncPromise", "SyncManager", async () => {
		...
		const { SyncManager } = await import('./sync.js?v=b43106f0');
		if (view._destroyed) return null;
...
const ensureEditWatcher = (view) =>
	loadOnce(view, "_editWatcherPromise", "EditWatcher", async () => {
		await ensurePollingCoordinator(view);
		const { EditWatcher } = await import('./watcher.js?v=b43106f0');
		if (view._destroyed) return null;
	...
	loadOnce(
		...
		async () => {
			...
			const { DeferredOperationManager } = await import(
				'./deferredOperations.js?v=b43106f0'
			);
			if (view._destroyed) return null;
...
const ensureNotifications = (view) =>
	loadOnce(view, "_notificationsPromise", "Notifications", async () => {
		...
		const { Notifications } = await import('./notifications.js?v=b43106f0');
		if (view._destroyed) return null;
...
const ensureSearchBox = (view) =>
	loadOnce(view, "_searchPromise", "SearchBox", async () => {
		...
		const { SearchBox } = await import('./search.js?v=b43106f0');
		if (view._destroyed) return null;
...
const ensureEntityMenu = (view) =>
	loadOnce(view, "_entityMenuPromise", "EntityMenu", async () => {
		const { EntityMenu } = await import('./entityMenu.js?v=b43106f0');
		if (view._destroyed) return null;
...
const ensureSubmissionManager = (view) =>
	loadOnce(view, "_submissionPromise", "SubmissionManager", async () => {
		const { SubmissionManager } = await import('./submission.js?v=b43106f0');
		if (view._destroyed) return null;
...
const ensureOfflineModal = (view) =>
	loadOnce(view, "_offlineModalPromise", "offlineModal", async () => {
		...
		const { OfflineModal } = await import('./modal.js?v=b43106f0');
		if (view._destroyed) return null;
...
const initializeCoreServices = (view) => {
	...
	const offlineWork = idle.then(async () => {
		const { inspectOfflineWork } = await import('./offlineWork.js?v=b43106f0');
	...
	view.initialReplayReady = view.offlineQueueReady.then(async (queue) => {
		if (!queue) return 0;
		const { replayOfflineQueue } = await import('./offlineReplay.js?v=b43106f0');
...
class Core extends ShellView {
	...
	scheduleOfflineReplay() {
		...
		const replay = import('./offlineReplay.js?v=b43106f0').then(
