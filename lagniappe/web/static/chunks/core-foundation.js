...
import { c as connectivity } from './connectivity.js?v=b1aeef6f';
import { c as captureError, E as ENDPOINTS, w as withTransition, r as request, a as whenIdle, m as markPerformance, S as ShellView } from './foundation.js?v=b1aeef6f';
import { clearRecentSearchResults } from './storage.js?v=b1aeef6f';
...
const WIDGETS = {
	BaseList: () => import('./baseList.js?v=b1aeef6f'),
	CategoryInfo: () => import('./category.js?v=b1aeef6f'),
	CollaborativeDocument: () => import('./collaborative.js?v=b1aeef6f'),
	CreateCategory: () => import('./category.js?v=b1aeef6f'),
	CreateForm: () => import('./form.js?v=b1aeef6f'),
	CreateModelTask: () => import('./modelTasks.js?v=b1aeef6f'),
	CreateNote: () => import('./note.js?v=b1aeef6f'),
	CreatePage: () => import('./pageInfo.js?v=b1aeef6f'),
	CreateProject: () => import('./projectInfo.js?v=b1aeef6f'),
	CreateToolReport: () => import('./tools.js?v=b1aeef6f'),
	CreateUserTask: () => import('./taskSettings.js?v=b1aeef6f'),
	CreateTask: () => import('./taskSettings.js?v=b1aeef6f'),
	CreateUser: () => import('./user.js?v=b1aeef6f'),
	CreateUserGroup: () => import('./user.js?v=b1aeef6f'),
	DirectoryList: () => import('./lists.js?v=b1aeef6f'),
	DocumentSettings: () => import('./documentSettings.js?v=b1aeef6f'),
	FileInfo: () => import('./fileInfo.js?v=b1aeef6f'),
	PDFPreview: () => import('./filePdfPreview.js?v=b1aeef6f'),
	FileUpload: () => import('./uploadFile.js?v=b1aeef6f'),
	Filters: () => import('./filters.js?v=b1aeef6f'),
	FilterResults: () => import('./filterResults.js?v=b1aeef6f'),
	GroupPermissions: () => import('./userPermissions.js?v=b1aeef6f'),
	HomeActivityList: () => import('./activity.js?v=b1aeef6f'),
	HomePageList: () => import('./lists.js?v=b1aeef6f'),
	HomeTaskList: () => import('./tasks.js?v=b1aeef6f'),
	HomeProjectList: () => import('./lists.js?v=b1aeef6f'),
	HomeCategoryList: () => import('./lists.js?v=b1aeef6f'),
	ImportData: () => import('./ingress.js?v=b1aeef6f'),
	IndexTable: () => import('./indexTable.js?v=b1aeef6f'),
	IngressFileUpload: () => import('./ingressUpload.js?v=b1aeef6f'),
	IngressList: () => import('./lists.js?v=b1aeef6f'),
	MobileTableControls: () => import('./mobileControls.js?v=b1aeef6f'),
	ModelTaskInfo: () => import('./modelTasks.js?v=b1aeef6f'),
	ModelTaskList: () => import('./modelTasks.js?v=b1aeef6f'),
	PageInfo: () => import('./pageInfo.js?v=b1aeef6f'),
	PagePermissions: () => import('./pagePermissions.js?v=b1aeef6f'),
	PagePhoto: () => import('./pagePhoto.js?v=b1aeef6f'),
	PageTaskList: () => import('./pageTaskList.js?v=b1aeef6f'),
	ProjectInfo: () => import('./projectInfo.js?v=b1aeef6f'),
	PublicPermissions: () => import('./userPermissions.js?v=b1aeef6f'),
	SavedFilters: () => import('./filters.js?v=b1aeef6f'),
	SiteAiModels: () => import('./aiModels.js?v=b1aeef6f'),
	SiteAdministrators: () => import('./administrators.js?v=b1aeef6f'),
	SiteDeployment: () => import('./deployment.js?v=b1aeef6f'),
	SiteInstallationAccess: () => import('./installationAccess.js?v=b1aeef6f'),
	SiteImage: () => import('./image.js?v=b1aeef6f'),
	SiteMaintenance: () => import('./maintenance.js?v=b1aeef6f'),
	SiteServiceProviders: () => import('./providers.js?v=b1aeef6f'),
	SiteSettings: () => import('./siteSettings.js?v=b1aeef6f'),
	StarredList: () => import('./lists.js?v=b1aeef6f'),
	TableEditor: () => import('./editor.js?v=b1aeef6f'),
	TableSorting: () => import('./sorting.js?v=b1aeef6f'),
	TableVisibility: () => import('./visibility.js?v=b1aeef6f'),
	TaskForm: () => import('./taskForm.js?v=b1aeef6f'),
	TaskHistory: () => import('./taskHistory.js?v=b1aeef6f'),
	TaskCombine: () => import('./taskSettings.js?v=b1aeef6f'),
	TaskMove: () => import('./taskSettings.js?v=b1aeef6f'),
	ToolReportList: () => import('./lists.js?v=b1aeef6f'),
	TaskSettings: () => import('./taskSettings.js?v=b1aeef6f'),
	UserSettings: () => import('./userSettings.js?v=b1aeef6f'),
};
...
const ensureOfflineQueue = (view) =>
	loadOnce(view, "_offlineQueuePromise", "offlineQueue", async () => {
		const { OfflineQueue } = await import('./offlineQueue.js?v=b1aeef6f');
...
const ensurePollingCoordinator = (view) =>
	loadOnce(view, "_pollingPromise", "PollingCoordinator", async () => {
		const { PollingCoordinator } = await import('./polling.js?v=b1aeef6f');
		if (view._destroyed) return null;
...
const ensureSyncManager = (view) =>
	loadOnce(view, "_syncPromise", "SyncManager", async () => {
		...
		const { SyncManager } = await import('./sync.js?v=b1aeef6f');
		if (view._destroyed) return null;
...
const ensureEditWatcher = (view) =>
	loadOnce(view, "_editWatcherPromise", "EditWatcher", async () => {
		await ensurePollingCoordinator(view);
		const { EditWatcher } = await import('./watcher.js?v=b1aeef6f');
		if (view._destroyed) return null;
	...
	loadOnce(
		...
		async () => {
			...
			const { DeferredOperationManager } = await import(
				'./deferredOperations.js?v=b1aeef6f'
			);
			if (view._destroyed) return null;
...
const ensureNotifications = (view) =>
	loadOnce(view, "_notificationsPromise", "Notifications", async () => {
		...
		const { Notifications } = await import('./notifications.js?v=b1aeef6f');
		if (view._destroyed) return null;
...
const ensureSearchBox = (view) =>
	loadOnce(view, "_searchPromise", "SearchBox", async () => {
		...
		const { SearchBox } = await import('./search.js?v=b1aeef6f');
		if (view._destroyed) return null;
...
const ensureEntityMenu = (view) =>
	loadOnce(view, "_entityMenuPromise", "EntityMenu", async () => {
		const { EntityMenu } = await import('./entityMenu.js?v=b1aeef6f');
		if (view._destroyed) return null;
...
const ensureSubmissionManager = (view) =>
	loadOnce(view, "_submissionPromise", "SubmissionManager", async () => {
		const { SubmissionManager } = await import('./submission.js?v=b1aeef6f');
		if (view._destroyed) return null;
...
const ensureOfflineModal = (view) =>
	loadOnce(view, "_offlineModalPromise", "offlineModal", async () => {
		...
		const { OfflineModal } = await import('./modal.js?v=b1aeef6f');
		if (view._destroyed) return null;
...
const initializeCoreServices = (view) => {
	...
	const offlineWork = idle.then(async () => {
		const { inspectOfflineWork } = await import('./offlineWork.js?v=b1aeef6f');
	...
	view.initialReplayReady = view.offlineQueueReady.then(async (queue) => {
		if (!queue) return 0;
		const { replayOfflineQueue } = await import('./offlineReplay.js?v=b1aeef6f');
...
class Core extends ShellView {
	...
	scheduleOfflineReplay() {
		...
		const replay = import('./offlineReplay.js?v=b1aeef6f').then(
