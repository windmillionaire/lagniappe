...
import { c as connectivity } from './connectivity.js?v=b7cf764f';
import { c as captureError, E as ENDPOINTS, w as withTransition, s as showBriefly, a as clearRecentSearchResults, r as request, b as whenIdle, m as markPerformance, S as ShellView } from './foundation.js?v=b7cf764f';
...
const WIDGETS = {
	BaseList: () => import('./baseList.js?v=b7cf764f'),
	CategoryInfo: () => import('./category.js?v=b7cf764f'),
	CollaborativeDocument: () => import('./collaborative.js?v=b7cf764f'),
	CreateCategory: () => import('./category.js?v=b7cf764f'),
	CreateForm: () => import('./form.js?v=b7cf764f'),
	CreateModelTask: () => import('./modelTasks.js?v=b7cf764f'),
	CreateNote: () => import('./note.js?v=b7cf764f'),
	CreatePage: () => import('./pageInfo.js?v=b7cf764f'),
	CreateProject: () => import('./projectInfo.js?v=b7cf764f'),
	CreateToolReport: () => import('./tools.js?v=b7cf764f'),
	CreateUserTask: () => import('./taskSettings.js?v=b7cf764f'),
	CreateTask: () => import('./taskSettings.js?v=b7cf764f'),
	CreateUser: () => import('./user.js?v=b7cf764f'),
	CreateUserGroup: () => import('./user.js?v=b7cf764f'),
	DirectoryList: () => import('./lists.js?v=b7cf764f'),
	DocumentSettings: () => import('./documentSettings.js?v=b7cf764f'),
	FileInfo: () => import('./fileInfo.js?v=b7cf764f'),
	PDFPreview: () => import('./filePdfPreview.js?v=b7cf764f'),
	FileUpload: () => import('./uploadFile.js?v=b7cf764f'),
	Filters: () => import('./filters.js?v=b7cf764f'),
	FilterResults: () => import('./tables.js?v=b7cf764f'),
	GroupPermissions: () => import('./user.js?v=b7cf764f'),
	HomeActivityList: () => import('./activity.js?v=b7cf764f'),
	HomePageList: () => import('./lists.js?v=b7cf764f'),
	HomeTaskList: () => import('./tasks.js?v=b7cf764f'),
	HomeProjectList: () => import('./lists.js?v=b7cf764f'),
	HomeCategoryList: () => import('./lists.js?v=b7cf764f'),
	ImportData: () => import('./ingress.js?v=b7cf764f'),
	IndexTable: () => import('./tables.js?v=b7cf764f'),
	IngressFileUpload: () => import('./ingressUpload.js?v=b7cf764f'),
	IngressList: () => import('./lists.js?v=b7cf764f'),
	MobileTableControls: () => import('./mobileTableControls.js?v=b7cf764f'),
	ModelTaskInfo: () => import('./modelTasks.js?v=b7cf764f'),
	ModelTaskList: () => import('./modelTasks.js?v=b7cf764f'),
	PageInfo: () => import('./pageInfo.js?v=b7cf764f'),
	PagePermissions: () => import('./pagePermissions.js?v=b7cf764f'),
	PagePhoto: () => import('./pagePhoto.js?v=b7cf764f'),
	PageTaskList: () => import('./pageTaskList.js?v=b7cf764f'),
	ProjectInfo: () => import('./projectInfo.js?v=b7cf764f'),
	PublicPermissions: () => import('./user.js?v=b7cf764f'),
	SavedFilters: () => import('./filters.js?v=b7cf764f'),
	SiteAiModels: () => import('./aiModels.js?v=b7cf764f'),
	SiteAdministrators: () => import('./administrators.js?v=b7cf764f'),
	SiteDeployment: () => import('./deployment.js?v=b7cf764f'),
	SiteInstallationAccess: () => import('./installationAccess.js?v=b7cf764f'),
	SiteImage: () => import('./image.js?v=b7cf764f'),
	SiteMaintenance: () => import('./maintenance.js?v=b7cf764f'),
	SiteServiceProviders: () => import('./providers.js?v=b7cf764f'),
	SiteSettings: () => import('./siteSettings.js?v=b7cf764f'),
	StarredList: () => import('./lists.js?v=b7cf764f'),
	TableEditor: () => import('./tableEditor.js?v=b7cf764f'),
	TableSorting: () => import('./tableSorting.js?v=b7cf764f'),
	TableVisibility: () => import('./tableVisibility.js?v=b7cf764f'),
	TaskForm: () => import('./taskForm.js?v=b7cf764f'),
	TaskHistory: () => import('./tables.js?v=b7cf764f'),
	TaskCombine: () => import('./taskSettings.js?v=b7cf764f'),
	TaskMove: () => import('./taskSettings.js?v=b7cf764f'),
	ToolReportList: () => import('./lists.js?v=b7cf764f'),
	TaskSettings: () => import('./taskSettings.js?v=b7cf764f'),
	UserSettings: () => import('./pageInfo.js?v=b7cf764f'),
};

/** Sync-capable widgets that can run without a mounted view (offline replay). */
const HEADLESS_WIDGETS = {
	document: {
		load: () => import('./collaborative.js?v=b7cf764f'),
...
const ensureOfflineQueue = (view) =>
	loadOnce(view, "_offlineQueuePromise", "offlineQueue", async () => {
		const { OfflineQueue } = await import('./offlineQueue.js?v=b7cf764f');
...
const ensurePollingCoordinator = (view) =>
	loadOnce(view, "_pollingPromise", "PollingCoordinator", async () => {
		const { PollingCoordinator } = await import('./polling.js?v=b7cf764f');
		if (view._destroyed) return null;
...
const ensureSyncManager = (view) =>
	loadOnce(view, "_syncPromise", "SyncManager", async () => {
		...
		const { SyncManager } = await import('./sync.js?v=b7cf764f');
		if (view._destroyed) return null;
...
const ensureEditWatcher = (view) =>
	loadOnce(view, "_editWatcherPromise", "EditWatcher", async () => {
		await ensurePollingCoordinator(view);
		const { EditWatcher } = await import('./editWatcher.js?v=b7cf764f');
		if (view._destroyed) return null;
	...
	loadOnce(
		...
		async () => {
			...
			const { DeferredOperationManager } = await import(
				'./deferredOperations.js?v=b7cf764f'
			);
			if (view._destroyed) return null;
...
const ensureNotifications = (view) =>
	loadOnce(view, "_notificationsPromise", "Notifications", async () => {
		...
		const { Notifications } = await import('./notifications.js?v=b7cf764f');
		if (view._destroyed) return null;
...
const ensureSearchBox = (view) =>
	loadOnce(view, "_searchPromise", "SearchBox", async () => {
		...
		const { SearchBox } = await import('./search.js?v=b7cf764f');
		if (view._destroyed) return null;
...
const ensureEntityMenu = (view) =>
	loadOnce(view, "_entityMenuPromise", "EntityMenu", async () => {
		const { EntityMenu } = await import('./entityMenu.js?v=b7cf764f');
		if (view._destroyed) return null;
...
const ensureSubmissionManager = (view) =>
	loadOnce(view, "_submissionPromise", "SubmissionManager", async () => {
		const { SubmissionManager } = await import('./submission.js?v=b7cf764f');
		if (view._destroyed) return null;
...
const ensureOfflineModal = (view) =>
	loadOnce(view, "_offlineModalPromise", "offlineModal", async () => {
		...
		const { OfflineModal } = await import('./modal.js?v=b7cf764f');
		if (view._destroyed) return null;
...
const initializeCoreServices = (view) => {
	...
	const offlineWork = idle.then(async () => {
		const { inspectOfflineWork } = await import('./offlineWork.js?v=b7cf764f');
	...
	view.initialReplayReady = view.offlineQueueReady.then(async (queue) => {
		if (!queue) return 0;
		const { replayOfflineQueue } = await import('./offlineReplay.js?v=b7cf764f');
...
class Core extends ShellView {
	...
	scheduleOfflineReplay() {
		...
		const replay = import('./offlineReplay.js?v=b7cf764f').then(({ replayOfflineQueue }) =>
