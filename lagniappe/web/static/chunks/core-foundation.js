...
import { c as connectivity } from './connectivity.js?v=b9ebf388';
import { c as captureError, E as ENDPOINTS, w as withTransition, s as showBriefly, a as clearRecentSearchResults, r as request, b as whenIdle, m as markPerformance, S as ShellView } from './foundation.js?v=b9ebf388';
...
const WIDGETS = {
	BaseList: () => import('./baseList.js?v=b9ebf388'),
	CategoryInfo: () => import('./category.js?v=b9ebf388'),
	CollaborativeDocument: () => import('./collaborative.js?v=b9ebf388'),
	CreateCategory: () => import('./category.js?v=b9ebf388'),
	CreateForm: () => import('./form.js?v=b9ebf388'),
	CreateModelTask: () => import('./modelTasks.js?v=b9ebf388'),
	CreateNote: () => import('./note.js?v=b9ebf388'),
	CreatePage: () => import('./pageInfo.js?v=b9ebf388'),
	CreateProject: () => import('./projectInfo.js?v=b9ebf388'),
	CreateToolReport: () => import('./tools.js?v=b9ebf388'),
	CreateUserTask: () => import('./taskSettings.js?v=b9ebf388'),
	CreateTask: () => import('./taskSettings.js?v=b9ebf388'),
	CreateUser: () => import('./user.js?v=b9ebf388'),
	CreateUserGroup: () => import('./user.js?v=b9ebf388'),
	DirectoryList: () => import('./lists.js?v=b9ebf388'),
	DocumentSettings: () => import('./documentSettings.js?v=b9ebf388'),
	FileInfo: () => import('./fileInfo.js?v=b9ebf388'),
	PDFPreview: () => import('./filePdfPreview.js?v=b9ebf388'),
	FileUpload: () => import('./uploadFile.js?v=b9ebf388'),
	Filters: () => import('./filters.js?v=b9ebf388'),
	FilterResults: () => import('./tables.js?v=b9ebf388'),
	GroupPermissions: () => import('./user.js?v=b9ebf388'),
	HomeActivityList: () => import('./activity.js?v=b9ebf388'),
	HomePageList: () => import('./lists.js?v=b9ebf388'),
	HomeTaskList: () => import('./tasks.js?v=b9ebf388'),
	HomeProjectList: () => import('./lists.js?v=b9ebf388'),
	HomeCategoryList: () => import('./lists.js?v=b9ebf388'),
	ImportData: () => import('./ingress.js?v=b9ebf388'),
	IndexTable: () => import('./tables.js?v=b9ebf388'),
	IngressFileUpload: () => import('./ingressUpload.js?v=b9ebf388'),
	IngressList: () => import('./lists.js?v=b9ebf388'),
	MobileTableControls: () => import('./mobileTableControls.js?v=b9ebf388'),
	ModelTaskInfo: () => import('./modelTasks.js?v=b9ebf388'),
	ModelTaskList: () => import('./modelTasks.js?v=b9ebf388'),
	PageInfo: () => import('./pageInfo.js?v=b9ebf388'),
	PagePermissions: () => import('./pagePermissions.js?v=b9ebf388'),
	PagePhoto: () => import('./pagePhoto.js?v=b9ebf388'),
	PageTaskList: () => import('./pageTaskList.js?v=b9ebf388'),
	ProjectInfo: () => import('./projectInfo.js?v=b9ebf388'),
	PublicPermissions: () => import('./user.js?v=b9ebf388'),
	SavedFilters: () => import('./filters.js?v=b9ebf388'),
	SiteAiModels: () => import('./aiModels.js?v=b9ebf388'),
	SiteAdministrators: () => import('./administrators.js?v=b9ebf388'),
	SiteDeployment: () => import('./deployment.js?v=b9ebf388'),
	SiteInstallationAccess: () => import('./installationAccess.js?v=b9ebf388'),
	SiteImage: () => import('./image.js?v=b9ebf388'),
	SiteMaintenance: () => import('./maintenance.js?v=b9ebf388'),
	SiteServiceProviders: () => import('./providers.js?v=b9ebf388'),
	SiteSettings: () => import('./siteSettings.js?v=b9ebf388'),
	StarredList: () => import('./lists.js?v=b9ebf388'),
	TableEditor: () => import('./tableEditor.js?v=b9ebf388'),
	TableSorting: () => import('./tableSorting.js?v=b9ebf388'),
	TableVisibility: () => import('./tableVisibility.js?v=b9ebf388'),
	TaskForm: () => import('./taskForm.js?v=b9ebf388'),
	TaskHistory: () => import('./tables.js?v=b9ebf388'),
	TaskCombine: () => import('./taskSettings.js?v=b9ebf388'),
	TaskMove: () => import('./taskSettings.js?v=b9ebf388'),
	ToolReportList: () => import('./lists.js?v=b9ebf388'),
	TaskSettings: () => import('./taskSettings.js?v=b9ebf388'),
	UserSettings: () => import('./pageInfo.js?v=b9ebf388'),
};

/** Sync-capable widgets that can run without a mounted view (offline replay). */
const HEADLESS_WIDGETS = {
	document: {
		load: () => import('./collaborative.js?v=b9ebf388'),
...
const ensureOfflineQueue = (view) =>
	loadOnce(view, "_offlineQueuePromise", "offlineQueue", async () => {
		const { OfflineQueue } = await import('./offlineQueue.js?v=b9ebf388');
...
const ensurePollingCoordinator = (view) =>
	loadOnce(view, "_pollingPromise", "PollingCoordinator", async () => {
		const { PollingCoordinator } = await import('./polling.js?v=b9ebf388');
		if (view._destroyed) return null;
...
const ensureSyncManager = (view) =>
	loadOnce(view, "_syncPromise", "SyncManager", async () => {
		...
		const { SyncManager } = await import('./sync.js?v=b9ebf388');
		if (view._destroyed) return null;
...
const ensureEditWatcher = (view) =>
	loadOnce(view, "_editWatcherPromise", "EditWatcher", async () => {
		await ensurePollingCoordinator(view);
		const { EditWatcher } = await import('./editWatcher.js?v=b9ebf388');
		if (view._destroyed) return null;
	...
	loadOnce(
		...
		async () => {
			...
			const { DeferredOperationManager } = await import(
				'./deferredOperations.js?v=b9ebf388'
			);
			if (view._destroyed) return null;
...
const ensureNotifications = (view) =>
	loadOnce(view, "_notificationsPromise", "Notifications", async () => {
		...
		const { Notifications } = await import('./notifications.js?v=b9ebf388');
		if (view._destroyed) return null;
...
const ensureSearchBox = (view) =>
	loadOnce(view, "_searchPromise", "SearchBox", async () => {
		...
		const { SearchBox } = await import('./search.js?v=b9ebf388');
		if (view._destroyed) return null;
...
const ensureEntityMenu = (view) =>
	loadOnce(view, "_entityMenuPromise", "EntityMenu", async () => {
		const { EntityMenu } = await import('./entityMenu.js?v=b9ebf388');
		if (view._destroyed) return null;
...
const ensureSubmissionManager = (view) =>
	loadOnce(view, "_submissionPromise", "SubmissionManager", async () => {
		const { SubmissionManager } = await import('./submission.js?v=b9ebf388');
		if (view._destroyed) return null;
...
const ensureOfflineModal = (view) =>
	loadOnce(view, "_offlineModalPromise", "offlineModal", async () => {
		...
		const { OfflineModal } = await import('./modal.js?v=b9ebf388');
		if (view._destroyed) return null;
...
const initializeCoreServices = (view) => {
	...
	const offlineWork = idle.then(async () => {
		const { inspectOfflineWork } = await import('./offlineWork.js?v=b9ebf388');
	...
	view.initialReplayReady = view.offlineQueueReady.then(async (queue) => {
		if (!queue) return 0;
		const { replayOfflineQueue } = await import('./offlineReplay.js?v=b9ebf388');
...
class Core extends ShellView {
	...
	scheduleOfflineReplay() {
		...
		const replay = import('./offlineReplay.js?v=b9ebf388').then(({ replayOfflineQueue }) =>
