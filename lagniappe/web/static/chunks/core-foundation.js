...
import { c as connectivity } from './connectivity.js?v=b24ca4c6';
import { c as captureError, E as ENDPOINTS, w as withTransition, a as clearRecentSearchResults, r as request, b as whenIdle, m as markPerformance, S as ShellView } from './foundation.js?v=b24ca4c6';
...
const WIDGETS = {
	BaseList: () => import('./baseList.js?v=b24ca4c6'),
	CategoryInfo: () => import('./category.js?v=b24ca4c6'),
	CollaborativeDocument: () => import('./collaborative.js?v=b24ca4c6'),
	CreateCategory: () => import('./category.js?v=b24ca4c6'),
	CreateForm: () => import('./form.js?v=b24ca4c6'),
	CreateModelTask: () => import('./modelTasks.js?v=b24ca4c6'),
	CreateNote: () => import('./note.js?v=b24ca4c6'),
	CreatePage: () => import('./pageInfo.js?v=b24ca4c6'),
	CreateProject: () => import('./projectInfo.js?v=b24ca4c6'),
	CreateToolReport: () => import('./tools.js?v=b24ca4c6'),
	CreateUserTask: () => import('./taskSettings.js?v=b24ca4c6'),
	CreateTask: () => import('./taskSettings.js?v=b24ca4c6'),
	CreateUser: () => import('./user.js?v=b24ca4c6'),
	CreateUserGroup: () => import('./user.js?v=b24ca4c6'),
	DirectoryList: () => import('./lists.js?v=b24ca4c6'),
	DocumentSettings: () => import('./documentSettings.js?v=b24ca4c6'),
	FileInfo: () => import('./fileInfo.js?v=b24ca4c6'),
	PDFPreview: () => import('./filePdfPreview.js?v=b24ca4c6'),
	FileUpload: () => import('./uploadFile.js?v=b24ca4c6'),
	Filters: () => import('./filters.js?v=b24ca4c6'),
	FilterResults: () => import('./tables.js?v=b24ca4c6'),
	GroupPermissions: () => import('./user.js?v=b24ca4c6'),
	HomeActivityList: () => import('./activity.js?v=b24ca4c6'),
	HomePageList: () => import('./lists.js?v=b24ca4c6'),
	HomeTaskList: () => import('./tasks.js?v=b24ca4c6'),
	HomeProjectList: () => import('./lists.js?v=b24ca4c6'),
	HomeCategoryList: () => import('./lists.js?v=b24ca4c6'),
	ImportData: () => import('./ingress.js?v=b24ca4c6'),
	IndexTable: () => import('./tables.js?v=b24ca4c6'),
	IngressFileUpload: () => import('./ingressUpload.js?v=b24ca4c6'),
	IngressList: () => import('./lists.js?v=b24ca4c6'),
	MobileTableControls: () => import('./mobileTableControls.js?v=b24ca4c6'),
	ModelTaskInfo: () => import('./modelTasks.js?v=b24ca4c6'),
	ModelTaskList: () => import('./modelTasks.js?v=b24ca4c6'),
	PageInfo: () => import('./pageInfo.js?v=b24ca4c6'),
	PagePermissions: () => import('./pagePermissions.js?v=b24ca4c6'),
	PagePhoto: () => import('./pagePhoto.js?v=b24ca4c6'),
	PageTaskList: () => import('./pageTaskList.js?v=b24ca4c6'),
	ProjectInfo: () => import('./projectInfo.js?v=b24ca4c6'),
	PublicPermissions: () => import('./user.js?v=b24ca4c6'),
	SavedFilters: () => import('./filters.js?v=b24ca4c6'),
	SiteAiModels: () => import('./aiModels.js?v=b24ca4c6'),
	SiteAdministrators: () => import('./administrators.js?v=b24ca4c6'),
	SiteDeployment: () => import('./deployment.js?v=b24ca4c6'),
	SiteInstallationAccess: () => import('./installationAccess.js?v=b24ca4c6'),
	SiteImage: () => import('./image.js?v=b24ca4c6'),
	SiteMaintenance: () => import('./maintenance.js?v=b24ca4c6'),
	SiteServiceProviders: () => import('./providers.js?v=b24ca4c6'),
	SiteSettings: () => import('./siteSettings.js?v=b24ca4c6'),
	StarredList: () => import('./lists.js?v=b24ca4c6'),
	TableEditor: () => import('./tableEditor.js?v=b24ca4c6'),
	TableSorting: () => import('./tableSorting.js?v=b24ca4c6'),
	TableVisibility: () => import('./tableVisibility.js?v=b24ca4c6'),
	TaskForm: () => import('./taskForm.js?v=b24ca4c6'),
	TaskHistory: () => import('./tables.js?v=b24ca4c6'),
	TaskCombine: () => import('./taskSettings.js?v=b24ca4c6'),
	TaskMove: () => import('./taskSettings.js?v=b24ca4c6'),
	ToolReportList: () => import('./lists.js?v=b24ca4c6'),
	TaskSettings: () => import('./taskSettings.js?v=b24ca4c6'),
	UserSettings: () => import('./pageInfo.js?v=b24ca4c6'),
};

/** Sync-capable widgets that can run without a mounted view (offline replay). */
const HEADLESS_WIDGETS = {
	document: {
		load: () => import('./collaborative.js?v=b24ca4c6'),
...
const ensureOfflineQueue = (view) =>
	loadOnce(view, "_offlineQueuePromise", "offlineQueue", async () => {
		const { OfflineQueue } = await import('./offlineQueue.js?v=b24ca4c6');
...
const ensurePollingCoordinator = (view) =>
	loadOnce(view, "_pollingPromise", "PollingCoordinator", async () => {
		const { PollingCoordinator } = await import('./polling.js?v=b24ca4c6');
		if (view._destroyed) return null;
...
const ensureSyncManager = (view) =>
	loadOnce(view, "_syncPromise", "SyncManager", async () => {
		...
		const { SyncManager } = await import('./sync.js?v=b24ca4c6');
		if (view._destroyed) return null;
...
const ensureEditWatcher = (view) =>
	loadOnce(view, "_editWatcherPromise", "EditWatcher", async () => {
		await ensurePollingCoordinator(view);
		const { EditWatcher } = await import('./editWatcher.js?v=b24ca4c6');
		if (view._destroyed) return null;
	...
	loadOnce(
		...
		async () => {
			...
			const { DeferredOperationManager } = await import(
				'./deferredOperations.js?v=b24ca4c6'
			);
			if (view._destroyed) return null;
...
const ensureNotifications = (view) =>
	loadOnce(view, "_notificationsPromise", "Notifications", async () => {
		...
		const { Notifications } = await import('./notifications.js?v=b24ca4c6');
		if (view._destroyed) return null;
...
const ensureSearchBox = (view) =>
	loadOnce(view, "_searchPromise", "SearchBox", async () => {
		...
		const { SearchBox } = await import('./search.js?v=b24ca4c6');
		if (view._destroyed) return null;
...
const ensureEntityMenu = (view) =>
	loadOnce(view, "_entityMenuPromise", "EntityMenu", async () => {
		const { EntityMenu } = await import('./entityMenu.js?v=b24ca4c6');
		if (view._destroyed) return null;
...
const ensureSubmissionManager = (view) =>
	loadOnce(view, "_submissionPromise", "SubmissionManager", async () => {
		const { SubmissionManager } = await import('./submission.js?v=b24ca4c6');
		if (view._destroyed) return null;
...
const ensureOfflineModal = (view) =>
	loadOnce(view, "_offlineModalPromise", "offlineModal", async () => {
		...
		const { OfflineModal } = await import('./modal.js?v=b24ca4c6');
		if (view._destroyed) return null;
...
const initializeCoreServices = (view) => {
	...
	const offlineWork = idle.then(async () => {
		const { inspectOfflineWork } = await import('./offlineWork.js?v=b24ca4c6');
	...
	view.initialReplayReady = view.offlineQueueReady.then(async (queue) => {
		if (!queue) return 0;
		const { replayOfflineQueue } = await import('./offlineReplay.js?v=b24ca4c6');
...
class Core extends ShellView {
	...
	scheduleOfflineReplay() {
		...
		const replay = import('./offlineReplay.js?v=b24ca4c6').then(({ replayOfflineQueue }) =>
