...
const WIDGETS = {
	BaseList: () => import('./baseList.js?v=b30f3f24'),
	CategoryInfo: () => import('./category.js?v=b30f3f24'),
	CollaborativeDocument: () => import('./collaborative.js?v=b30f3f24'),
	CreateCategory: () => import('./category.js?v=b30f3f24'),
	CreateForm: () => import('./form.js?v=b30f3f24'),
	CreateModelTask: () => import('./modelTasks.js?v=b30f3f24'),
	CreateNote: () => import('./note.js?v=b30f3f24'),
	CreatePage: () => import('./pageInfo.js?v=b30f3f24'),
	CreateProject: () => import('./projectInfo.js?v=b30f3f24'),
	CreateToolReport: () => import('./tools.js?v=b30f3f24'),
	CreateUserTask: () => import('./taskSettings.js?v=b30f3f24'),
	CreateTask: () => import('./taskSettings.js?v=b30f3f24'),
	CreateUser: () => import('./user.js?v=b30f3f24'),
	CreateUserGroup: () => import('./user.js?v=b30f3f24'),
	DirectoryList: () => import('./lists.js?v=b30f3f24'),
	DocumentSettings: () => import('./documentSettings.js?v=b30f3f24'),
	FileInfo: () => import('./fileInfo.js?v=b30f3f24'),
	PDFPreview: () => import('./filePdfPreview.js?v=b30f3f24'),
	FileUpload: () => import('./uploadFile.js?v=b30f3f24'),
	Filters: () => import('./filters.js?v=b30f3f24'),
	FilterResults: () => import('./tables.js?v=b30f3f24'),
	GeneratePages: () => import('./category.js?v=b30f3f24'),
	GroupPermissions: () => import('./user.js?v=b30f3f24'),
	HomeActivityList: () => import('./activity.js?v=b30f3f24'),
	HomePageList: () => import('./lists.js?v=b30f3f24'),
	HomeTaskList: () => import('./tasks.js?v=b30f3f24'),
	HomeProjectList: () => import('./lists.js?v=b30f3f24'),
	HomeCategoryList: () => import('./lists.js?v=b30f3f24'),
	ImportData: () => import('./ingress.js?v=b30f3f24'),
	IndexTable: () => import('./tables.js?v=b30f3f24'),
	IngressFileUpload: () => import('./ingressUpload.js?v=b30f3f24'),
	IngressList: () => import('./lists.js?v=b30f3f24'),
	MobileTableControls: () => import('./mobileTableControls.js?v=b30f3f24'),
	ModelTaskInfo: () => import('./modelTasks.js?v=b30f3f24'),
	ModelTaskList: () => import('./modelTasks.js?v=b30f3f24'),
	PageInfo: () => import('./pageInfo.js?v=b30f3f24'),
	PagePermissions: () => import('./pagePermissions.js?v=b30f3f24'),
	PagePhoto: () => import('./pagePhoto.js?v=b30f3f24'),
	PageTaskList: () => import('./pageTaskList.js?v=b30f3f24'),
	ProjectInfo: () => import('./projectInfo.js?v=b30f3f24'),
	PublicPermissions: () => import('./user.js?v=b30f3f24'),
	SavedFilters: () => import('./filters.js?v=b30f3f24'),
	SiteExport: () => import('./siteExport.js?v=b30f3f24'),
	SiteSettings: () => import('./siteSettings.js?v=b30f3f24'),
	StarredList: () => import('./lists.js?v=b30f3f24'),
	TableEditor: () => import('./tableEditor.js?v=b30f3f24'),
	TableSorting: () => import('./tableSorting.js?v=b30f3f24'),
	TableVisibility: () => import('./tableVisibility.js?v=b30f3f24'),
	TaskForm: () => import('./taskForm.js?v=b30f3f24'),
	TaskHistory: () => import('./tables.js?v=b30f3f24'),
	TaskCombine: () => import('./taskSettings.js?v=b30f3f24'),
	TaskMove: () => import('./taskSettings.js?v=b30f3f24'),
	ToolReportList: () => import('./lists.js?v=b30f3f24'),
	TaskSettings: () => import('./taskSettings.js?v=b30f3f24'),
	UserSettings: () => import('./pageInfo.js?v=b30f3f24'),
};

/** Sync-capable widgets that can run without a mounted view (offline replay). */
const HEADLESS_WIDGETS = {
	document: {
		load: () => import('./collaborative.js?v=b30f3f24'),
