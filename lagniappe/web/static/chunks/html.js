...
import { r as request, c as captureError, E as ENDPOINTS } from './foundation.js?v=baf2edcb';
import './connectivity.js?v=baf2edcb';
import { STYLES } from './styles.js?v=baf2edcb';
import { i as independentEditor, T as Toolbar } from './toolbar.js?v=baf2edcb';
