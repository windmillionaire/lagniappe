...
import { r as request, c as captureError, E as ENDPOINTS } from './foundation.js?v=bdc1ce7d';
import { STYLES } from './styles.js?v=bdc1ce7d';
import { i as independentEditor, T as Toolbar } from './toolbar.js?v=bdc1ce7d';
