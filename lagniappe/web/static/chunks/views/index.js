...
import { T as TableVisibilityState } from '../tableVisibilityState.js?v=b32ad33a';
import { C as Core } from '../core.js?v=b32ad33a';
...
class EntityIndex extends Core {
	...
	async _createDropdown() {
		...
		if (!trigger) return;
		this._dropdownPromise = import('../dropdown.js?v=b32ad33a')
			.then(({ Dropdown }) => {
