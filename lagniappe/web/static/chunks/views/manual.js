...
import { S as ShellView, E as ENDPOINTS, r as request, w as withTransition } from '../foundation.js?v=b110e8d6';
...
class Manual extends ShellView {
	...
	async _ensureMobileDropdown() {
		...
		this._mobileDropdownPromise = import('../dropdown.js?v=b110e8d6')
			.then(({ Dropdown }) => {
