...
import { S as ShellView, E as ENDPOINTS, r as request, w as withTransition } from '../foundation.js?v=bdc1ce7d';
...
class Manual extends ShellView {
	...
	async _ensureMobileDropdown() {
		...
		this._mobileDropdownPromise = import('../dropdown.js?v=bdc1ce7d')
			.then(({ Dropdown }) => {
