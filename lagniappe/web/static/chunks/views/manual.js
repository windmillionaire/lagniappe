...
import { S as ShellView, E as ENDPOINTS, r as request, w as withTransition } from '../foundation.js?v=b78fefcd';
...
class Manual extends ShellView {
	...
	async _ensureMobileDropdown() {
		...
		this._mobileDropdownPromise = import('../dropdown.js?v=b78fefcd')
			.then(({ Dropdown }) => {
