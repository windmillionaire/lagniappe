...
import { s as setIcon, c as createIcon } from '../icons.js?v=b66dffd0';
import { r as request, w as withTransition } from '../foundation.js?v=b66dffd0';
...
class Report extends Core {
	...
	ensureReportForms() {
		...
		const pending = import('../baseForm.js?v=b66dffd0').then(function (n) { return n.b; })
			.then(async ({ BaseForm }) => {
