...
import { c as createIcon, s as setIcon } from '../icons.js?v=bc63f152';
import { r as request, w as withTransition } from '../foundation.js?v=bc63f152';
import { C as Core } from '../core-foundation.js?v=bc63f152';
...
class Report extends Core {
	...
	ensureReportForms() {
		...
		const pending = import('../controller.js?v=bc63f152').then(function (n) { return n.c; })
