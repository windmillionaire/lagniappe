...
import { c as createIcon, s as setIcon } from '../icons.js?v=b26991f5';
import { r as request } from '../request.js?v=b26991f5';
import { C as Core } from '../core.js?v=b26991f5';
...
class Report extends Core {
	...
	ensureReportForms() {
		...
		const pending = import('../baseForm.js?v=b26991f5').then(function (n) { return n.b; })
			.then(async ({ BaseForm }) => {
