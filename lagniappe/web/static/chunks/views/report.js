...
import { c as createIcon, s as setIcon } from '../icons.js?v=bdbb928b';
import { r as request, w as withTransition } from '../foundation.js?v=bdbb928b';
...
class Report extends Core {
	...
	ensureReportForms() {
		...
		const pending = import('../baseForm.js?v=bdbb928b').then(function (n) { return n.b; })
			.then(async ({ BaseForm }) => {
