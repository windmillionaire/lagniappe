...
import { c as createIcon, s as setIcon } from '../icons.js?v=b41d0cfc';
import { r as request, w as withTransition } from '../foundation.js?v=b41d0cfc';
...
class Report extends Core {
	...
	ensureReportForms() {
		...
		const pending = import('../baseForm.js?v=b41d0cfc').then(function (n) { return n.b; })
			.then(async ({ BaseForm }) => {
