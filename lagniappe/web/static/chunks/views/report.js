...
import { s as setIcon, c as createIcon } from '../icons.js?v=b4b0f2eb';
import { r as request, w as withTransition } from '../foundation.js?v=b4b0f2eb';
...
class Report extends Core {
	...
	ensureReportForms() {
		...
		const pending = import('../baseForm.js?v=b4b0f2eb').then(function (n) { return n.b; })
			.then(async ({ BaseForm }) => {
