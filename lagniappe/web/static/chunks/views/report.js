...
import { c as createIcon, s as setIcon } from '../icons.js?v=ba683140';
import { r as request, w as withTransition } from '../foundation.js?v=ba683140';
...
class Report extends Core {
	...
	ensureReportForms() {
		...
		const pending = import('../baseForm.js?v=ba683140').then(function (n) { return n.b; })
			.then(async ({ BaseForm }) => {
