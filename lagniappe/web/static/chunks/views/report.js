...
import { c as createIcon, s as setIcon } from '../icons.js?v=b43106f0';
import { r as request, w as withTransition } from '../foundation.js?v=b43106f0';
import { C as Core } from '../core-foundation.js?v=b43106f0';
...
class Report extends Core {
	...
	ensureReportForms() {
		...
		const pending = import('../controller.js?v=b43106f0').then(function (n) { return n.c; })
