...
import { s as setIcon, c as createIcon } from '../icons.js?v=bc116afe';
import { r as request, w as withTransition } from '../foundation.js?v=bc116afe';
...
class Report extends Core {
	...
	ensureReportForms() {
		...
		const pending = import('../baseForm.js?v=bc116afe').then(function (n) { return n.b; })
			.then(async ({ BaseForm }) => {
