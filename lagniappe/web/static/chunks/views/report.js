...
import { c as createIcon, s as setIcon } from '../icons.js?v=b1aeef6f';
import { r as request, w as withTransition } from '../foundation.js?v=b1aeef6f';
import { C as Core } from '../core-foundation.js?v=b1aeef6f';
...
class Report extends Core {
	...
	ensureReportForms() {
		...
		const pending = import('../controller.js?v=b1aeef6f').then(function (n) { return n.c; })
