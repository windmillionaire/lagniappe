...
import { c as createIcon, s as setIcon } from '../icons.js?v=b7cf764f';
import { r as request, w as withTransition } from '../foundation.js?v=b7cf764f';
...
class Report extends Core {
	...
	ensureReportForms() {
		...
		const pending = import('../baseForm.js?v=b7cf764f').then(function (n) { return n.b; })
			.then(async ({ BaseForm }) => {
