...
import { c as createIcon, s as setIcon } from '../icons.js?v=be396a6a';
import { r as request, w as withTransition } from '../foundation.js?v=be396a6a';
...
class Report extends Core {
	...
	ensureReportForms() {
		...
		const pending = import('../baseForm.js?v=be396a6a').then(function (n) { return n.b; })
			.then(async ({ BaseForm }) => {
