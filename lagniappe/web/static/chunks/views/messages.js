...
import { ensureMessageComposer } from '../messageComposer.js?v=bc116afe';
import { r as request, E as ENDPOINTS } from '../foundation.js?v=bc116afe';
import '../connectivity.js?v=bc116afe';
import { c as createIcon } from '../icons.js?v=bc116afe';
import { C as Core } from '../core-foundation.js?v=bc116afe';
...
class Messages extends Core {
	...
	async _ensureConversationDropdown() {
		...
		this._conversationDropdownPromise = import('../dropdown.js?v=bc116afe')
			.then(({ Dropdown }) => {
