...
import { ensureMessageComposer } from '../messageComposer.js?v=b5fa0583';
import { r as request, E as ENDPOINTS } from '../foundation.js?v=b5fa0583';
import '../connectivity.js?v=b5fa0583';
import { c as createIcon } from '../icons.js?v=b5fa0583';
import { C as Core } from '../core-foundation.js?v=b5fa0583';
...
class Messages extends Core {
	...
	async _ensureConversationDropdown() {
		...
		this._conversationDropdownPromise = import('../dropdown.js?v=b5fa0583')
			.then(({ Dropdown }) => {
