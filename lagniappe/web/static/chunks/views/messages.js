...
import { ensureMessageComposer } from '../messageComposer.js?v=b7c13b49';
import { r as request, E as ENDPOINTS } from '../foundation.js?v=b7c13b49';
import '../connectivity.js?v=b7c13b49';
import { c as createIcon } from '../icons.js?v=b7c13b49';
import { C as Core } from '../core-foundation.js?v=b7c13b49';
...
class Messages extends Core {
	...
	async _ensureConversationDropdown() {
		...
		this._conversationDropdownPromise = import('../dropdown.js?v=b7c13b49')
			.then(({ Dropdown }) => {
