...
import { ensureMessageComposer } from '../messageComposer.js?v=bdbb928b';
import { r as request, E as ENDPOINTS } from '../foundation.js?v=bdbb928b';
import '../connectivity.js?v=bdbb928b';
import { c as createIcon } from '../icons.js?v=bdbb928b';
import { C as Core } from '../core-foundation.js?v=bdbb928b';
...
class Messages extends Core {
	...
	async _ensureConversationDropdown() {
		...
		this._conversationDropdownPromise = import('../dropdown.js?v=bdbb928b')
			.then(({ Dropdown }) => {
