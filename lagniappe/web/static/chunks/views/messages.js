...
import { ensureMessageComposer } from '../messageComposer.js?v=b687b680';
import { r as request, E as ENDPOINTS } from '../foundation.js?v=b687b680';
import '../connectivity.js?v=b687b680';
import { c as createIcon } from '../icons.js?v=b687b680';
...
class Messages extends Core {
	...
	async _ensureConversationDropdown() {
		...
		this._conversationDropdownPromise = import('../dropdown.js?v=b687b680')
			.then(({ Dropdown }) => {
