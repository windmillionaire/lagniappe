...
import { ensureMessageComposer } from '../messageComposer.js?v=bdc1ce7d';
import { STYLES } from '../styles.js?v=bdc1ce7d';
import { c as createIcon } from '../icons.js?v=bdc1ce7d';
import { r as request, E as ENDPOINTS } from '../foundation.js?v=bdc1ce7d';
import '../connectivity.js?v=bdc1ce7d';
import { C as Core } from '../core-foundation.js?v=bdc1ce7d';
