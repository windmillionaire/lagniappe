...
import { ensureMessageComposer } from '../messageComposer.js?v=b6795d9d';
import { r as request, E as ENDPOINTS } from '../foundation.js?v=b6795d9d';
import '../connectivity.js?v=b6795d9d';
import { c as createIcon } from '../icons.js?v=b6795d9d';
import { C as Core } from '../core-foundation.js?v=b6795d9d';
...
class Messages extends Core {
	...
	async _ensureConversationDropdown() {
		...
		this._conversationDropdownPromise = import('../dropdown.js?v=b6795d9d')
			.then(({ Dropdown }) => {
