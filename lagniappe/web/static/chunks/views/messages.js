...
import { ensureMessageComposer } from '../messageComposer.js?v=b41d0cfc';
import { r as request, E as ENDPOINTS } from '../foundation.js?v=b41d0cfc';
import '../connectivity.js?v=b41d0cfc';
import { c as createIcon } from '../icons.js?v=b41d0cfc';
import { C as Core } from '../core-foundation.js?v=b41d0cfc';
...
class Messages extends Core {
	...
	async _ensureConversationDropdown() {
		...
		this._conversationDropdownPromise = import('../dropdown.js?v=b41d0cfc')
			.then(({ Dropdown }) => {
