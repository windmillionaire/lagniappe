...
import { ensureMessageComposer } from '../messageComposer.js?v=b24ca4c6';
import { r as request, E as ENDPOINTS } from '../foundation.js?v=b24ca4c6';
import '../connectivity.js?v=b24ca4c6';
import { c as createIcon } from '../icons.js?v=b24ca4c6';
import { C as Core } from '../core-foundation.js?v=b24ca4c6';
...
class Messages extends Core {
	...
	async _ensureConversationDropdown() {
		...
		this._conversationDropdownPromise = import('../dropdown.js?v=b24ca4c6')
			.then(({ Dropdown }) => {
