...
import { ensureMessageComposer } from '../messageComposer.js?v=b60dadce';
import { r as request, E as ENDPOINTS } from '../foundation.js?v=b60dadce';
import '../connectivity.js?v=b60dadce';
import { c as createIcon } from '../icons.js?v=b60dadce';
import { C as Core } from '../core-foundation.js?v=b60dadce';
...
class Messages extends Core {
	...
	async _ensureConversationDropdown() {
		...
		this._conversationDropdownPromise = import('../dropdown.js?v=b60dadce')
			.then(({ Dropdown }) => {
