...
import { ensureMessageComposer } from '../messageComposer.js?v=b7cf764f';
import { r as request, E as ENDPOINTS } from '../foundation.js?v=b7cf764f';
import '../connectivity.js?v=b7cf764f';
import { c as createIcon } from '../icons.js?v=b7cf764f';
import { C as Core } from '../core-foundation.js?v=b7cf764f';
...
class Messages extends Core {
	...
	async _ensureConversationDropdown() {
		...
		this._conversationDropdownPromise = import('../dropdown.js?v=b7cf764f')
			.then(({ Dropdown }) => {
