...
import { ensureMessageComposer } from '../messageComposer.js?v=b05079d4';
import { r as request, E as ENDPOINTS } from '../foundation.js?v=b05079d4';
import '../connectivity.js?v=b05079d4';
import { c as createIcon } from '../icons.js?v=b05079d4';
import { C as Core } from '../core-foundation.js?v=b05079d4';
import '../modal.js?v=b05079d4';
...
class Messages extends Core {
	...
	async _ensureConversationDropdown() {
		...
		this._conversationDropdownPromise = import('../dropdown.js?v=b05079d4')
			.then(({ Dropdown }) => {
