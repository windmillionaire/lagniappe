...
import { ensureMessageComposer } from '../messageComposer.js?v=bb55a6e4';
import { r as request, E as ENDPOINTS } from '../foundation.js?v=bb55a6e4';
import '../connectivity.js?v=bb55a6e4';
import { c as createIcon } from '../icons.js?v=bb55a6e4';
import { C as Core } from '../core-foundation.js?v=bb55a6e4';
...
class Messages extends Core {
	...
	async _ensureConversationDropdown() {
		...
		this._conversationDropdownPromise = import('../dropdown.js?v=bb55a6e4')
			.then(({ Dropdown }) => {
