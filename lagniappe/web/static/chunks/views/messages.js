...
import { ensureMessageComposer } from '../messageComposer.js?v=b110e8d6';
import { r as request, E as ENDPOINTS } from '../foundation.js?v=b110e8d6';
import '../connectivity.js?v=b110e8d6';
import { c as createIcon } from '../icons.js?v=b110e8d6';
import { C as Core } from '../core-foundation.js?v=b110e8d6';
...
class Messages extends Core {
	...
	async _ensureConversationDropdown() {
		...
		this._conversationDropdownPromise = import('../dropdown.js?v=b110e8d6')
			.then(({ Dropdown }) => {
