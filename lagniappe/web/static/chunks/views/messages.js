...
import { ensureMessageComposer } from '../messageComposer.js?v=b564d2b9';
import { r as request, E as ENDPOINTS } from '../foundation.js?v=b564d2b9';
import '../connectivity.js?v=b564d2b9';
import { c as createIcon } from '../icons.js?v=b564d2b9';
import { C as Core } from '../core-foundation.js?v=b564d2b9';
...
class Messages extends Core {
	...
	async _ensureConversationDropdown() {
		...
		this._conversationDropdownPromise = import('../dropdown.js?v=b564d2b9')
			.then(({ Dropdown }) => {
