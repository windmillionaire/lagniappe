...
import { r as request, E as ENDPOINTS, w as withTransition } from './foundation.js?v=b564d2b9';
...
import { TableElement } from './table.js?v=b564d2b9';
import './upstreamUnavailable.js?v=b564d2b9';
import './baseElement.js?v=b564d2b9';
import './checkbox.js?v=b564d2b9';
import './input.js?v=b564d2b9';
import './formatting.js?v=b564d2b9';
import './link.js?v=b564d2b9';
