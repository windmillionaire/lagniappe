...
import { r as request, E as ENDPOINTS, w as withTransition } from './foundation.js?v=bd163a0f';
...
import { TableElement } from './table.js?v=bd163a0f';
import './baseElement.js?v=bd163a0f';
import './checkbox.js?v=bd163a0f';
import './input.js?v=bd163a0f';
import './formatting.js?v=bd163a0f';
import './link.js?v=bd163a0f';
