...
import { r as request, E as ENDPOINTS, w as withTransition, c as captureError } from './foundation.js?v=b110e8d6';
...
import { TableElement } from './table.js?v=b110e8d6';
import './upstreamUnavailable.js?v=b110e8d6';
import './baseElement.js?v=b110e8d6';
import './checkbox.js?v=b110e8d6';
import './input.js?v=b110e8d6';
import './formatting.js?v=b110e8d6';
import './link.js?v=b110e8d6';
...
class TaskHistory extends EmbeddedTable {
	...
	async _showCompletion(button) {
		...
		try {
			...
			const { BaseForm } = await import('./baseForm.js?v=b110e8d6').then(function (n) { return n.b; });
