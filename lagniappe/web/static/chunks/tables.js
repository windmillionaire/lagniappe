...
import { r as request, E as ENDPOINTS, w as withTransition } from './foundation.js?v=b13679a7';
...
import { TableElement } from './table.js?v=b13679a7';
import './baseElement.js?v=b13679a7';
import './checkbox.js?v=b13679a7';
import './input.js?v=b13679a7';
import './formatting.js?v=b13679a7';
import './link.js?v=b13679a7';
