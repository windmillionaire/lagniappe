...
import { r as request, E as ENDPOINTS, w as withTransition } from './foundation.js?v=b881d5e5';
...
import { TableElement } from './table.js?v=b881d5e5';
import './baseElement.js?v=b881d5e5';
import './checkbox.js?v=b881d5e5';
import './input.js?v=b881d5e5';
import './formatting.js?v=b881d5e5';
import './link.js?v=b881d5e5';
