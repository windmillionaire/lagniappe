...
import { r as request, E as ENDPOINTS, w as withTransition } from './foundation.js?v=b05079d4';
...
import { TableElement } from './table.js?v=b05079d4';
import './baseElement.js?v=b05079d4';
import './checkbox.js?v=b05079d4';
import './input.js?v=b05079d4';
import './formatting.js?v=b05079d4';
import './link.js?v=b05079d4';
