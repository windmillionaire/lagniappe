...
import { r as request, E as ENDPOINTS, w as withTransition } from './foundation.js?v=b4b0f2eb';
...
import { TableElement } from './table.js?v=b4b0f2eb';
import './baseElement.js?v=b4b0f2eb';
import './checkbox.js?v=b4b0f2eb';
import './input.js?v=b4b0f2eb';
import './formatting.js?v=b4b0f2eb';
import './link.js?v=b4b0f2eb';
