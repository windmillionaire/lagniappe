...
import { r as request, E as ENDPOINTS, w as withTransition } from './foundation.js?v=b41d0cfc';
...
import { TableElement } from './table.js?v=b41d0cfc';
import './upstreamUnavailable.js?v=b41d0cfc';
import './baseElement.js?v=b41d0cfc';
import './checkbox.js?v=b41d0cfc';
import './input.js?v=b41d0cfc';
import './formatting.js?v=b41d0cfc';
import './link.js?v=b41d0cfc';
