...
import { e as areEqual, r as request, c as captureError, w as withTransition } from './foundation.js?v=b6b75cd2';
import { c as compatibleField, i as incompatibleSchema } from './representation.js?v=b6b75cd2';
import { STYLES } from './styles.js?v=b6b75cd2';
import { Modal } from './modal.js?v=b6b75cd2';
import { l as loadWidget } from './core-foundation.js?v=b6b75cd2';
import { r as renderReviewBar } from './reviewBar.js?v=b6b75cd2';
...
class EditReconciler {
	...
	async handleClick(event) {
		...
		try {
			...
			if (widget?.target?.dataset?.formState && !state.record) {
