...
import { SearchBox } from './search.js?v=b1aeef6f';
import { EntityMenu } from './entityMenu.js?v=b1aeef6f';
import { d as directUpload } from './directUpload.js?v=b1aeef6f';
import { r as request, w as withTransition, c as captureError, E as ENDPOINTS, e as areEqual, g as generateElementId } from './foundation.js?v=b1aeef6f';
import { c as connectivity } from './connectivity.js?v=b1aeef6f';
import { Modal, OfflineModal, DeleteModal, HelpModal } from './modal.js?v=b1aeef6f';
import { PollingCoordinator } from './polling.js?v=b1aeef6f';
import { STYLES } from './styles.js?v=b1aeef6f';
import { s as setIcon } from './icons.js?v=b1aeef6f';
import { p as primitives } from './primitives.js?v=b1aeef6f';
import { F as FormController, a as FormRenderer } from './controller.js?v=b1aeef6f';
...
const CONDITION_REGISTRY = {
	modify: () => import('./modify.js?v=b1aeef6f'),
	html: () => import('./html.js?v=b1aeef6f'),
	status: () => import('./status.js?v=b1aeef6f'),
	visibility: () => import('./visibility2.js?v=b1aeef6f'),
	columns: () => import('./columns.js?v=b1aeef6f'),
	options: () => import('./options.js?v=b1aeef6f'),
};
...
class FormBuilder {
	...
	async prepareGeneratedDocuments(htmlFields) {
		const { default: HtmlEditor } = await import('./html.js?v=b1aeef6f');
