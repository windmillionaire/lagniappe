...
import { SearchBox } from './search.js?v=be0bc88b';
import { EntityMenu } from './entityMenu.js?v=be0bc88b';
import { u as uploadElement } from './upload.js?v=be0bc88b';
import { r as request, w as withTransition, c as captureError, E as ENDPOINTS, f as areEqual, g as generateElementId } from './foundation.js?v=be0bc88b';
import { c as connectivity } from './connectivity.js?v=be0bc88b';
import { Modal, OfflineModal, DeleteModal, HelpModal } from './modal.js?v=be0bc88b';
import { PollingCoordinator } from './polling.js?v=be0bc88b';
import { STYLES } from './styles.js?v=be0bc88b';
import { s as setIcon } from './icons.js?v=be0bc88b';
import { p as primitives } from './primitives.js?v=be0bc88b';
import { B as BaseForm, R as Renderer } from './baseForm.js?v=be0bc88b';
import { F as FacetsBox } from './facets.js?v=be0bc88b';
...
const CONDITION_REGISTRY = {
	modify: () => import('./modify.js?v=be0bc88b'),
	html: () => import('./html.js?v=be0bc88b'),
	status: () => import('./status.js?v=be0bc88b'),
	visibility: () => import('./visibility.js?v=be0bc88b'),
	columns: () => import('./columns.js?v=be0bc88b'),
	options: () => import('./options.js?v=be0bc88b'),
};
...
class FormBuilder {
	...
	async prepareGeneratedDocuments(htmlFields) {
		const { default: HtmlEditor } = await import('./html.js?v=be0bc88b');
