...
import { SearchBox } from './search.js?v=b41d0cfc';
import { EntityMenu } from './entityMenu.js?v=b41d0cfc';
import { w as withTransition, r as request, c as captureError, E as ENDPOINTS, f as areEqual, g as generateElementId } from './foundation.js?v=b41d0cfc';
import { c as connectivity } from './connectivity.js?v=b41d0cfc';
import { Modal, OfflineModal, DeleteModal, HelpModal } from './modal.js?v=b41d0cfc';
import { STYLES } from './styles.js?v=b41d0cfc';
import { s as setIcon } from './icons.js?v=b41d0cfc';
import { p as primitives } from './primitives.js?v=b41d0cfc';
import { B as BaseForm, R as Renderer } from './baseForm.js?v=b41d0cfc';
import { F as FacetsBox } from './facets.js?v=b41d0cfc';

const CONDITION_REGISTRY = {
	html: () => import('./html.js?v=b41d0cfc'),
	status: () => import('./status.js?v=b41d0cfc'),
	visibility: () => import('./visibility.js?v=b41d0cfc'),
	columns: () => import('./columns.js?v=b41d0cfc'),
	options: () => import('./options.js?v=b41d0cfc'),
};
