...
import { SearchBox } from './search.js?v=b687b680';
import { EntityMenu } from './entityMenu.js?v=b687b680';
import { w as withTransition, r as request, c as captureError, E as ENDPOINTS, f as areEqual, g as generateElementId } from './foundation.js?v=b687b680';
import { c as connectivity } from './connectivity.js?v=b687b680';
import { Modal, OfflineModal, DeleteModal, HelpModal } from './modal.js?v=b687b680';
import { STYLES } from './styles.js?v=b687b680';
import { s as setIcon } from './icons.js?v=b687b680';
import { p as primitives } from './primitives.js?v=b687b680';
import { B as BaseForm, R as Renderer } from './baseForm.js?v=b687b680';
import { F as FacetsBox } from './facets.js?v=b687b680';

const CONDITION_REGISTRY = {
	html: () => import('./html.js?v=b687b680'),
	status: () => import('./status.js?v=b687b680'),
	visibility: () => import('./visibility.js?v=b687b680'),
	columns: () => import('./columns.js?v=b687b680'),
	options: () => import('./options.js?v=b687b680'),
};
