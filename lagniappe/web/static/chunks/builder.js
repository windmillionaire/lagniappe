...
import { S as STYLES, s as setIcon, w as withTransition, r as request, E as ENDPOINTS, M as Modal, O as OfflineModal, D as DeleteModal, H as HelpModal, h as generateElementId } from './shared.js?v=b30f3f24';
import { p as primitives } from './primitives.js?v=b30f3f24';
import { B as BaseForm, R as Renderer } from './baseForm.js?v=b30f3f24';
import { F as FacetsBox } from './facets.js?v=b30f3f24';

const CONDITION_REGISTRY = {
	html: () => import('./html.js?v=b30f3f24'),
	status: () => import('./status.js?v=b30f3f24'),
	visibility: () => import('./visibility.js?v=b30f3f24'),
	columns: () => import('./columns.js?v=b30f3f24'),
	options: () => import('./options.js?v=b30f3f24'),
};
