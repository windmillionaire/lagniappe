...
import { SearchBox } from './search.js?v=ba9311bf';
import { EntityMenu } from './entityMenu.js?v=ba9311bf';
import { w as withTransition, r as request, E as ENDPOINTS, g as generateElementId } from './foundation.js?v=ba9311bf';
import { c as connectivity } from './connectivity.js?v=ba9311bf';
import { Modal, OfflineModal, DeleteModal, HelpModal } from './modal.js?v=ba9311bf';
import { STYLES } from './styles.js?v=ba9311bf';
import { s as setIcon } from './icons.js?v=ba9311bf';
import { p as primitives } from './primitives.js?v=ba9311bf';
import { B as BaseForm, R as Renderer } from './baseForm.js?v=ba9311bf';
import { F as FacetsBox } from './facets.js?v=ba9311bf';

const CONDITION_REGISTRY = {
	html: () => import('./html.js?v=ba9311bf'),
	status: () => import('./status.js?v=ba9311bf'),
	visibility: () => import('./visibility.js?v=ba9311bf'),
	columns: () => import('./columns.js?v=ba9311bf'),
	options: () => import('./options.js?v=ba9311bf'),
};
