...
import { SearchBox } from './search.js?v=bc116afe';
import { EntityMenu } from './entityMenu.js?v=bc116afe';
import { w as withTransition, r as request, E as ENDPOINTS, g as generateElementId } from './foundation.js?v=bc116afe';
import { c as connectivity } from './connectivity.js?v=bc116afe';
import { Modal, OfflineModal, DeleteModal, HelpModal } from './modal.js?v=bc116afe';
import { STYLES } from './styles.js?v=bc116afe';
import { s as setIcon } from './icons.js?v=bc116afe';
import { p as primitives } from './primitives.js?v=bc116afe';
import { B as BaseForm, R as Renderer } from './baseForm.js?v=bc116afe';
import { F as FacetsBox } from './facets.js?v=bc116afe';

const CONDITION_REGISTRY = {
	html: () => import('./html.js?v=bc116afe'),
	status: () => import('./status.js?v=bc116afe'),
	visibility: () => import('./visibility.js?v=bc116afe'),
	columns: () => import('./columns.js?v=bc116afe'),
	options: () => import('./options.js?v=bc116afe'),
};
