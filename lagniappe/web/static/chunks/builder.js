...
import { E as EntityMenu, S as SearchBox } from './entityMenu.js?v=bda9a134';
import { S as STYLES, s as setIcon, w as withTransition, r as request, E as ENDPOINTS, M as Modal, O as OfflineModal, D as DeleteModal, H as HelpModal, h as generateElementId } from './shared.js?v=bda9a134';
import { p as primitives } from './primitives.js?v=bda9a134';
import { B as BaseForm, R as Renderer } from './baseForm.js?v=bda9a134';
import { F as FacetsBox } from './facets.js?v=bda9a134';

const CONDITION_REGISTRY = {
	html: () => import('./html.js?v=bda9a134'),
	status: () => import('./status.js?v=bda9a134'),
	visibility: () => import('./visibility.js?v=bda9a134'),
	columns: () => import('./columns.js?v=bda9a134'),
	options: () => import('./options.js?v=bda9a134'),
};
...
export { CONFIG as C, builder as b };
