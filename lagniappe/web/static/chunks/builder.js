...
import { SearchBox } from './search.js?v=b24ca4c6';
import { EntityMenu } from './entityMenu.js?v=b24ca4c6';
import { u as uploadElement } from './upload.js?v=b24ca4c6';
import { r as request, w as withTransition, c as captureError, E as ENDPOINTS, f as areEqual, g as generateElementId } from './foundation.js?v=b24ca4c6';
import { c as connectivity } from './connectivity.js?v=b24ca4c6';
import { Modal, OfflineModal, DeleteModal, HelpModal } from './modal.js?v=b24ca4c6';
import { PollingCoordinator } from './polling.js?v=b24ca4c6';
import { STYLES } from './styles.js?v=b24ca4c6';
import { s as setIcon } from './icons.js?v=b24ca4c6';
import { p as primitives } from './primitives.js?v=b24ca4c6';
import { B as BaseForm, R as Renderer } from './baseForm.js?v=b24ca4c6';
import { F as FacetsBox } from './facets.js?v=b24ca4c6';
...
const CONDITION_REGISTRY = {
	modify: () => import('./modify.js?v=b24ca4c6'),
	html: () => import('./html.js?v=b24ca4c6'),
	status: () => import('./status.js?v=b24ca4c6'),
	visibility: () => import('./visibility.js?v=b24ca4c6'),
	columns: () => import('./columns.js?v=b24ca4c6'),
	options: () => import('./options.js?v=b24ca4c6'),
};
 ...
 */
const needsMigration = (before, after) =>
	before.some((field) => {
...
class FormBuilder {
	...
	async prepareGeneratedDocuments(htmlFields) {
		const { default: HtmlEditor } = await import('./html.js?v=b24ca4c6');
...
export { CONFIG as C, FormBuilder as F, fieldKind as f };
