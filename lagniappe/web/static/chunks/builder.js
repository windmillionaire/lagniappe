...
import { SearchBox } from './search.js?v=b5fa0583';
import { EntityMenu } from './entityMenu.js?v=b5fa0583';
import { u as uploadElement } from './upload.js?v=b5fa0583';
import { r as request, w as withTransition, c as captureError, E as ENDPOINTS, f as areEqual, g as generateElementId } from './foundation.js?v=b5fa0583';
import { c as connectivity } from './connectivity.js?v=b5fa0583';
import { Modal, OfflineModal, DeleteModal, HelpModal } from './modal.js?v=b5fa0583';
import { PollingCoordinator } from './polling.js?v=b5fa0583';
import { STYLES } from './styles.js?v=b5fa0583';
import { s as setIcon } from './icons.js?v=b5fa0583';
import { p as primitives } from './primitives.js?v=b5fa0583';
import { B as BaseForm, R as Renderer } from './baseForm.js?v=b5fa0583';
import { F as FacetsBox } from './facets.js?v=b5fa0583';
...
const CONDITION_REGISTRY = {
	modify: () => import('./modify.js?v=b5fa0583'),
	html: () => import('./html.js?v=b5fa0583'),
	status: () => import('./status.js?v=b5fa0583'),
	visibility: () => import('./visibility.js?v=b5fa0583'),
	columns: () => import('./columns.js?v=b5fa0583'),
	options: () => import('./options.js?v=b5fa0583'),
};
...
class FormBuilder {
	...
	async prepareGeneratedDocuments(htmlFields) {
		const { default: HtmlEditor } = await import('./html.js?v=b5fa0583');
