...
import { SearchBox } from './search.js?v=b43106f0';
import { EntityMenu } from './entityMenu.js?v=b43106f0';
import { d as directUpload } from './directUpload.js?v=b43106f0';
import { r as request, w as withTransition, c as captureError, E as ENDPOINTS, e as areEqual, g as generateElementId } from './foundation.js?v=b43106f0';
import { c as connectivity } from './connectivity.js?v=b43106f0';
import { Modal, OfflineModal, DeleteModal, HelpModal } from './modal.js?v=b43106f0';
import { PollingCoordinator } from './polling.js?v=b43106f0';
import { STYLES } from './styles.js?v=b43106f0';
import { s as setIcon } from './icons.js?v=b43106f0';
import { p as primitives } from './primitives.js?v=b43106f0';
import { F as FormController, a as FormRenderer } from './controller.js?v=b43106f0';
...
const CONDITION_REGISTRY = {
	modify: () => import('./modify.js?v=b43106f0'),
	html: () => import('./html.js?v=b43106f0'),
	status: () => import('./status.js?v=b43106f0'),
	visibility: () => import('./visibility2.js?v=b43106f0'),
	columns: () => import('./columns.js?v=b43106f0'),
	options: () => import('./options.js?v=b43106f0'),
};
...
class FormBuilder {
	...
	async prepareGeneratedDocuments(htmlFields) {
		const { default: HtmlEditor } = await import('./html.js?v=b43106f0');
