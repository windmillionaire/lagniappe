...
import { SearchBox } from './search.js?v=b7c13b49';
import { EntityMenu } from './entityMenu.js?v=b7c13b49';
import { u as uploadElement } from './upload.js?v=b7c13b49';
import { r as request, w as withTransition, c as captureError, E as ENDPOINTS, f as areEqual, g as generateElementId } from './foundation.js?v=b7c13b49';
import { c as connectivity } from './connectivity.js?v=b7c13b49';
import { Modal, OfflineModal, DeleteModal, HelpModal } from './modal.js?v=b7c13b49';
import { PollingCoordinator } from './polling.js?v=b7c13b49';
import { STYLES } from './styles.js?v=b7c13b49';
import { s as setIcon } from './icons.js?v=b7c13b49';
import { p as primitives } from './primitives.js?v=b7c13b49';
import { B as BaseForm, R as Renderer } from './baseForm.js?v=b7c13b49';
import { F as FacetsBox } from './facets.js?v=b7c13b49';
...
const CONDITION_REGISTRY = {
	modify: () => import('./modify.js?v=b7c13b49'),
	html: () => import('./html.js?v=b7c13b49'),
	status: () => import('./status.js?v=b7c13b49'),
	visibility: () => import('./visibility.js?v=b7c13b49'),
	columns: () => import('./columns.js?v=b7c13b49'),
	options: () => import('./options.js?v=b7c13b49'),
};
...
class FormBuilder {
	...
	async prepareGeneratedDocuments(htmlFields) {
		const { default: HtmlEditor } = await import('./html.js?v=b7c13b49');
