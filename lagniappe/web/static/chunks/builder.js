...
import { SearchBox } from './search.js?v=b6b75cd2';
import { EntityMenu } from './entityMenu.js?v=b6b75cd2';
import { d as directUpload } from './directUpload.js?v=b6b75cd2';
import { r as request, w as withTransition, c as captureError, E as ENDPOINTS, e as areEqual, g as generateElementId } from './foundation.js?v=b6b75cd2';
import { c as connectivity } from './connectivity.js?v=b6b75cd2';
import { Modal, OfflineModal, DeleteModal, HelpModal } from './modal.js?v=b6b75cd2';
import { PollingCoordinator } from './polling.js?v=b6b75cd2';
import { STYLES } from './styles.js?v=b6b75cd2';
import { s as setIcon } from './icons.js?v=b6b75cd2';
import { p as primitives } from './primitives.js?v=b6b75cd2';
import { F as FormController, a as FormRenderer } from './controller.js?v=b6b75cd2';
...
const CONDITION_REGISTRY = {
	modify: () => import('./modify.js?v=b6b75cd2'),
	html: () => import('./html.js?v=b6b75cd2'),
	status: () => import('./status.js?v=b6b75cd2'),
	visibility: () => import('./visibility2.js?v=b6b75cd2'),
	columns: () => import('./columns.js?v=b6b75cd2'),
	options: () => import('./options.js?v=b6b75cd2'),
};
...
class FormBuilder {
	...
	async prepareGeneratedDocuments(htmlFields) {
		const { default: HtmlEditor } = await import('./html.js?v=b6b75cd2');
