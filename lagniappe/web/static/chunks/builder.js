...
import { SearchBox } from './search.js?v=b05079d4';
import { EntityMenu } from './entityMenu.js?v=b05079d4';
import { w as withTransition, r as request, E as ENDPOINTS, g as generateElementId } from './foundation.js?v=b05079d4';
import { c as connectivity } from './connectivity.js?v=b05079d4';
import { Modal, OfflineModal, DeleteModal, HelpModal } from './modal.js?v=b05079d4';
...
import { B as BaseForm, R as Renderer } from './baseForm.js?v=b05079d4';
import { F as FacetsBox } from './facets.js?v=b05079d4';

const CONDITION_REGISTRY = {
	html: () => import('./html.js?v=b05079d4'),
	status: () => import('./status.js?v=b05079d4'),
	visibility: () => import('./visibility.js?v=b05079d4'),
	columns: () => import('./columns.js?v=b05079d4'),
	options: () => import('./options.js?v=b05079d4'),
};
