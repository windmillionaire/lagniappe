...
import { SearchBox } from './search.js?v=b110e8d6';
import { EntityMenu } from './entityMenu.js?v=b110e8d6';
import { u as uploadElement } from './upload.js?v=b110e8d6';
import { w as withTransition, r as request, c as captureError, E as ENDPOINTS, f as areEqual, g as generateElementId } from './foundation.js?v=b110e8d6';
import { c as connectivity } from './connectivity.js?v=b110e8d6';
import { Modal, OfflineModal, DeleteModal, HelpModal } from './modal.js?v=b110e8d6';
import { STYLES } from './styles.js?v=b110e8d6';
import { s as setIcon } from './icons.js?v=b110e8d6';
import { p as primitives } from './primitives.js?v=b110e8d6';
import { B as BaseForm, R as Renderer } from './baseForm.js?v=b110e8d6';
import { F as FacetsBox } from './facets.js?v=b110e8d6';

const CONDITION_REGISTRY = {
	html: () => import('./html.js?v=b110e8d6'),
	status: () => import('./status.js?v=b110e8d6'),
	visibility: () => import('./visibility.js?v=b110e8d6'),
	columns: () => import('./columns.js?v=b110e8d6'),
	options: () => import('./options.js?v=b110e8d6'),
};
