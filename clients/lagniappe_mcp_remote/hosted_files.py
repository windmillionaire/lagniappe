...
# @testable true
# @tests clients/lagniappe_mcp/tests/test_hosted_files.py::test_attachment_urls_reject_unsafe_addresses_and_pin_dns
...
# @testable true
# @tests clients/lagniappe_mcp/tests/test_hosted_files.py::test_attachment_names_and_mime_hints_do_not_select_paths
...
# @testable true
# @tests clients/lagniappe_mcp/tests/test_hosted_files.py::test_attachment_download_counts_actual_bytes_and_cleans_partial_files
# @tests clients/lagniappe_mcp/tests/test_hosted_files.py::test_attachment_redirects_and_expiry_never_forward_credentials
# @tests clients/lagniappe_mcp/tests/test_hosted_files.py::test_redirect_destinations_are_revalidated_before_connecting
# @tests clients/lagniappe_mcp/tests/test_hosted_files.py::test_partial_downloads_clean_the_entire_spool_when_transfer_fails
...
# @testable true
# @tests clients/lagniappe_mcp/tests/test_hosted_files.py::test_spooling_has_one_total_limit_and_cleans_on_cancellation
# @tests clients/lagniappe_mcp/tests/test_hosted_files.py::test_partial_downloads_clean_the_entire_spool_when_transfer_fails
