...
from lagniappe_mcp.server import _error_result, _success_result, _REQUEST_ID_TOKEN
...
# @testable true
# @tests clients/lagniappe_mcp/tests/test_hosted.py::test_hosted_configuration_and_public_discovery_are_exact
...
class HostedConfig:
    ...
    # @testable false
    # @covered-by clients/lagniappe_mcp_remote/hosted.py::HostedConfig
...
# @testable true
# @tests clients/lagniappe_mcp/tests/test_hosted.py::test_workload_identity_uses_only_metadata_and_envelope_uses_fixed_api_origin
...
class WorkloadIdentity:
    ...
    # @testable false
    # @covered-by clients/lagniappe_mcp_remote/hosted.py::WorkloadIdentity
...
class EnvelopeClient(httpx.AsyncClient):
    # @testable false
    # @covered-by clients/lagniappe_mcp_remote/hosted.py::EnvelopeClient
...
# @testable false
# @covered-by clients/lagniappe_mcp_remote/hosted.py::create_app
class RequestREST(RESTClient):
    ...
    # @testable false
    # @covered-by clients/lagniappe_mcp_remote/hosted.py::RequestREST
...
# @testable true
# @tests clients/lagniappe_mcp/tests/test_hosted.py::test_remote_catalog_and_calls_reuse_adapter_behavior_and_isolate_users
# @tests clients/lagniappe_mcp/tests/test_hosted.py::test_hosted_catalog_and_error_results_cannot_reflect_workload_identity
# @tests clients/lagniappe_mcp/tests/test_hosted.py::test_remote_attachment_uses_shared_upload_and_preserves_pending_failure
...
# @tests clients/lagniappe_mcp/tests/test_hosted.py::test_hosted_configuration_and_public_discovery_are_exact
# @tests clients/lagniappe_mcp/tests/test_hosted.py::test_remote_catalog_and_calls_reuse_adapter_behavior_and_isolate_users
# @tests clients/lagniappe_mcp/tests/test_hosted.py::test_http_authentication_preflights_every_request_and_reconnects_on_revocation
# @tests clients/lagniappe_mcp/tests/test_hosted.py::test_http_errors_are_private_and_mid_request_expiry_requests_reconnect
# @tests clients/lagniappe_mcp/tests/test_hosted.py::test_hosted_catalog_and_error_results_cannot_reflect_workload_identity
...
def main():
    ...
    if os.environ.get("LAGNIAPPE_MCP_ENABLED", "false") != "true":
        # @testable false
        # @covered-by clients/lagniappe_mcp_remote/hosted.py::main
