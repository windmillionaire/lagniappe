...
# @testable true
# @tests clients/lagniappe_mcp/tests/test_terminal_files.py::test_manifest_allows_only_validated_storage_writes_and_never_oauth_secrets
...
# @testable true
# @tests clients/lagniappe_mcp/tests/test_hosted.py::test_remote_attachment_uses_shared_upload_and_preserves_pending_failure
# @tests clients/lagniappe_mcp/tests/test_terminal_files.py::test_terminal_finalize_never_accepts_incomplete_or_replaced_batch
