...
Text font sources and their pinned provenance are recorded in
`src/fonts/sources.json`. The reproducible loading partitions retain the full
Bitter and Source Sans 3 character maps; see
[`INFRA_BUILD_STYLES.md`](../documentation/INFRA_BUILD_STYLES.md).
