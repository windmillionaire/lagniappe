...
const WIDGETS = {
	...
	FilterResults: () => import("./filterResults"),
	...
	IndexTable: () => import("./tables/indexTable"),
	IngressFileUpload: () => import("./ingressUpload"),
	IngressList: () => import("./home/lists"),
	MobileTableControls: () => import("./tables/mobileControls"),
	...
	TableEditor: () => import("./tables/editor"),
	TableSorting: () => import("./tables/sorting"),
	TableVisibility: () => import("./tables/visibility"),
	TaskForm: () => import("./taskForm"),
	TaskHistory: () => import("./taskHistory"),
