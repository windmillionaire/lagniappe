...
export const UPSTREAM_UNAVAILABLE_HEADER = "X-Lagniappe-Upstream-Unavailable";
export const UPSTREAM_STATUS_HEADER = "X-Lagniappe-Upstream-Status";
export const STALE_CACHE_HEADER = "X-Lagniappe-Stale-Cache";
